...
int DoubleMembranePlateFiberSection::setParameter(const char** argv, int argc, Parameter& param)
{
...
int DoubleMembranePlateFiberSection::updateParameter(int parameterID, Information& info)
{
