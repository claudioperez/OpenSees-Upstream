...
bool
OPS_addUniaxialMaterial (UniaxialMaterial * newComponent)
{
    return theUniaxialMaterialObjects.addComponent (newComponent);
}

bool
OPS_removeUniaxialMaterial (int tag)
{
...
UniaxialMaterial *
OPS_getUniaxialMaterial (int tag)
{
...
void
OPS_clearAllUniaxialMaterial (void)
{
    theUniaxialMaterialObjects.clearAll ();
}

void
OPS_printUniaxialMaterial (OPS_Stream & s, int flag)
{
...
int
UniaxialMaterial::setTrial (double strain, double &stress, double &tangent,
                            double strainRate)
{
    int res = this->setTrialStrain (strain, strainRate);
    if (res == 0)
...
int
UniaxialMaterial::setTrial (double strain, double temperature, double &stress,
        ...
        (strstr (argv[0], "TempElong") != 0))
      {
          ...
          if (strcmp (argv[0], "stress") == 0)
            {
                ...
                theResponse =
                    new MaterialResponse (this, 1, this->getStress ());
            }
          // tangent
          ...
          // strain
          else if (strcmp (argv[0], "strain") == 0)
            {
                ...
                theResponse =
                    new MaterialResponse (this, 3, this->getStrain ());
            }
          ...
          else if (strcmp (argv[0], "plasticStrain") == 0)
            {
                theOutput.tag ("ResponseType", "eps11");
                theResponse =
                    new MaterialResponse (this, 6, this->getStrain ());
            }
...
int
UniaxialMaterial::commitSensitivity (double strainSensitivity, int gradIndex,
                                     int numGrads)
{
    return -1;
}
