...
bool
OPS_addFrictionModel (FrictionModel * newComponent)
{
...
FrictionModel *
OPS_getFrictionModel (int tag)
{
    TaggedObject *theResult = theFrictionModelObjects.getComponentPtr (tag);
    if (theResult == 0)
      {
          opserr <<
              "FrictionModel *getFrictionModel(int tag) - none found with tag: "
              << tag << endln;
          return 0;
      }
...
Response *
FrictionModel::setResponse (const char **argv, int argc,
                            OPS_Stream & theOutputStream)
{
    ...
    // velocity
    else if (strcmp (argv[0], "velocity") == 0
             || strcmp (argv[0], "vel") == 0)
      {
    ...
    // friction force
             ...
             || strcmp (argv[0], "Ff") == 0
             || strcmp (argv[0], "frnForce") == 0
             || strcmp (argv[0], "frnFrc") == 0)
      {
...
int
FrictionModel::getResponse (int responseID, Information & info)
{
