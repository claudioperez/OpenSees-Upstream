...
Matrix
NDMaterial::errMatrix (1, 1);
Vector
NDMaterial::errVector (1);

static MapOfTaggedObjects theNDMaterialObjects;

bool
OPS_addNDMaterial (NDMaterial * newComponent)
{
    return theNDMaterialObjects.addComponent (newComponent);
}

bool
OPS_removeNDMaterial (int tag)
{
...
void
OPS_clearAllNDMaterial (void)
{
    theNDMaterialObjects.clearAll ();
}

void
OPS_printNDMaterial (OPS_Stream & s, int flag)
{
...
int
NDMaterial::commitSensitivity (const Vector & strainSensitivity,
