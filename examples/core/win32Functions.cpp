...
typedef int (*OPS_AllocateElementPtrType) (eleObj *, int *matTags,
                                           int *maType);
...
typedef int (*OPS_InvokeMaterialDirectlyPtrType) (matObject **, modelState *,
                                                  double *, double *,
                                                  double *, int *);
...
typedef VariableTimeStepDirectIntegrationAnalysis
    **(*OPS_GetVariableTimeStepTransientAnalysisPtrType) (void);
...
OPS_GetVariableTimeStepTransientAnalysisPtrType
    OPS_GetVariableTimeStepTransientAnalysisPtr = 0;
...
setGlobalPointers (OPS_Stream * theErrorStreamPtr,
                   ...
                   OPS_InvokeMaterialDirectlyFunct,
                   ...
                   OPS_GetTransientAnalysisFunct,
                   OPS_GetVariableTimeStepTransientAnalysisPtrType
                   OPS_GetVariableTimeStepTransientAnalysisFunct,
                   OPS_GetNumEigenPtrType OPS_GetNumEigenFunct,
                   OPS_GetStaticIntegratorPtrType
                   OPS_GetStaticIntegratorFunct,
                   OPS_GetTransientIntegratorPtrType
                   OPS_GetTransientIntegratorFunct,
                   ...
                   OPS_GetDomainPointer OPS_getDomainPtr)
{
    ...
    OPS_GetVariableTimeStepTransientAnalysisPtr =
        OPS_GetVariableTimeStepTransientAnalysisFunct;
...
extern "C" int
OPS_AllocateMaterial (matObj * mat)
{
    return (*OPS_AllocateMaterialPtr) (mat);
}

extern "C" int
OPS_AllocateElement (eleObj * ele, int *matTags, int *matType)
{
...
OPS_InvokeMaterialDirectly (matObject ** theMat, modelState * model,
                            ...
                            int *isw)
{
    return (*OPS_InvokeMaterialDirectlyPtr) (theMat, model, strain, stress,
                                             tang, isw);
}
