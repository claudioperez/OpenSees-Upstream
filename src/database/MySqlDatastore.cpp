...
MySqlDatastore::MySqlDatastore (const char *projectName,
                                Domain & theDomain,
                                FEM_ObjectBroker & theObjectBroker, int run):
                        ...
                        const ID & theID, ChannelAddress * theAddress)
{
    ...
    // form the INSERT query
    sprintf (query, "INSERT INTO IDs VALUES (%d, %d, %d,'", dbTag, commitTag,
             theID.sz);
    char *p = query + strlen (query);
...
int
MySqlDatastore::createTable (const char *tableName, int numColumns,
                             char *columns[])
{
    // check that we have a connection
    if (connection == false)
...
int
MySqlDatastore::insertData (const char *tableName, char *columns[],
...
int
MySqlDatastore::getData (const char *tableName, char *columns[],
