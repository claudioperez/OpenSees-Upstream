...
main (int argc, char **argv)
{
    ...
    opserr <<
        "Now We Test createTable()\n\t 1. invoke createTable() twice to create tables UnitTest1 and UnitTest2\n";
    opserr <<
        "\t 2. invoke createTable() with invalid args a number of times\n\n";
    ...
    opserr <<
        "Now We Test insertData()\n\t 1. invoke insertData() 3 times with valid args on both UnitTest1 and UnitTest2\n";
    opserr <<
        "\t 2. invoke insertData() with invalid args a number of times\n\n";
