...
RegulaFalsiLineSearch::RegulaFalsiLineSearch(double tol, int mIter,
                                             double mnEta, double mxEta,
                                             int
                                             pFlag):LineSearch
    (LINESEARCH_TAGS_RegulaFalsiLineSearch), x(0), tolerance(tol),
...
int RegulaFalsiLineSearch::search(double s0,
                                  double s1,
                                  LinearSOE & theSOE,
...
int RegulaFalsiLineSearch::sendSelf(int cTag, Channel & theChannel)
{
    return 0;
}

int RegulaFalsiLineSearch::recvSelf(int cTag,
                                    Channel & theChannel,
...
void RegulaFalsiLineSearch::Print(OPS_Stream & s, int flag)
{
    if (flag == 0) {
        s << "RegulaFalsiLineSearch :: Line Search Tolerance = " <<
            tolerance << endln;
