...
// Constructor
Broyden::Broyden(int theTangentToUse,
                 int n):EquiSolnAlgo(EquiALGORITHM_TAGS_Broyden),
...
//Constructor
Broyden::Broyden(ConvergenceTest & theT, int theTangentToUse,
                 int n):EquiSolnAlgo(EquiALGORITHM_TAGS_Broyden),
tangent(theTangentToUse), numberLoops(n)
{
    s = new Vector *[numberLoops + 3];
...
int Broyden::setConvergenceTest(ConvergenceTest * newTest)
{
...
int Broyden::solveCurrentStep(void)
{
...
void Broyden::BroydenUpdate(IncrementalIntegrator * theIntegrator,
                            LinearSOE * theSOE, Vector & du, int nBroyden)
{
...
ConvergenceTest *Broyden::getConvergenceTest(void)
{
    return theTest;
}

int Broyden::sendSelf(int cTag, Channel & theChannel)
{
    static ID data(2);
    data(0) = tangent;
    data(1) = numberLoops;
...
void Broyden::Print(OPS_Stream & s, int flag)
{
    if (flag == 0) {
        s << "Broyden" << endln;
