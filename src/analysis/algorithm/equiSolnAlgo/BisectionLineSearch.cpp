...
BisectionLineSearch::BisectionLineSearch(double tol, int mIter,
                                         double mnEta, double mxEta,
                                         int
                                         pFlag):LineSearch
    (LINESEARCH_TAGS_BisectionLineSearch), x(0), tolerance(tol),
...
int BisectionLineSearch::sendSelf(int cTag, Channel & theChannel)
{
    return 0;
}

int BisectionLineSearch::recvSelf(int cTag,
                                  Channel & theChannel,
...
void BisectionLineSearch::Print(OPS_Stream & s, int flag)
{
    if (flag == 0) {
