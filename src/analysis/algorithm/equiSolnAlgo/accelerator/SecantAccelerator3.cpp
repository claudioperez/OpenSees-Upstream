...
SecantAccelerator3::SecantAccelerator3(int maxIter,
                                       int
                                       tangent):Accelerator
    (ACCELERATOR_TAGS_Secant), iteration(0), numEqns(0), R1(0.0), R2(0.0),
...
int SecantAccelerator3::accelerate(Vector & vStar, LinearSOE & theSOE,
...
void SecantAccelerator3::Print(OPS_Stream & s, int flag)
{
...
int SecantAccelerator3::sendSelf(int commitTag, Channel & theChannel)
{
    return -1;
}

int SecantAccelerator3::recvSelf(int commitTag, Channel & theChannel,
