...
DifferenceAccelerator::DifferenceAccelerator(int max,
                                             int
                                             tangent):Accelerator
...
int DifferenceAccelerator::accelerate(Vector & vStar, LinearSOE & theSOE,
...
void DifferenceAccelerator::Print(OPS_Stream & s, int flag)
{
    s << "DifferenceAccelerator" << endln;
    s << "\tMax subspace dimension: " << maxDimension << endln;
}

int DifferenceAccelerator::sendSelf(int commitTag, Channel & theChannel)
{
    return -1;
}

int DifferenceAccelerator::recvSelf(int commitTag, Channel & theChannel,
