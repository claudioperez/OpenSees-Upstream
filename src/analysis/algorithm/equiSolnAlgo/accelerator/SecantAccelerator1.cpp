...
SecantAccelerator1::SecantAccelerator1(int maxIter,
                                       int
                                       tangent):Accelerator
...
int SecantAccelerator1::accelerate(Vector & vStar, LinearSOE & theSOE,
...
void SecantAccelerator1::Print(OPS_Stream & s, int flag)
{
...
int SecantAccelerator1::sendSelf(int commitTag, Channel & theChannel)
{
    return -1;
}

int SecantAccelerator1::recvSelf(int commitTag, Channel & theChannel,
