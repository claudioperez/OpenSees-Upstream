...
// Constructor
NewtonHallM::NewtonHallM(double initFactor, int mthd, double alphaFact,
                         double
                         cFact):EquiSolnAlgo
    (EquiALGORITHM_TAGS_NewtonHallM), numIterations(0), method(mthd),
alpha(alphaFact), c(cFact), iFactor(initFactor), cFactor(cFact)
{

}

NewtonHallM::NewtonHallM():EquiSolnAlgo(EquiALGORITHM_TAGS_NewtonHallM),
numIterations(0), method(0), alpha(.1), c(0),
iFactor(0.1)
{
 ...
 NewtonHallM::solveCurrentStep(void)
{
    ...
    if ((theAnaModel == 0) || (theIntegrator == 0) || (theSOE == 0)
        || (theTest == 0)) {
        opserr <<
            "WARNING NewtonHallM::solveCurrentStep() - setLinks() has";
        opserr <<
...
int NewtonHallM::sendSelf(int cTag, Channel & theChannel)
{
...
int NewtonHallM::recvSelf(int cTag,
                          Channel & theChannel,
...
void NewtonHallM::Print(OPS_Stream & s, int flag)
{
    if (flag == 0) {
        s << "NewtonHallM" << endln;
        if (method == 0)
...
int NewtonHallM::getNumIterations(void)
{
