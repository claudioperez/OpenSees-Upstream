...
SecantLineSearch::SecantLineSearch(double tol, int mIter, double mnEta,
                                   ...
                                   int
                                   pFlag):LineSearch
    (LINESEARCH_TAGS_SecantLineSearch), x(0), tolerance(tol),
...
int SecantLineSearch::search(double s0,
                             double s1,
                             LinearSOE & theSOE,
...
int SecantLineSearch::sendSelf(int cTag, Channel & theChannel)
{
    return 0;
}

int SecantLineSearch::recvSelf(int cTag,
                               Channel & theChannel,
...
void SecantLineSearch::Print(OPS_Stream & s, int flag)
{
    if (flag == 0) {
