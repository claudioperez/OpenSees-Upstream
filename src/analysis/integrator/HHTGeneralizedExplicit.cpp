...
HHTGeneralizedExplicit::HHTGeneralizedExplicit(double _rhoB,
                                               double _alphaF,
                                               bool
...
Utdot(0),
Utdotdot(0),
U(0), Udot(0), Udotdot(0), Ualpha(0), Ualphadot(0), Ualphadotdot(0)
{
...
HHTGeneralizedExplicit::HHTGeneralizedExplicit(double _alphaI,
                                               ...
                                               bool
                                               updelemdisp):TransientIntegrator
    (INTEGRATOR_TAGS_HHTGeneralizedExplicit), alphaI(_alphaI),
alphaF(_alphaF), beta(_beta), gamma(_gamma), updElemDisp(updelemdisp),
deltaT(0.0), updateCount(0), c1(0.0), c2(0.0), c3(0.0), Ut(0), Utdot(0),
 ...
 HHTGeneralizedExplicit::newStep(double _deltaT)
{
    ...
    if (deltaT <= 0.0) {
        opserr <<
            "HHTGeneralizedExplicit::newStep() - error in variable\n";
...
const Vector & HHTGeneralizedExplicit::getVel()
{
    return *Udot;
}
...
int HHTGeneralizedExplicit::recvSelf(int cTag, Channel & theChannel,
