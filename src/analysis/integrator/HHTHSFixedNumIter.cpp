...
int
HHTHSFixedNumIter::formEleTangent (FE_Element * theEle)
{
    theEle->zeroTangent ();
...
int
HHTHSFixedNumIter::formNodTangent (DOF_Group * theDof)
{
    theDof->zeroTangent ();
...
int
HHTHSFixedNumIter::domainChanged ()
{
    AnalysisModel *theModel = this->getAnalysisModel ();
...
int
HHTHSFixedNumIter::sendSelf (int cTag, Channel & theChannel)
{
    Vector data (6);
    data (0) = alphaI;
    data (1) = alphaF;
...
int
HHTHSFixedNumIter::recvSelf (int cTag, Channel & theChannel,
...
void
HHTHSFixedNumIter::Print (OPS_Stream & s, int flag)
{
    AnalysisModel *theModel = this->getAnalysisModel ();
    if (theModel != 0)
      {
