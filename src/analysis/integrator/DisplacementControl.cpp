...
void *
OPS_DisplacementControlIntegrator ()
{
...
Vector *
DisplacementControl::formTangDispSensitivity (Vector * dUhatdh,
                                              int gradNumber)
{
...
int
DisplacementControl::saveSensitivity (const Vector & v, int gradNum,
                                      int numGrads)
{
    AnalysisModel *theAnalysisModel = this->getAnalysisModel ();
...
int
DisplacementControl::saveLambdaSensitivity (double dlambdadh, int gradNum,
                                            int numGrads)
{
    AnalysisModel *theAnalysisModel = this->getAnalysisModel ();
    Domain *theDomain = theAnalysisModel->getDomainPtr ();
