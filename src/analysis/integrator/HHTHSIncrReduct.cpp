...
int
HHTHSIncrReduct::revertToLastStep ()
{
...
int
HHTHSIncrReduct::formEleTangent (FE_Element * theEle)
{
    theEle->zeroTangent ();
...
int
HHTHSIncrReduct::formNodTangent (DOF_Group * theDof)
{
    theDof->zeroTangent ();
...
int
HHTHSIncrReduct::update (const Vector & deltaU)
{
    AnalysisModel *theModel = this->getAnalysisModel ();
    if (theModel == 0)
      {
...
int
HHTHSIncrReduct::sendSelf (int cTag, Channel & theChannel)
{
    Vector data (5);
    data (0) = alphaI;
    data (1) = alphaF;
...
int
HHTHSIncrReduct::recvSelf (int cTag, Channel & theChannel,
...
void
HHTHSIncrReduct::Print (OPS_Stream & s, int flag)
{
    AnalysisModel *theModel = this->getAnalysisModel ();
    if (theModel != 0)
      {
