...
int
CollocationHSIncrLimit::revertToLastStep ()
{
...
int
CollocationHSIncrLimit::formEleTangent (FE_Element * theEle)
{
    theEle->zeroTangent ();
...
int
CollocationHSIncrLimit::formNodTangent (DOF_Group * theDof)
{
    theDof->zeroTangent ();
...
int
CollocationHSIncrLimit::domainChanged ()
{
    AnalysisModel *theModel = this->getAnalysisModel ();
...
int
CollocationHSIncrLimit::update (const Vector & deltaU)
{
    AnalysisModel *theModel = this->getAnalysisModel ();
    if (theModel == 0)
      {
...
int
CollocationHSIncrLimit::commit (void)
{
    AnalysisModel *theModel = this->getAnalysisModel ();
    if (theModel == 0)
      {
...
int
CollocationHSIncrLimit::sendSelf (int cTag, Channel & theChannel)
{
...
int
CollocationHSIncrLimit::recvSelf (int cTag, Channel & theChannel,
...
void
CollocationHSIncrLimit::Print (OPS_Stream & s, int flag)
{
    AnalysisModel *theModel = this->getAnalysisModel ();
    if (theModel != 0)
      {
