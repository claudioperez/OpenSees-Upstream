...
int
HHTGeneralized_TP::revertToLastStep ()
{
...
int
HHTGeneralized_TP::formUnbalance ()
{
    // get a pointer to the LinearSOE and the AnalysisModel
    LinearSOE *theLinSOE = this->getLinearSOE ();
    AnalysisModel *theModel = this->getAnalysisModel ();
...
int
HHTGeneralized_TP::formEleTangent (FE_Element * theEle)
{
    theEle->zeroTangent ();
...
int
HHTGeneralized_TP::formNodTangent (DOF_Group * theDof)
{
    theDof->zeroTangent ();
...
int
HHTGeneralized_TP::formEleResidual (FE_Element * theEle)
{
    theEle->zeroResidual ();
...
int
HHTGeneralized_TP::formNodUnbalance (DOF_Group * theDof)
{
...
int
HHTGeneralized_TP::domainChanged ()
{
    AnalysisModel *theModel = this->getAnalysisModel ();
    LinearSOE *theLinSOE = this->getLinearSOE ();
...
int
HHTGeneralized_TP::update (const Vector & deltaU)
{
    AnalysisModel *theModel = this->getAnalysisModel ();
    if (theModel == 0)
      {
...
int
HHTGeneralized_TP::sendSelf (int cTag, Channel & theChannel)
{
    Vector data (4);
    data (0) = alphaI;
    data (1) = alphaF;
...
int
HHTGeneralized_TP::recvSelf (int cTag, Channel & theChannel,
...
void
HHTGeneralized_TP::Print (OPS_Stream & s, int flag)
{
    AnalysisModel *theModel = this->getAnalysisModel ();
    if (theModel != 0)
      {
