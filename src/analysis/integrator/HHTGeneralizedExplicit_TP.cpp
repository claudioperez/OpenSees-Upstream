...
HHTGeneralizedExplicit_TP::HHTGeneralizedExplicit_TP(double _rhoB,
                                                     double
                                                     _alphaF):TransientIntegrator
    (INTEGRATOR_TAGS_HHTGeneralizedExplicit_TP),
...
HHTGeneralizedExplicit_TP::HHTGeneralizedExplicit_TP(double _alphaI,
                                                     ...
                                                     double _beta,
                                                     double
                                                     _gamma):TransientIntegrator
    (INTEGRATOR_TAGS_HHTGeneralizedExplicit_TP), alphaI(_alphaI),
alphaF(_alphaF), beta(_beta), gamma(_gamma), deltaT(0.0), updateCount(0),
c1(0.0), c2(0.0), c3(0.0), alphaM(0.0), alphaD(alphaF), alphaR(alphaF),
...
const Vector & HHTGeneralizedExplicit_TP::getVel()
{
    return *Udot;
}
...
int HHTGeneralizedExplicit_TP::recvSelf(int cTag, Channel & theChannel,
