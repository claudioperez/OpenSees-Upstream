...
int
GeneralizedAlpha::revertToLastStep ()
{
...
int
GeneralizedAlpha::formEleTangent (FE_Element * theEle)
{
    theEle->zeroTangent ();
...
int
GeneralizedAlpha::formNodTangent (DOF_Group * theDof)
{
    theDof->zeroTangent ();
...
int
GeneralizedAlpha::domainChanged ()
{
...
int
GeneralizedAlpha::update (const Vector & deltaU)
{
    AnalysisModel *theModel = this->getAnalysisModel ();
    if (theModel == 0)
      {
...
int
GeneralizedAlpha::sendSelf (int cTag, Channel & theChannel)
{
    Vector data (4);
    data (0) = alphaF;
    data (1) = alphaM;
...
int
GeneralizedAlpha::recvSelf (int cTag, Channel & theChannel,
