...
NewmarkHSIncrReduct::NewmarkHSIncrReduct(double _gamma,
    ...
    (INTEGRATOR_TAGS_NewmarkHSIncrReduct), gamma(_gamma), beta(_beta),
reduct(_reduct), c1(0.0), c2(0.0), c3(0.0), Ut(0), Utdot(0), Utdotdot(0),
U(0), Udot(0), Udotdot(0), scaledDeltaU(0)
{
...
const Vector & NewmarkHSIncrReduct::getVel()
{
    return *Udot;
}
...
int NewmarkHSIncrReduct::recvSelf(int cTag, Channel & theChannel,
