...
int
HHTHSIncrLimit_TP::revertToLastStep ()
{
...
int
HHTHSIncrLimit_TP::formUnbalance ()
{
    // get a pointer to the LinearSOE and the AnalysisModel
    LinearSOE *theLinSOE = this->getLinearSOE ();
    AnalysisModel *theModel = this->getAnalysisModel ();
...
int
HHTHSIncrLimit_TP::formEleTangent (FE_Element * theEle)
{
    theEle->zeroTangent ();
...
int
HHTHSIncrLimit_TP::formNodTangent (DOF_Group * theDof)
{
    theDof->zeroTangent ();
...
int
HHTHSIncrLimit_TP::formEleResidual (FE_Element * theEle)
{
    theEle->zeroResidual ();
...
int
HHTHSIncrLimit_TP::formNodUnbalance (DOF_Group * theDof)
{
...
int
HHTHSIncrLimit_TP::domainChanged ()
{
    AnalysisModel *theModel = this->getAnalysisModel ();
    LinearSOE *theLinSOE = this->getLinearSOE ();
...
int
HHTHSIncrLimit_TP::update (const Vector & deltaU)
{
    AnalysisModel *theModel = this->getAnalysisModel ();
    if (theModel == 0)
      {
...
int
HHTHSIncrLimit_TP::sendSelf (int cTag, Channel & theChannel)
{
    Vector data (6);
    data (0) = alphaI;
    data (1) = alphaF;
...
int
HHTHSIncrLimit_TP::recvSelf (int cTag, Channel & theChannel,
...
void
HHTHSIncrLimit_TP::Print (OPS_Stream & s, int flag)
{
    AnalysisModel *theModel = this->getAnalysisModel ();
    if (theModel != 0)
      {
