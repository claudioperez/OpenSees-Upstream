...
NewmarkHSIncrLimit::NewmarkHSIncrLimit(double _gamma,
    ...
    (INTEGRATOR_TAGS_NewmarkHSIncrLimit), gamma(_gamma), beta(_beta),
limit(_limit), normType(normtype), c1(0.0), c2(0.0), c3(0.0), Ut(0),
...
const Vector & NewmarkHSIncrLimit::getVel()
{
    return *Udot;
}
...
int NewmarkHSIncrLimit::recvSelf(int cTag, Channel & theChannel,
