...
int
HHTGeneralized::revertToLastStep ()
{
...
int
HHTGeneralized::formEleTangent (FE_Element * theEle)
{
    theEle->zeroTangent ();
...
int
HHTGeneralized::formNodTangent (DOF_Group * theDof)
{
    theDof->zeroTangent ();
...
int
HHTGeneralized::update (const Vector & deltaU)
{
    AnalysisModel *theModel = this->getAnalysisModel ();
    if (theModel == 0)
      {
...
const Vector &
HHTGeneralized::getVel ()
{
    return *Udot;
}

int
HHTGeneralized::sendSelf (int cTag, Channel & theChannel)
{
    Vector data (4);
    data (0) = alphaI;
    data (1) = alphaF;
...
int
HHTGeneralized::recvSelf (int cTag, Channel & theChannel,
...
void
HHTGeneralized::Print (OPS_Stream & s, int flag)
{
    AnalysisModel *theModel = this->getAnalysisModel ();
    if (theModel != 0)
      {
