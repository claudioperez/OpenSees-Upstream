...
int
HHTExplicit_TP::formEleTangent (FE_Element * theEle)
{
    theEle->zeroTangent ();
...
int
HHTExplicit_TP::formNodTangent (DOF_Group * theDof)
{
    theDof->zeroTangent ();
...
int
HHTExplicit_TP::formEleResidual (FE_Element * theEle)
{
    theEle->zeroResidual ();
...
int
HHTExplicit_TP::formNodUnbalance (DOF_Group * theDof)
{
...
int
HHTExplicit_TP::update (const Vector & aiPlusOne)
{
    updateCount++;
    if (updateCount > 1)
      {
...
int
HHTExplicit_TP::sendSelf (int cTag, Channel & theChannel)
{
    Vector data (2);
    data (0) = alpha;
    data (1) = gamma;
...
int
HHTExplicit_TP::recvSelf (int cTag, Channel & theChannel,
...
void
HHTExplicit_TP::Print (OPS_Stream & s, int flag)
{
    AnalysisModel *theModel = this->getAnalysisModel ();
    if (theModel != 0)
      {
