...
CollocationHSIncrReduct::CollocationHSIncrReduct(double _theta,
    ...
    (INTEGRATOR_TAGS_CollocationHSIncrReduct), theta(_theta), beta(0.0),
gamma(0.5), reduct(_reduct), deltaT(0.0), c1(0.0), c2(0.0), c3(0.0), Ut(0),
Utdot(0), Utdotdot(0), U(0), Udot(0), Udotdot(0), scaledDeltaU(0)
{
...
CollocationHSIncrReduct::CollocationHSIncrReduct(double _theta,
                                                 ...
                                                 double
                                                 _reduct):TransientIntegrator
    (INTEGRATOR_TAGS_CollocationHSIncrReduct), theta(_theta), beta(_beta),
gamma(_gamma), reduct(_reduct), deltaT(0.0), c1(0.0), c2(0.0), c3(0.0),
Ut(0), Utdot(0), Utdotdot(0), U(0), Udot(0), Udotdot(0), scaledDeltaU(0)
{
...
const Vector & CollocationHSIncrReduct::getVel()
{
    return *Udot;
}
...
int CollocationHSIncrReduct::recvSelf(int cTag, Channel & theChannel,
