...
int
CollocationHSFixedNumIter::revertToLastStep ()
{
...
int
CollocationHSFixedNumIter::formEleTangent (FE_Element * theEle)
{
    theEle->zeroTangent ();
...
int
CollocationHSFixedNumIter::formNodTangent (DOF_Group * theDof)
{
    theDof->zeroTangent ();
...
int
CollocationHSFixedNumIter::domainChanged ()
{
    AnalysisModel *theModel = this->getAnalysisModel ();
...
int
CollocationHSFixedNumIter::commit (void)
{
    AnalysisModel *theModel = this->getAnalysisModel ();
    if (theModel == 0)
      {
...
int
CollocationHSFixedNumIter::sendSelf (int cTag, Channel & theChannel)
{
...
int
CollocationHSFixedNumIter::recvSelf (int cTag, Channel & theChannel,
...
void
CollocationHSFixedNumIter::Print (OPS_Stream & s, int flag)
{
    AnalysisModel *theModel = this->getAnalysisModel ();
    if (theModel != 0)
      {
