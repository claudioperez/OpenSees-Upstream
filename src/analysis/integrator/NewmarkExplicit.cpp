...
NewmarkExplicit::
NewmarkExplicit(double
                _gamma):TransientIntegrator
(INTEGRATOR_TAGS_NewmarkExplicit), gamma(_gamma), updateCount(0), c2(0.0), c3(0.0),
Ut(0), Utdot(0), Utdotdot(0), U(0), Udot(0), Udotdot(0)
{
...
const Vector & NewmarkExplicit::getVel()
{
    return *Udot;
}
...
int NewmarkExplicit::recvSelf(int cTag, Channel & theChannel,
