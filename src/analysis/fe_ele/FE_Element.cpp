...
Matrix
FE_Element::errMatrix (1, 1);
Vector
FE_Element::errVector (1);
Matrix **
    FE_Element::theMatrices;    // pointers to class wide matrices
Vector **
    FE_Element::theVectors;     // pointers to class widde vectors
int
FE_Element::numFEs (0);         // number of objects
          ...
          if (myEle->isSubdomain () == false)
            {
                ...
                if (theResidual->
                    addMatrixVector (1.0, *theTangent, tmp, fact) < 0)
                  {
          ...
          else
            {
                Subdomain *theSub = (Subdomain *) myEle;
                if (theResidual->
                    addMatrixVector (1.0, theSub->getTang (), tmp, fact) < 0)
                  {
                      opserr << "WARNING FE_Element::getTangForce() - ";
                      opserr << "- addMatrixVector returned error\n";
                  }
    ...
    if (myEle != 0)
      {
          ...
          if (theResidual->
              addMatrixVector (1.0, myEle->getTangentStiff (), tmp, fact) < 0)
            {
    ...
    if (myEle != 0)
      {
          ...
          if (theResidual->
              addMatrixVector (1.0, myEle->getInitialStiff (), tmp, fact) < 0)
            {
                opserr << "WARNING FE_Element::getKForce() - ";
                opserr << "- addMatrixVector returned error\n";
            }
    ...
    if (myEle != 0)
      {
          ...
          if (theResidual->
              addMatrixVector (1.0, myEle->getMass (), tmp, fact) < 0)
            {
    ...
    if (myEle != 0)
      {
          ...
          if (theResidual->
              addMatrixVector (1.0, myEle->getDamp (), tmp, fact) < 0)
            {
          ...
          if (myEle->isSubdomain () == false)
            {
                ...
                if (theResidual->
                    addMatrixVector (1.0, myEle->getTangentStiff (), tmp,
                                     fact) < 0)
                  {
          ...
          if (myEle->isSubdomain () == false)
            {
                ...
                if (theResidual->
                    addMatrixVector (1.0, myEle->getGeometricTangentStiff (),
                                     tmp, fact) < 0)
                  {
...
void
FE_Element::addM_ForceSensitivity (int gradNumber, const Vector & vect,
                                   double fact)
{
    // Get the components we need out of the vector
    // and place in a temporary vector
    ...
    if (theResidual->
        addMatrixVector (1.0, myEle->getMassSensitivity (gradNumber), tmp,
                         fact) < 0)
      {
...
void
FE_Element::addD_ForceSensitivity (int gradNumber, const Vector & vect,
                                   double fact)
{
    if (myEle != 0)
      {
          ...
          if (myEle->isSubdomain () == false)
            {
                ...
                if (theResidual->
                  ...
                  {
                      opserr <<
                          "WARNING FE_Element::addD_ForceSensitivity() - ";
                      opserr << "- addMatrixVector returned error\n";
                  }
            }
          else
...
void
FE_Element::addLocalD_ForceSensitivity (int gradNumber, const Vector & accel,
                                        double fact)
{
    if (myEle != 0)
      {
...
void
FE_Element::addLocalM_ForceSensitivity (int gradNumber, const Vector & accel,
                                        double fact)
{
    if (myEle != 0)
      {
