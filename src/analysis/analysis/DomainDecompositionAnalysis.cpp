...
DomainDecompositionAnalysis::DomainDecompositionAnalysis(Subdomain & the_Domain):Analysis(the_Domain),
...
theSOE(0),
theSolver(0),
theResidual(0), numEqn(0), numExtEqn(0), tangFormed(false),
tangFormedCount(0), domainStamp(0), myChannel(0)
{
...
DomainDecompositionAnalysis::DomainDecompositionAnalysis(int clsTag,
                                                         Subdomain &
                                                         the_Domain):Analysis
    (the_Domain), MovableObject(clsTag), theSubdomain(&the_Domain),
theHandler(0), theNumberer(0), theModel(0), theAlgorithm(0),
theIntegrator(0), theSOE(0), theSolver(0), theResidual(0), numEqn(0),
numExtEqn(0), tangFormed(false), tangFormedCount(0), domainStamp(0),
myChannel(0)
{

}

DomainDecompositionAnalysis::DomainDecompositionAnalysis(Subdomain & the_Domain, ConstraintHandler & handler, DOF_Numberer & numberer, AnalysisModel & model, DomainDecompAlgo & theSolnAlgo, IncrementalIntegrator & integrator, LinearSOE & theLinSOE, DomainSolver & theDDSolver, ConvergenceTest * theTest):Analysis(the_Domain),
MovableObject(DomDecompANALYSIS_TAGS_DomainDecompositionAnalysis),
theSubdomain(&the_Domain),
theHandler(&handler),
...
int DomainDecompositionAnalysis::analyze(double dT)
{
    return 0;
}

int DomainDecompositionAnalysis::initialize(void)
{
    return 0;
}


bool DomainDecompositionAnalysis::doesIndependentAnalysis(void)
{
    return false;
}

int DomainDecompositionAnalysis::domainChanged(void)
{
...
int DomainDecompositionAnalysis::getNumExternalEqn(void)
{
    return numExtEqn;
}

int DomainDecompositionAnalysis::getNumInternalEqn(void)
{
    return numEqn - numExtEqn;
}

int DomainDecompositionAnalysis::newStep(double dT)
{
    return theIntegrator->newStep(dT);
}

int DomainDecompositionAnalysis::analysisStep(double dT)
{
    return theIntegrator->newStep(dT);
}

int DomainDecompositionAnalysis::eigenAnalysis(int numMode,
                                               bool generalized,
                                               bool findSmallest)
{
    opserr <<
        "DomainDecompositionAnalysis::eigenAnalysis() - should not be called\n";
    return -1;;
}

int DomainDecompositionAnalysis::setEigenSOE(EigenSOE & theSOE)
{
    opserr <<
        "DomainDecompositionAnalysis::setEigenSOE() - should not be called\n";
    return -1;;
}

int DomainDecompositionAnalysis::computeInternalResponse(void)
{
    return theAlgorithm->solveCurrentStep();
}


int DomainDecompositionAnalysis::formTangent(void)
{
    int result = 0;
...
int DomainDecompositionAnalysis::formResidual(void)
{
    int result = 0;
    Domain *the_Domain = this->getDomainPtr();
...
int DomainDecompositionAnalysis::formTangVectProduct(Vector & u)
{
    int result = 0;
...
Subdomain *DomainDecompositionAnalysis::getSubdomainPtr(void) const
{
    return theSubdomain;
}
...
ConstraintHandler *DomainDecompositionAnalysis::
getConstraintHandlerPtr(void) const
{
    return theHandler;
}
...
DOF_Numberer *DomainDecompositionAnalysis::getDOF_NumbererPtr(void) const
{
    return theNumberer;
}
...
AnalysisModel *DomainDecompositionAnalysis::getAnalysisModelPtr(void) const
{
    return theModel;
}
...
DomainDecompAlgo *DomainDecompositionAnalysis::getDomainDecompAlgoPtr(void) const
{
    return theAlgorithm;
}
...
LinearSOE *DomainDecompositionAnalysis::getLinSOEPtr(void) const
{
    return theSOE;
}
...
DomainSolver *DomainDecompositionAnalysis::getDomainSolverPtr(void) const
{
    return theSolver;
}


int DomainDecompositionAnalysis::sendSelf(int commitTag,
                                          Channel & theChannel)
{
...
int DomainDecompositionAnalysis::recvSelf(int commitTag,
                                          Channel & theChannel,
...
int DomainDecompositionAnalysis::setAlgorithm(EquiSolnAlgo & theAlgorithm)
{
    opserr <<
        "DomainDecompositionAnalysis::setAlgorithm() - not implemented\n";
    return -1;
}

int DomainDecompositionAnalysis::
setIntegrator(IncrementalIntegrator & theIntegrator)
{
    opserr <<
        "DomainDecompositionAnalysis::setIntegrator() - not implemented\n";
    return -1;
}


int DomainDecompositionAnalysis::setLinearSOE(LinearSOE & theSOE)
{
    opserr <<
        "DomainDecompositionAnalysis::setLinearSOE() - not implemented\n";
    return -1;
}

int DomainDecompositionAnalysis::
setConvergenceTest(ConvergenceTest & theTest)
{
    opserr <<
        "DomainDecompositionAnalysis::setConvergenceTest() - not implemented\n";
    return -1;
}



int DomainDecompositionAnalysis::checkAllResult(int mine)
{
    static ID data(1);
    data(0) = mine;
    if (myChannel != 0) {
