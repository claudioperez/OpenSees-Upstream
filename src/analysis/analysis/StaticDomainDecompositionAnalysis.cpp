...
StaticDomainDecompositionAnalysis::StaticDomainDecompositionAnalysis (Subdomain & the_Domain):DomainDecompositionAnalysis (ANALYSIS_TAGS_StaticDomainDecompositionAnalysis,
                             the_Domain), theConstraintHandler (0),
theDOF_Numberer (0), theAnalysisModel (0), theAlgorithm (0), theSOE (0),
theEigenSOE (0), theIntegrator (0), theTest (0), domainStamp (0)
{

}

StaticDomainDecompositionAnalysis::
StaticDomainDecompositionAnalysis (Subdomain & the_Domain,
                                   ...
                                   bool setLinks):
DomainDecompositionAnalysis (ANALYSIS_TAGS_StaticDomainDecompositionAnalysis,
                             the_Domain),
...
int
StaticDomainDecompositionAnalysis::eigenAnalysis (int numMode,
                                                  bool generalized,
                                                  bool findSmallest)
{
...
int
StaticDomainDecompositionAnalysis::sendSelf (int commitTag,
                                             Channel & theChannel)
{
...
int
StaticDomainDecompositionAnalysis::recvSelf (int commitTag,
                                             Channel & theChannel,
