...
double
invert2by2Matrix (const Matrix & a, Matrix & b)
{
    return a.Invert (b);
...
double
invert3by3Matrix (const Matrix & a, Matrix & b)
{
    return a.Invert (b);
...
void
invertMatrix (int n, const Matrix & a, Matrix & b)
{
    a.Invert (b);
}
...
void
getCBDIinfluenceMatrix (int nIntegrPts, const Matrix & xi_pt, double L,
                        Matrix & ls)
{
    ...
    if (G.Solve (I, Ginv) < 0)
        opserr <<
            "LargeDispBeamCol3d::getCBDIinfluenceMatrix() - could not invert G\n";
...
void
getCBDIinfluenceMatrix (int nIntegrPts, double *pts, double L, Matrix & ls)
{
    // setup Vandermode and CBDI influence matrices
    int i, j, i0, j0;
    double xi;
...
void
getCBDIinfluenceMatrix (int nPts, double *pts, int nIntegrPts,
                        double *integrPts, double L, Matrix & ls)
{
    // setup Vandermode and CBDI influence matrices
    int i, j, i0, j0;
    double xi;
