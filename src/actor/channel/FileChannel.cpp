...
int FileChannel::sendMsg(int dbTag, int commitTag, const Message &,
                         ChannelAddress * theAddress)
{
    return 0;
}

int FileChannel::recvMsg(int dbTag, int commitTag, Message &,
                         ChannelAddress * theAddress)
{
    return 0;
}
...
int FileChannel::sendID(int dbTag, int commitTag, const ID & theID,
                        ChannelAddress * theAddress)
{
    int i;
...
int FileChannel::sendnDarray(int dbTag, int commitTag,
...
int FileChannel::recvnDarray(int dbTag, int commitTag,
                             nDarray & theNDarray,
                             ChannelAddress * theAddress)
{
    int rank, elem, i, j;
    ...
    if (rank != n_rank) {
        opserr <<
            "FileChannel::recvnDarray, mismatch in rank of nDArray\n";
        return -1;
    }
