...
int
FileChannel::setCommitStep (int commitTag)
{
...
int
FileChannel::setNextAddress (const ChannelAddress & otherChannelAddress)
{
    return 0;
}
...
int
FileChannel::sendDomain (int commitTag, Domain * theDomain)
{
    if (!theFile)
        return -1;
...
int
FileChannel::recvDomain (int commitTag, Domain * theDomain)
{
...
int
FileChannel::sendObj (int commitTag,
...
int
FileChannel::recvObj (int commitTag,
...
int
FileChannel::sendMsg (int dbTag, int commitTag, const Message &,
                      ChannelAddress * theAddress)
{
    return 0;
}
...
int
FileChannel::recvMsg (int dbTag, int commitTag, Message &,
                      ChannelAddress * theAddress)
{
    return 0;
}
...
*/
int
FileChannel::recvMsgUnknownSize (int dbTag, int commitTag,
                                 Message & theMessage,
                                 ChannelAddress * theAddress)
{
    opserr <<
        "FileChannel::recvMsgUnknownSize, error, a FileChannel should not " <<
        "receive a message\n";
    return -1;
}

int
FileChannel::sendMatrix (int dbTag, int commitTag,
...
int
FileChannel::recvMatrix (int dbTag, int commitTag,
...
int
FileChannel::sendVector (int dbTag, int commitTag,
...
int
FileChannel::recvVector (int dbTag, int commitTag,
...
int
FileChannel::sendID (int dbTag, int commitTag, const ID & theID,
                     ChannelAddress * theAddress)
{
    int i;
...
int
FileChannel::sendnDarray (int dbTag, int commitTag,
...
int
FileChannel::recvnDarray (int dbTag, int commitTag, nDarray & theNDarray,
                          ChannelAddress * theAddress)
{
    int rank, elem, i, j;
    ...
    if (fread ((void *) &rank, sizeof (int), 1, theFile) != 1)
      {
          opserr <<
              "FileChannel::receivenDarray, error reading rank to file\n";
          return -1;
      }
    ...
    if (elem != n_elem)
      {
          opserr <<
              "FileChannel::recvnDarray, mismatch in length of nDArray\n";
          return -1;
      }
