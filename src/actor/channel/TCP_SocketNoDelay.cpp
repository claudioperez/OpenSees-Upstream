...
int
TCP_SocketNoDelay::recvMatrix (Matrix & theMatrix,
                               ChannelAddress * theAddress)
{
    // first check address is the only address a TCP_SocketNoDelay can send to
    SocketAddress *theSocketAddress = 0;
...
int
TCP_SocketNoDelay::sendMatrix (const Matrix & theMatrix,
                               ChannelAddress * theAddress)
{
    // first check address is the only address a TCP_SocketNoDelay can send to
    SocketAddress *theSocketAddress = 0;
...
int
TCP_SocketNoDelay::recvVector (Vector & theVector,
                               ChannelAddress * theAddress)
{
    // first check address is the only address a TCP_SocketNoDelay can send to
    SocketAddress *theSocketAddress = 0;
...
int
TCP_SocketNoDelay::sendVector (const Vector & theVector,
                               ChannelAddress * theAddress)
{
    // first check address is the only address a TCP_SocketNoDelay can send to
    SocketAddress *theSocketAddress = 0;
    ...
    if (theAddress != 0)
      {
          ...
          if (memcmp ((char *) &other_Addr, (char *) &theSocketAddress->addr,
                      theSocketAddress->addrLength) != 0)
            {
                ...
                opserr <<
                    "TCP_SocketNoDelay::recvID() - a TCP_SocketNoDelay ";
                opserr <<
                    "can only communicate with one other TCP_SocketNoDelay\n";
                return -1;
            }
