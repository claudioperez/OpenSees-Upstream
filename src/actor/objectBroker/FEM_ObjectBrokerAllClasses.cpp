...
FEM_ObjectBrokerAllClasses::FEM_ObjectBrokerAllClasses():lastDomainSolver(0)
{
...
Actor *FEM_ObjectBrokerAllClasses::getNewActor(int classTag,
                                               Channel * theChannel)
{
    switch (classTag) {
...
PartitionedModelBuilder
    *FEM_ObjectBrokerAllClasses::getPtrNewPartitionedModelBuilder(Subdomain
                                                                  &
                                                                  theSubdomain,
                                                                  int
                                                                  classTag)
{
    ...
    default:
        opserr <<
            "FEM_ObjectBrokerAllClasses::getPtrNewPartitionedModelBuilder - ";
        opserr <<
...
GraphNumberer *FEM_ObjectBrokerAllClasses::
getPtrNewGraphNumberer(int classTag)
{
    switch (classTag) {
...
Element *FEM_ObjectBrokerAllClasses::getNewElement(int classTag)
{
    switch (classTag) {
...
Node *FEM_ObjectBrokerAllClasses::getNewNode(int classTag)
{
    switch (classTag) {
    case NOD_TAG_Node:
...
MP_Constraint *FEM_ObjectBrokerAllClasses::getNewMP(int classTag)
{
    switch (classTag) {
...
SP_Constraint *FEM_ObjectBrokerAllClasses::getNewSP(int classTag)
{
    switch (classTag) {
...
Pressure_Constraint *FEM_ObjectBrokerAllClasses::getNewPC(int classTag)
{
    switch (classTag) {
...
NodalLoad *FEM_ObjectBrokerAllClasses::getNewNodalLoad(int classTag)
{
    switch (classTag) {
...
ElementalLoad *FEM_ObjectBrokerAllClasses::
getNewElementalLoad(int classTag)
{
    switch (classTag) {
...
CrdTransf *FEM_ObjectBrokerAllClasses::getNewCrdTransf(int classTag)
{
    switch (classTag) {
...
getNewBeamIntegration(int classTag)
{
    switch (classTag) {
...
UniaxialMaterial *FEM_ObjectBrokerAllClasses::
getNewUniaxialMaterial(int classTag)
{
    ...
    default:
        ...
        while (matCommands != NULL && found == false) {
            if ((matCommands->classTag == classTag)
                && (matCommands->funcPtr != 0)) {
...
SectionForceDeformation *FEM_ObjectBrokerAllClasses::
getNewSection(int classTag)
{
    switch (classTag) {
...
NDMaterial *FEM_ObjectBrokerAllClasses::getNewNDMaterial(int classTag)
{
    switch (classTag) {
...
Fiber *FEM_ObjectBrokerAllClasses::getNewFiber(int classTag)
{
    switch (classTag) {
...
FrictionModel *FEM_ObjectBrokerAllClasses::
getNewFrictionModel(int classTag)
{
    switch (classTag) {
...
getNewConvergenceTest(int classTag)
{
    switch (classTag) {
...
LoadPattern *FEM_ObjectBrokerAllClasses::getNewLoadPattern(int classTag)
{
    switch (classTag) {
...
GroundMotion *FEM_ObjectBrokerAllClasses::getNewGroundMotion(int classTag)
{
    switch (classTag) {
...
TimeSeries *FEM_ObjectBrokerAllClasses::getNewTimeSeries(int classTag)
{
    switch (classTag) {
...
TimeSeriesIntegrator *FEM_ObjectBrokerAllClasses::
getNewTimeSeriesIntegrator(int classTag)
{
    switch (classTag) {
    ...
    default:
        opserr <<
            "FEM_ObjectBrokerAllClasses::getPtrTimeSeriesIntegrator - ";
        opserr << " - no Load type exists for class tag ";
        opserr << classTag << endln;
        return 0;
...
Matrix *FEM_ObjectBrokerAllClasses::getPtrNewMatrix(int classTag,
...
Vector *FEM_ObjectBrokerAllClasses::getPtrNewVector(int classTag, int size)
{
    switch (classTag) {
...
OPS_Stream *FEM_ObjectBrokerAllClasses::getPtrNewStream(int classTag)
{
    switch (classTag) {
...
Recorder *FEM_ObjectBrokerAllClasses::getPtrNewRecorder(int classTag)
{
    switch (classTag) {
...
ConstraintHandler *FEM_ObjectBrokerAllClasses::
getNewConstraintHandler(int classTag)
{
    switch (classTag) {
...
DOF_Numberer *FEM_ObjectBrokerAllClasses::getNewNumberer(int classTag)
{
    switch (classTag) {
...
AnalysisModel *FEM_ObjectBrokerAllClasses::
getNewAnalysisModel(int classTag)
{
    switch (classTag) {
...
EquiSolnAlgo *FEM_ObjectBrokerAllClasses::getNewEquiSolnAlgo(int classTag)
{
    switch (classTag) {
...
Accelerator *FEM_ObjectBrokerAllClasses::getAccelerator(int classTag)
{
    switch (classTag) {
...
LineSearch *FEM_ObjectBrokerAllClasses::getLineSearch(int classTag)
{
    switch (classTag) {
...
DomainDecompAlgo *FEM_ObjectBrokerAllClasses::
...
StaticIntegrator *FEM_ObjectBrokerAllClasses::
...
TransientIntegrator *FEM_ObjectBrokerAllClasses::
getNewTransientIntegrator(int classTag)
{
    ...
    default:
        opserr <<
            "FEM_ObjectBrokerAllClasses::getNewTransientIntegrator - ";
...
IncrementalIntegrator *FEM_ObjectBrokerAllClasses::
getNewIncrementalIntegrator(int classTag)
{
    switch (classTag) {
    case INTEGRATOR_TAGS_LoadControl:
    ...
    default:
        opserr <<
            "FEM_ObjectBrokerAllClasses::getNewIncrementalIntegrator - ";
...
LinearSOE *FEM_ObjectBrokerAllClasses::getNewLinearSOE(int classTagSOE)
{
    LinearSOE *theSOE = 0;
...
EigenSOE *FEM_ObjectBrokerAllClasses::getNewEigenSOE(int classTagSOE)
{
    EigenSOE *theSOE = 0;
...
DomainSolver *FEM_ObjectBrokerAllClasses::getNewDomainSolver(void)
{
    return lastDomainSolver;
}

LinearSOE *FEM_ObjectBrokerAllClasses::
getPtrNewDDLinearSOE(int classTagSOE, int classTagDDSolver)
{
    ...
    case LinSOE_TAGS_ProfileSPDLinSOE:
        ...
        if (classTagDDSolver == SOLVER_TAGS_ProfileSPDLinSubstrSolver) {
            ...
            opserr << "FEM_ObjectBrokerAllClasses::getNewLinearSOE - ";
            opserr <<
                " - no ProfileSPD Domain Solver type exists for class tag ";
...
DomainDecompositionAnalysis *FEM_ObjectBrokerAllClasses::
getNewDomainDecompAnalysis(int classTag, Subdomain & theSubdomain)
{
    switch (classTag) {
...
Subdomain *FEM_ObjectBrokerAllClasses::getSubdomainPtr(int classTag)
{
...
int FEM_ObjectBrokerAllClasses::addUniaxialMaterial(int classTag,
                                                    const char *lib,
                                                    const char *funcName,
                                                    UniaxialMaterial *
                                                    (*funcPtr) (void))
{
    ...
    if (funcPtr == 0) {
        if (getLibraryFunction
            (lib, funcName, &libHandle, (void **) &funcPtr) != 0) {
            opserr <<
                "FEM_ObjectBrokerAllClasses::addUniaxialMaterial - could not find function\n";
            return -1;
        }
    }
    ...
    if (libNameCopy == 0 || funcNameCopy == 0 || theMat == 0) {
        opserr <<
            "FEM_ObjectBrokerAllClasses::addUniaxialMaterial - could not add lib, out of memory\n";
        return -1;
    }
...
Parameter *FEM_ObjectBrokerAllClasses::getParameter(int classTag)
{
    Parameter *theRes = 0;
