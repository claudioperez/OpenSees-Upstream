...
Node *DummyNode::getNode() const
{

    return theRealNode;
}

void DummyNode::setDOF_GroupPtr(DOF_Group * theDOF_Grp)
{
...
DOF_Group *DummyNode::getDOF_GroupPtr(void)
{
    return theDOFGroup;
}
...
int DummyNode::getNumberDOF(void) const
{
...
const Matrix & DummyNode::getMass(void)
{
...
int DummyNode::setMass(const Matrix & m)
{
...
const Vector & DummyNode::getCrds() const
{
    return theRealNode->getCrds();
}


const Vector & DummyNode::getDisp(void)
{
    return theRealNode->getDisp();
}


const Vector & DummyNode::getVel(void)
{
    return theRealNode->getVel();
}


const Vector & DummyNode::getAccel(void)
{
    return theRealNode->getAccel();
}


const Vector & DummyNode::getTrialDisp(void)
{
...
const Vector & DummyNode::getTrialVel(void)
{
...
const Vector & DummyNode::getTrialAccel(void)
{
...
int DummyNode::setTrialDisp(const Vector & displ)
{
    return 0;
}

int DummyNode::setTrialVel(const Vector & vel)
{
    return 0;
}


int DummyNode::setTrialAccel(const Vector & accel)
{
    return 0;
}


int DummyNode::setIncrTrialDisp(const Vector & incrDispl)
{
    return 0;
}


int DummyNode::setIncrTrialVel(const Vector & incrVel)
{
    return 0;
}


int DummyNode::setIncrTrialAccel(const Vector & incrAccel)
{
    return 0;
}


int DummyNode::commitState()
{
    return 0;
}
...
void DummyNode::addUnbalancedLoad(const Vector & add)
{
...
void DummyNode::zeroUnbalancedLoad(void)
{
...
int DummyNode::addElementPtr(Element * elePtr)
{
...
int DummyNode::sendSelf(Channel & theChannel, FEM_ObjectBroker & theBroker)
{
...
int DummyNode::recvSelf(Channel & theChannel, FEM_ObjectBroker & theBroker)
{
