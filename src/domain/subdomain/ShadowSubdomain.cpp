...
int
 ShadowSubdomain::count = 0;    // MHS
int
 ShadowSubdomain::numShadowSubdomains = 0;
...
ShadowSubdomain::ShadowSubdomain(int tag,
                                 ...
                                 FEM_ObjectBroker &
                                 theObjectBroker):Shadow
    (ACTOR_TAGS_SUBDOMAIN, theObjectBroker, theMachineBroker, 0),
...
gotRemoteData(false), theFEele(0), theVector(0), theMatrix(0)
{
...
ShadowSubdomain::ShadowSubdomain(int tag,
                                 Channel & the_Channel,
                                 FEM_ObjectBroker &
                                 theObjectBroker):Shadow(the_Channel,
                                                         theObjectBroker),
Subdomain(tag), msgData(4), theElements(0, 128), theNodes(0, 128),
theExternalNodes(0, 128), theLoadCases(0, 128), theShadowSPs(0),
theShadowMPs(0), theShadowLPs(0), numDOF(0), numElements(0), numNodes(0),
 ...
 ShadowSubdomain::getRemoteData(void)
{
    if (buildRemote == true && gotRemoteData == false) {
        ...
        if (theExternalNodes.Size() != numExternalNodes) {
            opserr <<
                "ShadowSubdomain::getRemoteData(void) - need to resize the ID\n";
            return -1;
        }
...
bool ShadowSubdomain::addElement(Element * theEle)
{
...
bool ShadowSubdomain::addNode(Node * theNode)
{
...
bool ShadowSubdomain::addExternalNode(Node * theNode)
{
    int tag = theNode->getTag();
#ifdef _G3DEBUG
    // do all the checking stuff
...
bool ShadowSubdomain::addSP_Constraint(SP_Constraint * theSP)
{
#ifdef _G3DEBUG
    // do all the checking stuff
#endif
...
int ShadowSubdomain::addSP_Constraint(int axisDirn, double axisValue,
...
bool ShadowSubdomain::addMP_Constraint(MP_Constraint * theMP)
{
#ifdef _G3DEBUG
    // do all the checking stuff
#endif
...
bool ShadowSubdomain::addLoadPattern(LoadPattern * thePattern)
{
#ifdef _G3DEBUG
    // do all the checking stuff
#endif
...
bool ShadowSubdomain::addNodalLoad(NodalLoad * theLoad, int loadPattern)
{
#ifdef _G3DEBUG
    // do all the checking stuff
#endif
...
bool ShadowSubdomain::addElementalLoad(ElementalLoad * theLoad,
                                       int loadPattern)
{
#ifdef _G3DEBUG
    // do all the checking stuff
...
bool ShadowSubdomain::hasNode(int tag)
{
...
bool ShadowSubdomain::hasElement(int tag)
{
...
Element *ShadowSubdomain::removeElement(int tag)
{
...
Node *ShadowSubdomain::removeNode(int tag)
{
...
int ShadowSubdomain::removeSP_Constraint(int theNode, int theDOF,
                                         int loadPatternTag)
{
...
int ShadowSubdomain::removeMP_Constraints(int cNode)
{
    opserr <<
...
MP_Constraint *ShadowSubdomain::removeMP_Constraint(int tag)
{
...
LoadPattern *ShadowSubdomain::removeLoadPattern(int loadTag)
{
...
SP_Constraint *ShadowSubdomain::removeSP_Constraint(int loadTag,
                                                    int loadPattern)
{
    // remove the object from the container            
    TaggedObject *mc = theShadowLPs->getComponentPtr(loadPattern);
...
ElementIter & ShadowSubdomain::getElements()
{
...
NodeIter & ShadowSubdomain::getNodes()
{
...
NodeIter & ShadowSubdomain::getInternalNodeIter(void)
{
...
NodeIter & ShadowSubdomain::getExternalNodeIter(void)
{
...
Element *ShadowSubdomain::getElement(int tag)
{
    ...
    opserr << "ShadowSubdomain::getElement(int tag) 3 type: " << theType <<
        endln;
...
Node *ShadowSubdomain::getNode(int tag)
{
    Node *theNod = 0;
...
int ShadowSubdomain::getNumElements(void) const
{
    return numElements;
}

int ShadowSubdomain::getNumLoadPatterns(void) const
{
    return numLoadPatterns;
}

int ShadowSubdomain::getNumNodes(void) const
{
    return numNodes;
}

int ShadowSubdomain::getNumSPs(void) const
{
    return numSPs;
}

int ShadowSubdomain::getNumMPs(void) const
{
    return numMPs;
}


Graph & ShadowSubdomain::getElementGraph(void)
{
...
Graph & ShadowSubdomain::getNodeGraph(void)
{
...
void ShadowSubdomain::applyLoad(double time)
{
...
void ShadowSubdomain::setCommitTag(int newTag)
{
...
void ShadowSubdomain::setCurrentTime(double time)
{
    DomainDecompositionAnalysis *theDDA = this->getDDAnalysis();
    if (theDDA != 0 && theDDA->doesIndependentAnalysis() != true) {
...
void ShadowSubdomain::setCommittedTime(double time)
{
...
int ShadowSubdomain::setRayleighDampingFactors(double alphaM, double betaK,
                                               double betaK0,
                                               double betaKc)
{
...
int ShadowSubdomain::update(void)
{
    DomainDecompositionAnalysis *theDDA = this->getDDAnalysis();
    if (theDDA != 0 && theDDA->doesIndependentAnalysis() != true) {
...
int ShadowSubdomain::update(double newTime, double dT)
{
    static Vector data(2);
    DomainDecompositionAnalysis *theDDA = this->getDDAnalysis();
    if (theDDA != 0 && theDDA->doesIndependentAnalysis() != true) {
...
int ShadowSubdomain::barrierCheckIN(void)
{
    static ID data(1);
    this->recvID(data);
    return data(0);
...
int ShadowSubdomain::barrierCheckOUT(int result)
{
    static ID data(1);
    data(0) = result;
    this->sendID(data);
...
void ShadowSubdomain::clearAll(void)
{
...
int ShadowSubdomain::addRecorder(Recorder & theRecorder)
{
...
int ShadowSubdomain::removeRecorders(void)
{
...
int ShadowSubdomain::removeRecorder(int tag)
{
...
int ShadowSubdomain::commit(void)
{
    DomainDecompositionAnalysis *theDDA = this->getDDAnalysis();
    if (theDDA != 0 && theDDA->doesIndependentAnalysis() != true) {
...
int ShadowSubdomain::record(bool fromAnalysis)
{
    DomainDecompositionAnalysis *theDDA = this->getDDAnalysis();
    if (theDDA != 0
        && (fromAnalysis == false
            || theDDA->doesIndependentAnalysis() != true)) {
...
int ShadowSubdomain::revertToLastCommit(void)
{
    DomainDecompositionAnalysis *theDDA = this->getDDAnalysis();
    if (theDDA != 0 && theDDA->doesIndependentAnalysis() != true) {
...
int ShadowSubdomain::revertToStart(void)
{
...
void ShadowSubdomain::wipeAnalysis(void)
{
    msgData(0) = ShadowActorSubdomain_wipeAnalysis;
    this->sendID(msgData);
}

void ShadowSubdomain::
setDomainDecompAnalysis(DomainDecompositionAnalysis & theDDAnalysis)
{
...
int ShadowSubdomain::
setAnalysisIntegrator(IncrementalIntegrator & theIntegrator)
{
...
int ShadowSubdomain::setAnalysisConvergenceTest(ConvergenceTest & theTest)
{
...
bool ShadowSubdomain::getDomainChangeFlag(void)
{
...
void ShadowSubdomain::domainChange(void)
{
...
void ShadowSubdomain::clearAnalysis(void)
{
    msgData(0) = ShadowActorSubdomain_clearAnalysis;
    this->sendID(msgData);
}

int ShadowSubdomain::getNumExternalNodes(void) const
{
...
const ID & ShadowSubdomain::getExternalNodes(void)
{
...
int ShadowSubdomain::getNumDOF(void)
{
    // if the subdoamin was built remotly need to get it's data
    if (gotRemoteData == false && buildRemote == true)
        this->getRemoteData();
...
const Matrix & ShadowSubdomain::getTang(void)
{
    // if the subdoamin was built remotly need to get it's data
    if (gotRemoteData == false && buildRemote == true)
        this->getRemoteData();
...
const Vector & ShadowSubdomain::getResistingForce(void)
{
    // if the subdoamin was built remotly need to get it's data
    if (gotRemoteData == false && buildRemote == true)
        this->getRemoteData();
...
int ShadowSubdomain::computeTang(void)
{
    count++;
...
int ShadowSubdomain::computeResidual(void)
{
    count++;
...
int ShadowSubdomain::eigenAnalysis(int numMode, bool generalized,
                                   bool findSmallest)
{
...
double ShadowSubdomain::getCost(void)
{
    /*
...
int ShadowSubdomain::sendSelf(int cTag, Channel & the_Channel)
{
...
int ShadowSubdomain::recvSelf(int cTag, Channel & the_Channel,
...
void ShadowSubdomain::Print(OPS_Stream & s, int flag)
{
...
void ShadowSubdomain::Print(OPS_Stream & s, ID * nodeTags, ID * eleTags,
                            int flag)
{
...
int ShadowSubdomain::buildEleGraph(Graph * theEleGraph)
{
...
int ShadowSubdomain::buildNodeGraph(Graph * theNodeGraph)
{
...
int ShadowSubdomain::buildMap(void)
{
    mapBuilt = true;
    return 0;
}
...
double ShadowSubdomain::getNodeDisp(int nodeTag, int dof, int &errorFlag)
{
...
int ShadowSubdomain::setMass(const Matrix & mass, int nodeTag)
{
...
const Vector *ShadowSubdomain::getElementResponse(int tag,
                                                  const char **argv,
                                                  int argc)
{
    if (theElements.getLocation(tag) < 0)
    ...
    if (allResponseArgs == 0) {
        opserr <<
            "ShadowSubdomain::getElementResponse() - out of memory\n";
        return 0;
    }
    ...
    if (this->sendMessage(theMessage) < 0) {
        opserr <<
            "ShadowSubdomain::getElementResponse() - failed to send message\n";
        return 0;
    }
...
bool ShadowSubdomain::addParameter(Parameter * param)
{
...
Parameter *ShadowSubdomain::removeParameter(int tag)
{
...
int ShadowSubdomain::updateParameter(int tag, double value)
{
