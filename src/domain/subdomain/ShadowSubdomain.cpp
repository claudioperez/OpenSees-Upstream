...
ShadowSubdomain **
    ShadowSubdomain::theShadowSubdomains = 0;

// 2 procedurs defined in SP_Constraint.cpp
int
SP_Constraint_GetNextTag ();
int
SP_Constraint_SetNextTag (int);
...
int
ShadowSubdomain::removeSP_Constraint (int theNode, int theDOF,
                                      int loadPatternTag)
{
...
ElementIter & ShadowSubdomain::getElements ()
{
    ...
    ArrayOfTaggedObjects *
        theEror = new ArrayOfTaggedObjects (1);
    ElementIter *
        theIter = new SingleDomEleIter (theEror);
    return *theIter;
}
...
NodeIter & ShadowSubdomain::getNodes ()
{
    ...
    ArrayOfTaggedObjects *
        theEror = new ArrayOfTaggedObjects (1);
    NodeIter *
        theIter = new SingleDomNodIter (theEror);
    return *theIter;
}
...
int
ShadowSubdomain::setRayleighDampingFactors (double alphaM, double betaK,
