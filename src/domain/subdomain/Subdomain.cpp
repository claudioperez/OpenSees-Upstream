...
Subdomain::Subdomain(int tag):Element(tag, ELE_TAG_Subdomain),
Domain(),
mapBuilt(false),
map(0),
mappedVect(0),
mappedMatrix(0),
realCost(0.0),
cpuCost(0), pageCost(0), theAnalysis(0), extNodes(0), theFEele(0)
{
...
Subdomain::Subdomain(int tag,
                     ...
                     TaggedObjectStorage & theSPsStorage):Element(tag,
                                                                  ELE_TAG_Subdomain),
Domain(theExternalNodeStorage, theElementsStorage, theLoadPatternsStorage,
       theMPsStorage, theSPsStorage), mapBuilt(false), map(0),
mappedVect(0), mappedMatrix(0), internalNodes(&theInternalNodeStorage),
externalNodes(&theExternalNodeStorage), realCost(0.0), cpuCost(0),
pageCost(0), theAnalysis(0), extNodes(0), theFEele(0)
{
    //thePartitionedModelBuilder = 0;
...
bool Subdomain::addNode(Node * node)
{
#ifdef _G3DEBUG
...
bool Subdomain::addExternalNode(Node * thePtr)
{
#ifdef _G3DEBUG
...
Node *Subdomain::removeNode(int tag)
{
...
Node **Subdomain::getNodePtrs(void)
{
...
Node *Subdomain::getNode(int tag)
{
...
bool Subdomain::hasNode(int tag)
{
...
bool Subdomain::hasElement(int tag)
{
...
int Subdomain::revertToLastCommit(void)
{
...
int Subdomain::revertToStart(void)
{
    this->Domain::revertToLastCommit();
...
int Subdomain::update(void)
{
    return this->Domain::update();
}

int Subdomain::update(double newTime, double dT)
{
    return this->Domain::update(newTime, dT);
}

void Subdomain::Print(OPS_Stream & s, int flag)
{
...
void Subdomain::Print(OPS_Stream & s, ID * nodeTags, ID * eleTags,
                      int flag)
{
    if (nodeTags != 0) {
...
void Subdomain::wipeAnalysis(void)
{
    if (theAnalysis != 0) {
...
int Subdomain::setAnalysisAlgorithm(EquiSolnAlgo & theAlgorithm)
{
    if (theAnalysis != 0)
...
int Subdomain::setAnalysisIntegrator(IncrementalIntegrator & theIntegrator)
{
    if (theAnalysis != 0)
...
int Subdomain::setAnalysisLinearSOE(LinearSOE & theSOE)
{
    if (theAnalysis != 0)
...
int Subdomain::setAnalysisEigenSOE(EigenSOE & theSOE)
{
    if (theAnalysis != 0)
...
int Subdomain::setAnalysisConvergenceTest(ConvergenceTest & theTest)
{
    if (theAnalysis != 0)
...
int Subdomain::invokeChangeOnAnalysis(void)
{
    int result = 0;
    if (theAnalysis != 0)
...
int Subdomain::getNumExternalNodes(void) const
{
    return externalNodes->getNumComponents();
}

const ID & Subdomain::getExternalNodes()
{
...
int Subdomain::commitState(void)
{
    return this->commit();
}

const Matrix & Subdomain::getTangentStiff(void)
{
...
const Matrix & Subdomain::getInitialStiff(void)
{
...
const Matrix & Subdomain::getDamp(void)
{
...
const Matrix & Subdomain::getMass(void)
{
...
void Subdomain::zeroLoad(void)
{
    opserr << "Subdomain::zeroLoad() - should not be called\n";
}


int Subdomain::addLoad(ElementalLoad * theLoad, double loadFactor)
{
    opserr << "Subdomain::addLoad() - should not be called\n";
    return 0;
}

int Subdomain::addInertiaLoadToUnbalance(const Vector & accel)
{
    return 0;
}


const Vector & Subdomain::getResistingForce(void)
{
    if (theAnalysis == 0) {
...
const Vector & Subdomain::getResistingForceIncInertia(void)
{
...
bool Subdomain::isSubdomain(void)
{
    return true;
}


int Subdomain::setRayleighDampingFactors(double alphaM, double betaK,
...
int Subdomain::computeTang(void)
{
    if (theAnalysis != 0) {
        //    theTimer.start();
...
int Subdomain::computeResidual(void)
{
    if (theAnalysis != 0) {
        //    theTimer.start();
...
FE_Element *Subdomain::getFE_ElementPtr(void)
{
    return theFEele;
}
...
const Vector & Subdomain::getLastExternalSysResponse(void)
{
    if (theFEele == 0) {
...
int Subdomain::computeNodalResponse(void)
{
    int res = 0;
    if (theAnalysis != 0) {
...
int Subdomain::analysisStep(double dT)
{
    if (theAnalysis != 0)
...
int Subdomain::eigenAnalysis(int numMode, bool generalized,
                             bool findSmallest)
{
    if (theAnalysis != 0)
...
bool Subdomain::doesIndependentAnalysis(void)
{
    if (theAnalysis != 0)
...
int Subdomain::sendSelf(int cTag, Channel & theChannel)
{
...
int Subdomain::recvSelf(int cTag, Channel & theChannel,
...
DomainDecompositionAnalysis *Subdomain::getDDAnalysis(void)
{
    return theAnalysis;
}

int Subdomain::addResistingForceToNodalReaction(bool inclInertia)
{
    return 0;
}

int Subdomain::updateParameter(int tag, int value)
{
    return this->Domain::updateParameter(tag, value);
}

int Subdomain::updateParameter(int tag, double value)
{
    return this->Domain::updateParameter(tag, value);
}
