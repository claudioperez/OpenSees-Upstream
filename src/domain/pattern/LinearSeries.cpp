...
LinearSeries::LinearSeries(int tag, double theFactor):TimeSeries(tag,
                                                                 TSERIES_TAG_LinearSeries),
cFactor(theFactor)
{
    // does nothing
}
...
TimeSeries *LinearSeries::getCopy(void)
{
    return new LinearSeries(this->getTag(), cFactor);
}

double LinearSeries::getFactor(double pseudoTime)
{
    return cFactor * pseudoTime;
}


int LinearSeries::sendSelf(int commitTag, Channel & theChannel)
{
...
int LinearSeries::recvSelf(int commitTag, Channel & theChannel,
...
void LinearSeries::Print(OPS_Stream & s, int flag)
{
