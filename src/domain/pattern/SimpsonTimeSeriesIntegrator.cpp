...
TimeSeries *SimpsonTimeSeriesIntegrator::integrate(TimeSeries * theSeries,
                                                   double delta)
{
...
int SimpsonTimeSeriesIntegrator::sendSelf(int commitTag,
                                          Channel & theChannel)
{
    return 0;
}
...
int SimpsonTimeSeriesIntegrator::recvSelf(int commitTag,
                                          Channel & theChannel,
