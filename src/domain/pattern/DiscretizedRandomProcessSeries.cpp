...
int
DiscretizedRandomProcessSeries::recvSelf (int commitTag, Channel & theChannel,
...
int
DiscretizedRandomProcessSeries::updateParameter (int parameterID,
                                                 Information & info)
{
    // In case the vector doesn't exist
    if (randomVariables == 0)
