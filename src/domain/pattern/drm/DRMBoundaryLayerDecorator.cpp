...
DRMBoundaryLayerDecorator::DRMBoundaryLayerDecorator()
{
...
void DRMBoundaryLayerDecorator::setID(ID * eNodes)
{
    this->eNodeID = eNodes;
    this->cons = 1;
}

void DRMBoundaryLayerDecorator::setMap(std::map < int, int >&eNodes)
{
    this->eNodeMap = eNodes;
    this->cons = 2;
}

void DRMBoundaryLayerDecorator::setSet(std::set < int,
                                       std::less < int > >&eNodes)
{
...
void DRMBoundaryLayerDecorator::setDomain(Domain * theDomain)
{
    this->myDomain = theDomain;
}

void DRMBoundaryLayerDecorator::clearDomain()
{
    this->myDomain = NULL;
}

void DRMBoundaryLayerDecorator::setBrick(Element * brickTag)
{
    this->myBrick = brickTag;
}

void DRMBoundaryLayerDecorator::clearBrick()
{
    this->myBrick = NULL;
}

void DRMBoundaryLayerDecorator::clear()
{
    this->myDomain = NULL;
    this->myBrick = NULL;
}
...
void DRMBoundaryLayerDecorator::get_E_B_Nodes(ID & e, ID & b)
{
...
void DRMBoundaryLayerDecorator::zeroSubmatrix(Matrix & M, int e, int b)
{
...
void DRMBoundaryLayerDecorator::computeDRMLoad(Vector & drmLoad,
                                               const Vector & displ,
                                               const Vector & veloc,
                                               const Vector & accel)
{
...
void DRMBoundaryLayerDecorator::applyDRMLoad(double cfact,
                                             Vector & drmLoad,
                                             const Vector & displ,
                                             const Vector & veloc,
                                             const Vector & accel)
