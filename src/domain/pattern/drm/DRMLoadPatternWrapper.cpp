...
DRMLoadPatternWrapper::DRMLoadPatternWrapper(int ttag, double cfact,
                                             ...
                                             int *filedata,
                                             int fileDatasize, int nd_1,
                                             int nd_2, double *drmboxcrds,
                                             double *ele_D,
                                             int
                                             stepstocache):LoadPattern
    (ttag, PATTERN_TAG_DRMLoadPattern)
{
...
int DRMLoadPatternWrapper::recvSelf(int commitTag, Channel & theChannel,
