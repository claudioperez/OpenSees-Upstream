...
void PlaneDRMInputHandler::getMotions(Element * eletag, double time,
                                      Vector & U, Vector & Ud,
                                      Vector & Udd)
{
...
void PlaneDRMInputHandler::computeHistory(Element * eletag, double time,
                                          Vector & U, Vector & Ud,
                                          Vector & Udd, bool updateDm1)
{
    ...
    Udd =
        (1.0 - mt) * 1 o2dt * (Vtp1 - Vtm2) + mt * 1 o2dt * (Vtp2 - Vtm1);
...
void PlaneDRMInputHandler::handle_elementAtface5(Element * eletag,
                                                 double time, Vector & U,
...
void PlaneDRMInputHandler::handle_elementAtface1(Element * eletag,
                                                 double time, Vector & U,
                                                 Vector & Ud, Vector & Udd)
{
    bool updateDm1 = false;
...
void PlaneDRMInputHandler::handle_elementAtface2(Element * eletag,
                                                 double time, Vector & U,
                                                 Vector & Ud, Vector & Udd)
{
    bool updateDm1 = false;
...
void PlaneDRMInputHandler::handle_elementAtface3(Element * eletag,
                                                 double time, Vector & U,
                                                 Vector & Ud, Vector & Udd)
{
    bool updateDm1 = false;
...
void PlaneDRMInputHandler::handle_elementAtface4(Element * eletag,
                                                 double time, Vector & U,
                                                 Vector & Ud, Vector & Udd)
{
    bool updateDm1 = false;
...
void PlaneDRMInputHandler::getLocations(double x, double y, double dx,
                                        double dy, int *xloc, int *yloc)
{
    *xloc = floor(x / dx);
    *yloc = floor(y / dy);
}
...
void PlaneDRMInputHandler::getf5pointer(Node * node_tag, int local_tag,
                                        int index)
{
...
void PlaneDRMInputHandler::getf1pointer(Node * node_tag, int local_tag,
                                        int index)
{
...
void PlaneDRMInputHandler::getf2pointer(Node * node_tag, int local_tag,
                                        int index)
{
    const Vector & crd = node_tag->getCrds();
    double x = crd(0);
...
void PlaneDRMInputHandler::getf3pointer(Node * node_tag, int local_tag,
                                        int index)
{
    const Vector & crd = node_tag->getCrds();
    double x = crd(0);
...
void PlaneDRMInputHandler::getf4pointer(Node * node_tag, int local_tag,
                                        int index)
{
    bool debug = false;
    const Vector & crd = node_tag->getCrds();
...
void PlaneDRMInputHandler::populateTempBuffers(int index, int fileptr,
