...
GeometricBrickDecorator::evalSignedVol (const Vector & pA,
                                        const Vector & pB,
                                        const Vector & pC, const Vector & pP)
{
...
bool
GeometricBrickDecorator::isFaceinVertPlane (int which, double xy, double zmin,
                                            double zmax, int whichCrd)
{
    /*
...
bool
GeometricBrickDecorator::isLeftBoundary (double xMin, double xMax,
...
bool
GeometricBrickDecorator::isRightBoundary (double xMin, double xMax,
                                          double yMin, double yMax,
                                          double zMin, double zMax)
{
...
bool
GeometricBrickDecorator::isFrontBoundary (double xMin, double xMax,
                                          double yMin, double yMax,
                                          double zMin, double zMax)
{
...
bool
GeometricBrickDecorator::isRearBoundary (double xMin, double xMax,
                                         double yMin, double yMax,
                                         double zMin, double zMax)
{
...
bool
GeometricBrickDecorator::isBottomBoundary (double xMin, double xMax,
                                           double yMin, double yMax,
                                           double zMin, double zMax)
{
...
bool
GeometricBrickDecorator::isBoundaryLayerEle (double xMin, double xMax,
                                             double yMin, double yMax,
                                             double zMin, double zMax)
{
