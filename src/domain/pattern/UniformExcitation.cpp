...
UniformExcitation::UniformExcitation(GroundMotion & _theMotion,
                                     ...
                                     double
                                     theFactor):EarthquakePattern(tag,
                                                                  PATTERN_TAG_UniformExcitation),
...
const GroundMotion *UniformExcitation::getGroundMotion(void)
{
    return theMotion;
}

int UniformExcitation::setParameter(const char **argv, int argc,
                                    Parameter & param)
{
...
void UniformExcitation::setDomain(Domain * theDomain)
{
...
void UniformExcitation::applyLoad(double time)
{
...
void UniformExcitation::applyLoadSensitivity(double time)
{
    Domain *theDomain = this->getDomain();
    if (theDomain == 0)
        return;
...
int UniformExcitation::sendSelf(int commitTag, Channel & theChannel)
{
...
int UniformExcitation::recvSelf(int commitTag, Channel & theChannel,
...
void UniformExcitation::Print(OPS_Stream & s, int flag)
{
    s << "UniformExcitation  " << this->getTag() <<
        " - Not Printing the GroundMotion\n";
}

LoadPattern *UniformExcitation::getCopy(void)
{
    LoadPattern *theCopy =
