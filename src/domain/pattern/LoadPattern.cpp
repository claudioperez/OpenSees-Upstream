                ...
                for (int i = 0; i < numNod; i++)
                  {
                      ...
                      NodalLoad *theNode =
                          theBroker.getNewNodalLoad (classTag);
          ...
          while ((theEleLoad = theEleLoadIter ()) != 0)
            {
                ...
                if (eleNumber == eleTag)
                  {
                      return theEleLoad->setParameter (&argv[2], argc - 2,
                                                       param);
                  }
            }
...
int
LoadPattern::saveLoadFactorSensitivity (double dlambdadh, int gradIndex,
                                        int numGrads)
{
