...
Beam2dPointLoad::Beam2dPointLoad(int tag, double Pt, double dist,
                                 int theElementTag,
                                 double Pa):ElementalLoad(tag,
                                                          LOAD_TAG_Beam2dPointLoad,
                                                          theElementTag),
...
Beam2dPointLoad::Beam2dPointLoad():ElementalLoad(LOAD_TAG_Beam2dPointLoad),
...
const Vector & Beam2dPointLoad::getData(int &type, double loadFactor)
{
...
int Beam2dPointLoad::sendSelf(int commitTag, Channel & theChannel)
{
...
int Beam2dPointLoad::recvSelf(int commitTag, Channel & theChannel,
...
void Beam2dPointLoad::Print(OPS_Stream & s, int flag)
{
...
int Beam2dPointLoad::setParameter(const char **argv, int argc,
                                  Parameter & param)
{
    if (argc < 1)
        return 0;
...
int Beam2dPointLoad::updateParameter(int parameterID, Information & info)
{
    switch (parameterID) {
    case 1:
...
int Beam2dPointLoad::activateParameter(int paramID)
{
    parameterID = paramID;
...
const Vector & Beam2dPointLoad::getSensitivityData(int gradNumber)
{
    data.Zero();
