...
Vector
Beam3dPartialUniformLoad::data (5);
...
int
Beam3dPartialUniformLoad::recvSelf (int commitTag, Channel & theChannel,
...
int
Beam3dPartialUniformLoad::setParameter (const char **argv, int argc,
                                        Parameter & param)
{
    if (argc < 1)
        return -1;
...
int
Beam3dPartialUniformLoad::updateParameter (int parameterID,
                                           Information & info)
{
    switch (parameterID)
      {
