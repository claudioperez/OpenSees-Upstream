...
Beam2dUniformLoad::Beam2dUniformLoad():ElementalLoad(LOAD_TAG_Beam2dUniformLoad),
wTrans(0.0), wAxial(0.0),
parameterID(0)
{
...
const Vector & Beam2dUniformLoad::getData(int &type, double loadFactor)
{
...
int Beam2dUniformLoad::sendSelf(int commitTag, Channel & theChannel)
{
...
int Beam2dUniformLoad::recvSelf(int commitTag, Channel & theChannel,
...
void Beam2dUniformLoad::Print(OPS_Stream & s, int flag)
{
...
int Beam2dUniformLoad::setParameter(const char **argv, int argc,
                                    Parameter & param)
{
    if (argc < 1)
        return -1;
...
int Beam2dUniformLoad::updateParameter(int parameterID, Information & info)
{
    switch (parameterID) {
    case 1:
...
int Beam2dUniformLoad::activateParameter(int paramID)
{
    parameterID = paramID;
...
const Vector & Beam2dUniformLoad::getSensitivityData(int gradNumber)
{
    data.Zero();
