...
Vector
ShellThermalAction::data (18);

ShellThermalAction::ShellThermalAction (int tag,
                                        double t1, double locY1, double t2,
                                        double locY2, double t3, double locY3,
                                        double t4, double locY4, double t5,
                                        double locY5, double t6, double locY6,
                                        double t7, double locY7, double t8,
                                        double locY8, double t9, double locY9,
                                        int theElementTag):
...
ShellThermalAction::ShellThermalAction (int tag,
                                        ...
                                        double locY2, double t3, double locY3,
                                        double t4, double locY4, double t5,
                                        double locY5, int theElementTag):
ElementalLoad (tag, LOAD_TAG_ShellThermalAction, theElementTag),
ThermalActionType (LOAD_TAG_ShellThermalAction),
theSeries (0)
{
...
ShellThermalAction::ShellThermalAction (int tag,
                                        double t1, double locY1, double t2,
                                        double locY2, int theElementTag):
ElementalLoad (tag, LOAD_TAG_ShellThermalAction, theElementTag),
ThermalActionType (LOAD_TAG_ShellThermalAction),
theSeries (0)
{
...
ShellThermalAction::ShellThermalAction (int tag, int theElementTag):
ElementalLoad (tag, LOAD_TAG_ShellThermalAction, theElementTag),
