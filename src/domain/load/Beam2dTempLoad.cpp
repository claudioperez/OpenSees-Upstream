...
Beam2dTempLoad::Beam2dTempLoad(int tag, double temp1,
                               int theElementTag):ElementalLoad(tag,
                                                                LOAD_TAG_Beam2dTempLoad,
                                                                theElementTag),
...
Beam2dTempLoad::Beam2dTempLoad():ElementalLoad(LOAD_TAG_Beam2dTempLoad),
Ttop1(0.0), Tbot1(0.0), Ttop2(0.0),
Tbot2(0.0)
{
...
const Vector & Beam2dTempLoad::getData(int &type, double loadFactor)
{
...
int Beam2dTempLoad::sendSelf(int commitTag, Channel & theChannel)
{
    return -1;
}

int Beam2dTempLoad::recvSelf(int commitTag, Channel & theChannel,
                             FEM_ObjectBroker & theBroker)
{
    return -1;
}

void Beam2dTempLoad::Print(OPS_Stream & s, int flag)
{
    s << "Beam2dTempLoad - reference load : " << Ttop1 <<
        " change in temp at top of node 1 : " << Tbot1 <<
        " change in temp at bottom of node 1\n";
    s << Ttop2 << " change in temp at top of node 2 : " << Tbot2 <<
        " change in temp at bottom of node 2\n";
