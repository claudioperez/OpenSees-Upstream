...
Vector
Beam2dPartialUniformLoad::data (6);
...
int
Beam2dPartialUniformLoad::recvSelf (int commitTag, Channel & theChannel,
...
int
Beam2dPartialUniformLoad::setParameter (const char **argv, int argc,
                                        Parameter & param)
{
    if (argc < 1)
        return -1;
...
int
Beam2dPartialUniformLoad::updateParameter (int parameterID,
                                           Information & info)
{
    switch (parameterID)
      {
