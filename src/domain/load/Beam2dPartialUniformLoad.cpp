...
Beam2dPartialUniformLoad::Beam2dPartialUniformLoad(int tag, double wt,
                                                   double wa,
                                                   int
                                                   theElementTag):ElementalLoad
    (tag, LOAD_TAG_Beam2dPartialUniformLoad, theElementTag), wTrans_a(wt),
wTrans_b(wt), wAxial_a(wa), wAxial_b(wa), aOverL(0.0), bOverL(1.0),
parameterID(0)
{
...
Beam2dPartialUniformLoad::Beam2dPartialUniformLoad(int tag, double wt,
                                                   ...
                                                   theElementTag):ElementalLoad
    (tag, LOAD_TAG_Beam2dPartialUniformLoad, theElementTag), wTrans_a(wt),
wTrans_b(wt), wAxial_a(wa), wAxial_b(wa), aOverL(aL), bOverL(bL),
parameterID(0)
{

}

Beam2dPartialUniformLoad::Beam2dPartialUniformLoad(int tag, double wta,
                                                   double wtb, double waa,
                                                   double wab, double aL,
                                                   double bL,
                                                   int
                                                   theElementTag):ElementalLoad
    (tag, LOAD_TAG_Beam2dPartialUniformLoad, theElementTag), wTrans_a(wta),
wTrans_b(wtb), wAxial_a(waa), wAxial_b(wab), aOverL(aL), bOverL(bL),
parameterID(0)
{

}

Beam2dPartialUniformLoad::Beam2dPartialUniformLoad():ElementalLoad(LOAD_TAG_Beam2dPartialUniformLoad),
wTrans_a(0.0), wTrans_b(0.0), wAxial_a(0.0), wAxial_b(0.0), aOverL(0.0),
bOverL(0.0), parameterID(0)
{
 ...
 Beam2dPartialUniformLoad::sendSelf(int commitTag, Channel & theChannel)
{
    ...
    if (result < 0) {
        opserr <<
            "Beam2dPartialUniformLoad::sendSelf - failed to send data\n";
        return result;
    }
...
int Beam2dPartialUniformLoad::recvSelf(int commitTag, Channel & theChannel,
                                       FEM_ObjectBroker & theBroker)
{
    ...
    if (result < 0) {
        opserr <<
            "Beam2dPartialUniformLoad::recvSelf - failed to recv data\n";
        return result;
    }
...
void Beam2dPartialUniformLoad::Print(OPS_Stream & s, int flag)
{
...
int Beam2dPartialUniformLoad::setParameter(const char **argv, int argc,
                                           Parameter & param)
{
    if (argc < 1)
        return -1;
...
int Beam2dPartialUniformLoad::updateParameter(int parameterID,
                                              Information & info)
{
    switch (parameterID) {
    case 1:
...
int Beam2dPartialUniformLoad::activateParameter(int paramID)
{
    parameterID = paramID;
...
const Vector & Beam2dPartialUniformLoad::getSensitivityData(int gradNumber)
{
    data.Zero();
