...
Beam3dThermalAction::Beam3dThermalAction (int tag,
                                          ...
                                          double locY5, double t6, double t7,
                                          double locZ1, double t8, double t9,
                                          double locZ2, double t10,
                                          double t11, double locZ3,
                                          double t12, double t13,
                                          double locZ4, double t14,
                                          double t15, double locZ5,
                                          int theElementTag):
...
Beam3dThermalAction::Beam3dThermalAction (int tag,
                                          ...
                                          double locY9, int theElementTag):
ElementalLoad (tag, LOAD_TAG_Beam3dThermalAction, theElementTag),
ThermalActionType (LOAD_TAG_Beam3dThermalAction)
{
    Temp[0] = t1;
...
Beam3dThermalAction::Beam3dThermalAction (int tag, int theElementTag):
ElementalLoad (tag, LOAD_TAG_Beam3dThermalAction, theElementTag),
