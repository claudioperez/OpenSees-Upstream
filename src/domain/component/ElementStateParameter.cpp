...
ElementStateParameter::ElementStateParameter(double value,
                                             ...
                                             int Argc,
                                             int Flag,
                                             ID * theEle):Parameter(0,
                                                                    PARAMETER_TAG_ElementStateParameter),
currentValue(value), flag(Flag), argc(Argc), fromFree(1)
{
    if (theEle != 0)
...
ElementStateParameter::ElementStateParameter():Parameter(0, PARAMETER_TAG_ElementStateParameter),
currentValue(0.0),
theEleIDs(0), flag(0), argv(0), argc(0), fromFree(1)
{
...
void ElementStateParameter::setDomain(Domain * theDomain)
{
    ...
    if (flag == 0) {
        ...
        while (((theEle = theEles()) != 0)) {
            int theResult =
                theEle->setParameter((const char **) argv, argc,
                                     *theParameter);
            if (theResult != -1) {
...
int ElementStateParameter::sendSelf(int commitTag, Channel & theChannel)
{
    static ID iData(3);
    iData(0) = flag;
    iData(1) = argc;
...
int ElementStateParameter::recvSelf(int commitTag, Channel & theChannel,
