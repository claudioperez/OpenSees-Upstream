...
myDV(theDV), myParam(theParam), currentValue(0.0)
{
    if (myDV != 0)
...
int DVParameter::update(double newValue)
{
    currentValue = newValue;
...
int DVParameter::activate(bool active)
{
    if (myParam != 0)
...
double DVParameter::getValue(void)
{
    //return currentValue;
    return myDV->getValue();
}

void DVParameter::setValue(double newValue)
{
    currentValue = newValue;
...
bool DVParameter::isImplicit(void)
{
    return false;
}

double DVParameter::getSensitivity(int index)
{
    return Parameter::getSensitivity(index);
}

double DVParameter::getPerturbation(void)
{
...
int DVParameter::getPointerTag(void)
{
    return myDV->getTag();
}

void DVParameter::Print(OPS_Stream & s, int flag)
{
...
void DVParameter::setDomain(Domain * theDomain)
{
    if (myParam != 0)
...
int DVParameter::sendSelf(int commitTag, Channel & theChannel)
{
    return 0;
}

int DVParameter::recvSelf(int commitTag, Channel & theChannel,
