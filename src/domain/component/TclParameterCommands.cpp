                                ...
                                TclModelBuilder * theTclBuilder)
{
    ...
    if (strcmp(argv[0], "parameter") == 0
        ...
        if (argc > argStart && strstr(argv[argStart], "element") != 0) {
            ...
            // Retrieve element from domain
            theObject =
                (DomainComponent *) theTclDomain->getLoadPattern(loadTag);
        ...
        if (strcmp(argv[0], "addToParameter") == 0) {
            ...
            if (theParameter == 0) {
                ...
                if (isele == false)
                    theParameter->addComponent(theObject, (const char **)
                                               &argv[argStart],
                                               argc - argStart);
                else {
                    theObject = (DomainComponent *)
                        theTclDomain->getElement(eleTag);
                    theParameter->addComponent(theObject, (const char **)
                                               &argv[argStart],
                                               argc - argStart);
