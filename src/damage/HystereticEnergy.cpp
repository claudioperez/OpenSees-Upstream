...
HystereticEnergy::HystereticEnergy ():DamageModel (0, DMG_TAG_HystereticEnergy)
{
    // Does nothing
}
...
double
HystereticEnergy::getPosDamage (void)
{
...
double
HystereticEnergy::getNegDamage (void)
{
    return this->getDamage ();
}
...
int
HystereticEnergy::setInputResponse (Element * elem, const char **argv,
                                    int argc, int ndof)
{
    return -1;
}
