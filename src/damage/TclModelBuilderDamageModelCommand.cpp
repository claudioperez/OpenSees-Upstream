...
int
TclModelBuilderDamageModelCommand (ClientData clientData, Tcl_Interp * interp,
    ...
    if (strcmp (argv[1], "Mehanny") == 0)
      {
          ...
          int tag;
          double alpha, beta, gamma, ultimatePosDisp, ultimateNegDisp, abstol,
              reltol, posmodifier, negmodifier;
