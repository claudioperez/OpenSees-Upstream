...
NormElementRecorder::NormElementRecorder ():Recorder (RECORDER_TAGS_NormElementRecorder),
...
theResponses (0),
theDomain (&theDom),
theOutputHandler (&theOutputHandler),
    ...
    if (ele != 0)
      {
          ...
          if (eleID == 0 || eleID->Size () != numEle)
              opserr <<
                  "NormElementRecorder::NormElementRecorder() - out of memory\n";
      }
    ...
    if (initializationDone == false)
      {
          if (this->initialize () != 0)
            {
                opserr <<
                    "NormElementRecorder::record() - failed to initialize\n";
                return -1;
            }
      }
...
NormElementRecorder::sendSelf (int commitTag, Channel & theChannel)
{
    ...
    if (theChannel.isDatastore () == 1)
      {
          opserr <<
              "NormElementRecorder::sendSelf() - does not send data to a datastore\n";
          return -1;
      }
    ...
    if (theChannel.sendID (0, commitTag, idData) < 0)
      {
          opserr <<
              "NormElementRecorder::sendSelf() - failed to send idData\n";
          return -1;
      }
    ...
    if (theChannel.sendVector (0, commitTag, dData) < 0)
      {
          opserr <<
              "NormElementRecorder::sendSelf() - failed to send dData\n";
          return -1;
      }
    ...
    if (theChannel.sendMsg (0, commitTag, theMessage) < 0)
      {
          opserr <<
              "NormElementRecorder::sendSelf() - failed to send message\n";
          return -1;
      }
    ...
    if (theOutputHandler == 0
        || theOutputHandler->sendSelf (commitTag, theChannel) < 0)
      {
          opserr <<
              "NormElementRecorder::sendSelf() - failed to send the DataOutputHandler\n";
          return -1;
      }
                               ...
                               FEM_ObjectBroker & theBroker)
{
    ...
    if (theChannel.isDatastore () == 1)
      {
          opserr <<
              "NormElementRecorder::recvSelf() - does not recv data to a datastore\n";
          return -1;
      }
    ...
    if (theChannel.recvID (0, commitTag, idData) < 0)
      {
          opserr <<
              "NormElementRecorder::recvSelf() - failed to recv idData\n";
          return -1;
      }
    ...
    if (msgLength == 0)
      {
          opserr <<
              "NormElementRecorder::recvSelf() - 0 sized string for responses\n";
          return -1;
      }
    ...
    if (theChannel.recvMsg (0, commitTag, theMessage) < 0)
      {
          opserr <<
              "NormElementRecorder::recvSelf() - failed to recv message\n";
          return -1;
      }
    ...
    if (eleID != 0)
      {
          ...
          if (theResponses == 0)
            {
                opserr <<
                    "NormElementRecorder::initialize() - out of memory\n";
                return -1;
            }
