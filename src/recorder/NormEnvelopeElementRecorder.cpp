...
NormEnvelopeElementRecorder::NormEnvelopeElementRecorder ():Recorder (RECORDER_TAGS_NormEnvelopeElementRecorder),
...
NormEnvelopeElementRecorder::sendSelf (int commitTag, Channel & theChannel)
{
    ...
    if (theChannel.isDatastore () == 1)
      {
          opserr <<
              "NormEnvelopeElementRecorder::sendSelf() - does not send data to a datastore\n";
          return -1;
      }
    initializationDone = false;
    //
    ...
    if (theChannel.sendID (0, commitTag, idData) < 0)
      {
          opserr <<
              "NormEnvelopeElementRecorder::sendSelf() - failed to send idData\n";
          return -1;
      }
    ...
    if (theChannel.sendVector (0, commitTag, dData) < 0)
      {
          opserr <<
              "NormEnvelopeElementRecorder::sendSelf() - failed to send dData\n";
          return -1;
      }
    ...
    if (msgLength == 0)
      {
          opserr <<
              "NormEnvelopeElementRecorder::sendSelf() - no data to send!!\n";
          return -1;
      }
    ...
    if (allResponseArgs == 0)
      {
          opserr <<
              "NormEnvelopeElementRecorder::sendSelf() - out of memory\n";
          return -1;
      }
    ...
    if (theChannel.sendMsg (0, commitTag, theMessage) < 0)
      {
          opserr <<
              "NormEnvelopeElementRecorder::sendSelf() - failed to send message\n";
          return -1;
      }
    ...
    if (theHandler == 0 || theHandler->sendSelf (commitTag, theChannel) < 0)
      {
          opserr <<
              "NormEnvelopeElementRecorder::sendSelf() - failed to send the DataOutputHandler\n";
          return -1;
      }
                                       ...
                                       FEM_ObjectBroker & theBroker)
{
    ...
    if (theChannel.isDatastore () == 1)
      {
          opserr <<
              "NormEnvelopeElementRecorder::recvSelf() - does not recv data to a datastore\n";
          return -1;
      }
    ...
    if (theChannel.recvID (0, commitTag, idData) < 0)
      {
          opserr <<
              "NormEnvelopeElementRecorder::recvSelf() - failed to recv idData\n";
          return -1;
      }
    ...
    if (theChannel.recvVector (0, commitTag, dData) < 0)
      {
          opserr <<
              "NormEnvelopeElementRecorder::recvSelf() - failed to recv dData\n";
          return -1;
      }
    deltaT = dData (1);
    ...
    if (msgLength == 0)
      {
          opserr <<
              "NormEnvelopeElementRecorder::recvSelf() - 0 sized string for responses\n";
          return -1;
      }
    ...
    if (allResponseArgs == 0)
      {
          opserr <<
              "NormEnvelopeElementRecorder::recvSelf() - out of memory\n";
          return -1;
      }
    ...
    if (theChannel.recvMsg (0, commitTag, theMessage) < 0)
      {
          opserr <<
              "NormEnvelopeElementRecorder::recvSelf() - failed to recv message\n";
          return -1;
      }
...
NormEnvelopeElementRecorder::initialize (void)
{
    ...
    if (data == 0 || currentData == 0)
      {
          opserr <<
              "NormEnvelopeElementRecorder::NormEnvelopeElementRecorder() - out of memory\n";
          exit (-1);
      }
