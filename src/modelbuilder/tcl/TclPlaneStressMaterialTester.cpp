...
int TclPlaneStressMaterialTester_setPlaneStressMaterial (ClientData
                                                         clientData,
                                                         Tcl_Interp * interp,
                                                         int argc,
                                                         TCL_Char ** argv);

int TclPlaneStressMaterialTester_setStrainPlaneStressMaterial (ClientData
                                                               clientData,
                                                               Tcl_Interp *
                                                               interp,
                                                               int argc,
...
int TclPlaneStressMaterialTester_getStressPlaneStressMaterial (ClientData
                                                               clientData,
                                                               Tcl_Interp *
                                                               interp,
                                                               int argc,
...
int TclPlaneStressMaterialTester_getTangPlaneStressMaterial (ClientData
                                                             clientData,
                                                             Tcl_Interp *
                                                             interp, int argc,
                                                             TCL_Char **
...
TclPlaneStressMaterialTester (Domain & theDomain, Tcl_Interp * interp,
                              int cTC):
...
int
TclPlaneStressMaterialTester_setStrainPlaneStressMaterial (ClientData
                                                           clientData,
                                                           Tcl_Interp *
                                                           interp, int argc,
                                                           TCL_Char ** argv)
{
    ...
    if (argc < 4)
      {
          opserr <<
              "WARNING bad command - want: strainPlaneStressTest strain?\n";
          return TCL_ERROR;
      }
    ...
    if (Tcl_GetDouble (interp, argv[1], &strain[0]) != TCL_OK)
      {
          opserr <<
              "WARNING could not read strain: strainPlaneStressTest strain?\n";
          return TCL_ERROR;
      }
...
int
TclPlaneStressMaterialTester_getStressPlaneStressMaterial (ClientData
                                                           clientData,
                                                           Tcl_Interp *
                                                           interp, int argc,
                                                           TCL_Char ** argv)
    ...
    if (theMaterial != 0)
      {
          ...
          char buffer[60];
          sprintf (buffer, "%.10e %.10e %.10e", stress (0), stress (1),
                   stress (2));
      ...
      {
          opserr <<
              "WARNING no active Plane StressMaterial - use plane stressTest command\n";
          return TCL_ERROR;
      }
}

int
TclPlaneStressMaterialTester_getTangPlaneStressMaterial (ClientData
                                                         clientData,
                                                         Tcl_Interp * interp,
                                                         int argc,
                                                         TCL_Char ** argv)
    ...
    if (theMaterial != 0)
      {
          ...
          sprintf (buffer,
                   ...
                   tangent (0, 0), tangent (0, 1), tangent (0, 2), tangent (1,
                                                                            0),
                   tangent (1, 1), tangent (1, 2), tangent (2, 0), tangent (2,
                                                                            1),
                   tangent (2, 2));
          Tcl_SetResult (interp, buffer, TCL_VOLATILE);
          return TCL_OK;
      ...
      {
          opserr <<
              "WARNING no active PlaneStressMaterial - use plane stressTest command\n";
          return TCL_ERROR;
      }
}
