...
DataOutputStreamHandler::
DataOutputStreamHandler(bool
                        echoD):DataOutputHandler
(DATAHANDLER_TAGS_DataOutputStreamHandler), echoDescription(echoD), numColumns(0)
{
...
int DataOutputStreamHandler::write(Vector & data)
{
...
int DataOutputStreamHandler::sendSelf(int commitTag, Channel & theChannel)
{
    return 0;
}

int DataOutputStreamHandler::recvSelf(int commitTag, Channel & theChannel,
