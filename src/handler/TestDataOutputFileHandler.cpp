...
int main(int argc, char **argv)
{
    ...
    opserr <<
        "TEST: Creation of DataOutputFile object - will create 3 objects 1,2, & 3\n";

    DataOutputFileHandler *theHandler1 =
        new DataOutputFileHandler("UnitTest1");
    DataOutputFileHandler *theHandler2 =
        new DataOutputFileHandler("UnitTest2", DATA_FILE);
    DataOutputFileHandler *theHandler3 =
        new DataOutputFileHandler("UnitTest3", XML_FILE, APPEND);
