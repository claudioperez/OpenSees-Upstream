...
DataOutputDatabaseHandler::DataOutputDatabaseHandler(FE_Datastore *
                                                     database,
                                                     const char
                                                     *tName):DataOutputHandler
    (DATAHANDLER_TAGS_DataOutputDatabaseHandler), theDatabase(database),
tableName(0), numColumns(0), columns(0), commitTag(0)
{
    //
...
int DataOutputDatabaseHandler::write(Vector & data)
{
    int result = 0;
...
int DataOutputDatabaseHandler::setDatabase(FE_Datastore & database,
                                           const char *tName)
{
...
int DataOutputDatabaseHandler::sendSelf(int commitTag,
                                        Channel & theChannel)
{
    opserr <<
        "DataOutputDatabaseHandler::sendSelf() - not yet implemented\n";
    return -1;
}

int DataOutputDatabaseHandler::recvSelf(int commitTag,
                                        Channel & theChannel,
