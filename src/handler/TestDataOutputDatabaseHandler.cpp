...
int main(int argc, char **argv)
{
    ...
    opserr <<
        " *******************************************************************\n";
    opserr <<
        "                        DataOutputDatabaseHandler unit test\n";
    opserr <<
        " *******************************************************************\n\n";
    ...
    opserr <<
        "TEST: Creation of DataOutputFile object - will create 4 objects 1,2,3 and 4 (3,4 have no assigned database)\n";

    DataOutputDatabaseHandler *theHandler1 =
        new DataOutputDatabaseHandler(&theDatabase, "UnitTest1");
    DataOutputDatabaseHandler *theHandler2 =
        new DataOutputDatabaseHandler(&theDatabase, "UnitTest2");
    DataOutputDatabaseHandler *theHandler3 =
        new DataOutputDatabaseHandler(0, "UnitTest3");
    DataOutputDatabaseHandler *theHandler4 =
        new DataOutputDatabaseHandler(0, 0);
    ...
    if (result != 0)
        opserr <<
            "PASS: open() method with valid args but no database set\n\n";
    else {
        opserr <<
            "FAIL: open() method with valid args but no database set\n\n";
    }
    ...
    opserr <<
        "Now We Test setDatabase & open after setDatabase on handler 2\n";
