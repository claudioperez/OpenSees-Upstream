...
DataFileStreamAdd::
DataFileStreamAdd(int
                  indent):OPS_Stream(OPS_STREAM_TAGS_DataFileStreamAdd),
fileOpen(0), fileName(0), indentSize(indent), sendSelfCount(0),
theChannels(0), numDataRows(0), mapping(0), maxCount(0), sizeColumns(0),
theColumns(0), theData(0), theRemoteData(0), doCSV(0)
{
    if (indentSize < 1)
        indentSize = 1;
...
DataFileStreamAdd::DataFileStreamAdd(const char *file, openMode mode,
                                     int indent, int csv, bool closeWrite,
                                     int prec,
                                     bool
                                     scientific):OPS_Stream
    (OPS_STREAM_TAGS_DataFileStreamAdd), fileOpen(0), fileName(0),
indentSize(indent), sendSelfCount(0), theChannels(0), numDataRows(0),
mapping(0), maxCount(0), sizeColumns(0), theColumns(0), theData(0),
theRemoteData(0), doCSV(csv), closeOnWrite(closeWrite)
{
    thePrecision = prec;
 ...
 DataFileStreamAdd::setFile(const char *name, openMode mode)
{
    ...
    if (fileName == 0) {
        ...
        if (fileName == 0) {
            std::cerr <<
                "DataFileStreamAdd::setFile() - out of memory copying name: "
                << name << std::endl;
            return -1;
        }
        // copy the strings
...
int DataFileStreamAdd::open(void)
{
    // check setFile has been called
    if (fileName == 0) {
        std::cerr <<
            "DataFileStreamAdd::open(void) - no file name has been set\n";
        return -1;
    }
...
int DataFileStreamAdd::close(void)
{
    if (fileOpen != 0)
        theFile.close();
    fileOpen = 0;
...
int DataFileStreamAdd::setPrecision(int prec)
{
    if (fileOpen == 0)
        this->open();
...
int DataFileStreamAdd::setFloatField(floatField field)
{
    if (fileOpen == 0)
        this->open();
...
int DataFileStreamAdd::tag(const char *tagName)
{
    return 0;
}

int DataFileStreamAdd::tag(const char *tagName, const char *value)
{
    return 0;
}


int DataFileStreamAdd::endTag()
{
    return 0;
}

int DataFileStreamAdd::attr(const char *name, int value)
{
    return 0;
}

int DataFileStreamAdd::attr(const char *name, double value)
{
    return 0;
}

int DataFileStreamAdd::attr(const char *name, const char *value)
{
    return 0;
}

int DataFileStreamAdd::write(Vector & data)
{
    if (fileOpen == 0)
        this->open();
        ...
        if (i == 0) {
            ...
            if (numColumns != 0) {
                ...
                if (theChannels[i - 1]->recvVector(0, 0, *theV) < 0) {
                    opserr <<
                        "DataFileStreamAdd::write - failed to recv data\n";
                }
            }
        }
    }
...
OPS_Stream & DataFileStreamAdd::write(const char *s, int n)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & DataFileStreamAdd::write(const unsigned char *s, int n)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & DataFileStreamAdd::write(const signed char *s, int n)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & DataFileStreamAdd::write(const void *s, int n)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & DataFileStreamAdd::write(const double *s, int n)
{
    numDataRows++;
...
OPS_Stream & DataFileStreamAdd::operator<<(char c)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & DataFileStreamAdd::operator<<(unsigned char c)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & DataFileStreamAdd::operator<<(signed char c)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & DataFileStreamAdd::operator<<(const char *s)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & DataFileStreamAdd::operator<<(const unsigned char *s)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & DataFileStreamAdd::operator<<(const signed char *s)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & DataFileStreamAdd::operator<<(const void *p)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & DataFileStreamAdd::operator<<(int n)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & DataFileStreamAdd::operator<<(unsigned int n)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & DataFileStreamAdd::operator<<(long n)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & DataFileStreamAdd::operator<<(unsigned long n)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & DataFileStreamAdd::operator<<(short n)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & DataFileStreamAdd::operator<<(unsigned short n)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & DataFileStreamAdd::operator<<(bool b)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & DataFileStreamAdd::operator<<(double n)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & DataFileStreamAdd::operator<<(float n)
{
    if (fileOpen == 0)
        this->open();
...
int DataFileStreamAdd::sendSelf(int commitTag, Channel & theChannel)
{
    sendSelfCount++;
    ...
    if (theChannel.sendID(0, commitTag, idData) < 0) {
        opserr <<
            "DataFileStreamAdd::sendSelf() - failed to send id data\n";
        return -1;
    }
    ...
    if (fileNameLength != 0) {
        ...
        if (theChannel.sendMsg(0, commitTag, theMessage) < 0) {
            opserr <<
                "DataFileStreamAdd::sendSelf() - failed to send message\n";
            return -1;
        }
    }
...
int DataFileStreamAdd::recvSelf(int commitTag, Channel & theChannel,
                                FEM_ObjectBroker & theBroker)
{
    ...
    if (theChannel.recvID(0, commitTag, idData) < 0) {
        opserr <<
            "DataFileStreamAdd::recvSelf() - failed to recv id data\n";
        return -1;
    }
    ...
    if (fileNameLength != 0) {
        ...
        if (theChannel.recvMsg(0, commitTag, theMessage) < 0) {
            opserr <<
                "DataFileStreamAdd::recvSelf() - failed to recv message\n";
            return -1;
        }
        ...
        if (this->setFile(fileName, theOpenMode) < 0) {
            opserr <<
                "DataFileStreamAdd::DataFileStreamAdd() - setFile() failed\n";
            if (fileName != 0) {
                delete[]fileName;
                fileName = 0;
            }
...
void DataFileStreamAdd::indent(void)
{
    if (fileOpen != 0)
...
int DataFileStreamAdd::setOrder(const ID & orderData)
{
    if (sendSelfCount == 0)
        return 0;
    ...
    if (sendSelfCount > 0) {
        ...
        for (int i = 0; i < sendSelfCount; i++) {
            ...
            if (theChannels[i]->recvID(0, 0, numColumnID) < 0) {
                opserr <<
                    "DataFileStreamAdd::setOrder - failed to recv column size for process: "
                    << i + 1 << endln;
                return -1;
            }
            ...
            if (numColumns != 0) {
                ...
                if (theChannels[i]->recvID(0, 0, *theColumns[i + 1]) < 0) {
                    opserr <<
                        "DataFileStreamAdd::setOrder - failed to recv column data for process: "
                        << i + 1 << endln;
                    return -1;
                }

                if (numColumns != 0
                    && (*theColumns[i + 1])[numColumns - 1] > maxCount)
                    maxCount = (*theColumns[i + 1])[numColumns - 1];

                theData[i + 1] = new double[numColumns];
                theRemoteData[i + 1] =
                    new Vector(theData[i + 1], numColumns);
            } else {
                theColumns[i + 1] = 0;
                theData[i + 1] = 0;
                theRemoteData[i + 1] = 0;
