...
BinaryFileStream::BinaryFileStream():OPS_Stream(OPS_STREAM_TAGS_BinaryFileStream),
...
BinaryFileStream::BinaryFileStream(const char *file,
                                   openMode
                                   mode):OPS_Stream
    (OPS_STREAM_TAGS_BinaryFileStream), fileOpen(0), fileName(0),
 ...
 BinaryFileStream::setFile(const char *name, openMode mode)
{
    ...
    if (fileName == 0) {
        ...
        if (fileName == 0) {
            std::cerr <<
                "BinaryFileStream::setFile() - out of memory copying name: "
                << name << std::endl;
            return -1;
        }
        // copy the strings
...
int BinaryFileStream::open(void)
{
    // check setFile has been called
    if (fileName == 0) {
        std::cerr <<
            "BinaryFileStream::open(void) - no file name has been set\n";
        return -1;
    }
...
int BinaryFileStream::close(void)
{
    if (fileOpen != 0)
        theFile.close();
    fileOpen = 0;
...
int BinaryFileStream::setPrecision(int prec)
{
    return 0;
}

int BinaryFileStream::setFloatField(floatField field)
{
    return 0;
}


int BinaryFileStream::tag(const char *tagName)
{
    return 0;
}

int BinaryFileStream::tag(const char *tagName, const char *value)
{
    return 0;
}


int BinaryFileStream::endTag()
{
    return 0;
}

int BinaryFileStream::attr(const char *name, int value)
{
    return 0;
}

int BinaryFileStream::attr(const char *name, double value)
{
    return 0;
}

int BinaryFileStream::attr(const char *name, const char *value)
{
    return 0;
}

int BinaryFileStream::write(Vector & data)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & BinaryFileStream::write(const char *s, int n)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & BinaryFileStream::write(const unsigned char *s, int n)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & BinaryFileStream::write(const signed char *s, int n)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & BinaryFileStream::write(const double *s, int n)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & BinaryFileStream::write(const void *s, int n)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & BinaryFileStream::operator<<(char c)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & BinaryFileStream::operator<<(unsigned char c)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & BinaryFileStream::operator<<(signed char c)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & BinaryFileStream::operator<<(const char *s)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & BinaryFileStream::operator<<(const unsigned char *s)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & BinaryFileStream::operator<<(const signed char *s)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & BinaryFileStream::operator<<(const void *p)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & BinaryFileStream::operator<<(int n)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & BinaryFileStream::operator<<(unsigned int n)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & BinaryFileStream::operator<<(long n)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & BinaryFileStream::operator<<(unsigned long n)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & BinaryFileStream::operator<<(short n)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & BinaryFileStream::operator<<(unsigned short n)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & BinaryFileStream::operator<<(bool b)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & BinaryFileStream::operator<<(double n)
{
    if (fileOpen == 0)
        this->open();
...
OPS_Stream & BinaryFileStream::operator<<(float n)
{
    if (fileOpen == 0)
        this->open();
...
int BinaryFileStream::sendSelf(int commitTag, Channel & theChannel)
{
    sendSelfCount++;
    ...
    if (theChannel.sendID(0, commitTag, idData) < 0) {
        opserr <<
            "BinaryFileStream::sendSelf() - failed to send id data\n";
        return -1;
    }
    ...
    if (fileNameLength != 0) {
        ...
        if (theChannel.sendMsg(0, commitTag, theMessage) < 0) {
            opserr <<
                "BinaryFileStream::sendSelf() - failed to send message\n";
            return -1;
        }
    }
...
int BinaryFileStream::recvSelf(int commitTag, Channel & theChannel,
                               FEM_ObjectBroker & theBroker)
{
    ...
    if (theChannel.recvID(0, commitTag, idData) < 0) {
        opserr <<
            "BinaryFileStream::recvSelf() - failed to recv id data\n";
        return -1;
    }
    ...
    if (fileNameLength != 0) {
        ...
        if (theChannel.recvMsg(0, commitTag, theMessage) < 0) {
            opserr <<
                "BinaryFileStream::recvSelf() - failed to recv message\n";
            return -1;
        }
        ...
        if (this->setFile(fileName, theOpenMode) < 0) {
            opserr <<
                "BinaryFileStream::BinaryFileStream() - setFile() failed\n";
            if (fileName != 0) {
                delete[]fileName;
                fileName = 0;
            }
...
int binaryToText(const char *inputFilename, const char *outputFilename)
{
    ...
    if (input.bad()) {
        ...
        std::
            cerr << " - could not open file " << inputFilename <<
            std::endl;
        output.close();
        return -1;
    }
    if (output.bad()) {
        std::cerr << "WARNING - BinaryFileStream - binaryToText()";
        std::
            cerr << " - could not open file " << outputFilename <<
            std::endl;
        output.close();
        return -1;
    }
...
int BinaryFileStream::setOrder(const ID & orderData)
{
    if (sendSelfCount < 0) {
    ...
    if (sendSelfCount > 0) {
        ...
        for (int i = 0; i < sendSelfCount; i++) {
            ...
            if (theChannels[i]->recvID(0, 0, numColumnID) < 0) {
                opserr <<
                    "BinaryFileStream::setOrder - failed to recv column size for process: "
                    << i + 1 << endln;
                return -1;
            }
            ...
            if (numColumns != 0) {
                ...
                if (theChannels[i]->recvID(0, 0, *theColumns[i + 1]) < 0) {
                    opserr <<
                        "BinaryFileStream::setOrder - failed to recv column data for process: "
                        << i + 1 << endln;
                    return -1;
                }
