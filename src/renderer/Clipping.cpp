...
FACE & Clipping::transform (FACE & input)
{
    // opserr << "Clipping:1\n" << input;
    ...
    if (input != 0)
      {
          ...
          if (x < -X || x > X || y < -Y || Y > Y || z > Znear || z < Zfar)
            {
...
FACE & CLIP_X (FACE & input, float X, float Y, float Zfar, float Znear)
{
// this first procedure is used to clip against pos and
    ...
    FOR_EACH_PAIR (Point1, Point2, input.pointList,
                   {
                   x1 = Point1->X ();
                   x2 = Point2->X (); y1 = Point1->Y ();
                   y2 = Point2->Y (); z1 = Point1->Z ();
                   z2 = Point2->Z (); r1 = Point1->r;
                   r2 = Point2->r; g1 = Point1->g;
                   g2 = Point2->g; b1 = Point1->b;
                   b2 = Point2->b; vwx1 = Point1->Viewp[0];
                   vwx2 = Point2->Viewp[0]; vwy1 = Point1->Viewp[1];
                   vwy2 = Point2->Viewp[1]; vwz1 = Point1->Viewp[2];
                   vwz2 = Point2->Viewp[2];
                   // first determine in or out
                   if (x1 > X) out1 = TRUE;
                   else
                   out1 = FALSE; if (x2 > X) out2 = TRUE;
                   else
                   out2 = FALSE; if (out1 == FALSE || out2 == FALSE)
                   {
                   ...
                   b1 = b1 + t * sb;
                   vwx1 = vwx1 + t * svwx;
                   vwy1 = vwy1 + t * svwy; vwz1 = vwz1 + t * svwz;}
                   if (out2 == TRUE)
                   {
                   t = (X - x1) / sx;
                   x2 = x1 + t * sx;
                   ...
                   b2 = b1 + t * sb;
                   vwx2 = vwx1 + t * svwx;
                   vwy2 = vwy1 + t * svwy; vwz2 = vwz1 + t * svwz;}

                   // now clip against -X
                   // first determine in or out
                   out1a = out1; if (x1 < -X) out1 = TRUE;
                   else
                   out1 = FALSE; if (x2 < -X) out2 = TRUE;
                   else
                   out2 = FALSE;
                   ...
                   {
                   P1 =
                   new MYPOINT (0, x1, y1, z1, 0, 0, 0, vwx1, vwy1, vwz1);
                   P1->r = r1; P1->b = b1; P1->g = g1;
                   output->AddPoint (*P1);}
                   P2 = new MYPOINT (0, x2, y2, z2, 0, 0, 0, vwx2, vwy2, vwz2); P2->r = r2; P2->b = b2; P2->g = g2; output->AddPoint (*P2);}    // else do nothing
...
FACE & CLIP_Y (FACE & input, float X, float Y, float Zfar, float Znear)
{
    // this first procedure is used to clip against pos and
    FACE *output;
    MYPOINT *Point1, *Point2, *P1, *P2;
    ...
    FOR_EACH_PAIR (Point1, Point2, input.pointList,
                   ...
                   y2 = Point2->Y ();
                   z1 = Point1->Z ();
                   z2 = Point2->Z (); vwx1 = Point1->Viewp[0];
                   vwx2 = Point2->Viewp[0]; vwy1 = Point1->Viewp[1];
                   vwy2 = Point2->Viewp[1]; vwz1 = Point1->Viewp[2];
                   vwz2 = Point2->Viewp[2]; r1 = Point1->r;
                   r2 = Point2->r; g1 = Point1->g;
                   g2 = Point2->g; b1 = Point1->b;
                   b2 = Point2->b;
                   // first determine in or out
...
FACE & CLIP_Z (FACE & input, float X, float Y, float Zfar, float Znear)
{
    // this first procedure is used to clip against pos and
    FACE *output;
    MYPOINT *Point1, *Point2, *P1, *P2;
    ...
    FOR_EACH_PAIR (Point1, Point2, input.pointList,
                   ...
                   y1 = Point1->Y ();
                   y2 = Point2->Y ();
                   z1 = Point1->Z (); z2 = Point2->Z (); r1 = Point1->r;
                   r2 = Point2->r; g1 = Point1->g;
                   g2 = Point2->g; b1 = Point1->b;
                   b2 = Point2->b; vwx1 = Point1->Viewp[0];
                   vwx2 = Point2->Viewp[0]; vwy1 = Point1->Viewp[1];
                   ...
                   b2 = Point2->b;
                   // first determine in or out
                   if (z1 < Zfar) out1 = TRUE;
                   else
                   out1 = FALSE; if (z2 < Zfar) out2 = TRUE;
                   else
                   out2 = FALSE; if (out1 == FALSE || out2 == FALSE)
                   {
                   ...
                   // first determine in or out
                   out1a = out1; if (z1 > Znear) out1 = TRUE;
                   else
                   out1 = FALSE; if (z2 > Znear) out2 = TRUE;
                   else
                   out2 = FALSE;
                   // clip if either in
                   if (out1 == FALSE || out2 == FALSE)
                   ...
                   P1->r = r1; P1->b = b1; P1->g = g1;
                   output->AddPoint (*P1);}
                   P2 = new MYPOINT (0, x2, y2, z2, 0, 0, 0, vwx2, vwy2, vwz2); P2->r = r1; P2->b = b1; P2->g = g1; output->AddPoint (*P2);}    // else do nothing
                   }            // else do nothing again
                   }
    );
