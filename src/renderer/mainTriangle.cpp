...
main (int argc, char **argv)
{
    ...
    if (soeType == 1)
      ...
      {                         // a ProfileSPD
          ...
          if (solverType == 1)
          ...
          else if (solverType == 2)
            {
                ...
                cin >> blockSize;
                theSolver =
                    new ProfileSPDLinDirectBlockSolver (1.0e-12, blockSize);
            }
          else
            {
                ...
                cin >> mRows >> mCols;
                theSolver =
                    new ProfileSPDLinDirectSkypackSolver (mCols, mRows);
            }
    ...
    else if (soeType == 5)
      {
          ...
          int perm;
          cin >> perm;
          SparseGenLinSolver *theSolver =
              new SparseGenSuperLuSolver (perm, 3, 3, 0.0);
          //      SparseGenLinSolver  
    ...
    WindowRenderer *theViewer =
        new X11Renderer (600, 600, *theDomain, theMap);
