...
int
Renderer::numRenderers (0);
char **
    Renderer::theTitles = 0;
Renderer **
    Renderer::theRenderers = 0;

Renderer::Renderer (ColorMap & _theMap):theMap (&_theMap)
{
...
Renderer::saveImage (const char *rendererTitle, const char *fileName)
{
    ...
    opserr << "Renderer::saveImage - no renderer with title: " <<
        rendererTitle << " found\n";
    return 0;
}
...
int
Renderer::drawCube (const Matrix & points, const Vector & values, int tag,
                    int mode)
{
