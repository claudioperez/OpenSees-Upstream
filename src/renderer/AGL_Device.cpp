...
AGL_Device::AGL_Device ():FontBase (0), winOpen (1), width (0), height (0),
windowTitle (0)
{
    context = NULL;
...
void
AGL_Device::WINOPEN (const char *_title, int _xLoc, int _yLoc, int _width,
                     int _height)
{
    if (windowTitle != 0)
        delete[]windowTitle;
    ...
    OSStatus carbonError = CreateNewWindow (kDocumentWindowClass,
