...
ModIMKPeakOriented02::ModIMKPeakOriented02 (int tag, double Ke0, double alfanPos, double alfanNeg, double my_pos, double my_neg,        // Updated:Filipe Ribeiro and Andre Barbosa
                                            ...
                                            double dNeg):
UniaxialMaterial (tag, MAT_TAG_ModIMKPeakOriented02),
Ke0 (Ke0),
AlfanPos (alfanPos),
AlfanNeg (alfanNeg),
My_pos (my_pos),
...
DNeg (dNeg),
C_Fp (CFp),
C_Fn (CFn)                      // Updated:Filipe Ribeiro and Andre Barbosa
{
    // Initialize Variables by Calling revertToStart function
    this->revertToStart ();
    nFactor = 0.0;              // Updated:Filipe Ribeiro and Andre Barbosa
...
ModIMKPeakOriented02::ModIMKPeakOriented02 ():UniaxialMaterial (0, MAT_TAG_ModIMKPeakOriented02), Ke0 (0.0), AlfanPos (0.0), AlfanNeg (0.0), My_pos (0.0), My_neg (0.0), Ls (0.0), Ld (0.0), La (0.0), Lk (0.0),
                                                                                                                                                                        // Updated:Filipe Ribeiro and Andre Barbosa
...
ModIMKPeakOriented02::setTrialStrain (double strain, double strainRate)
{
    ...
    flagdeg = 0;
    if (fabs (deltaD) < 1.0e-18 && strain != 0.0 && commitCalledOnce == 1)
      {                         // Updated:Filipe Ribeiro and Andre Barbosa
          return 0;
      }
...
double
ModIMKPeakOriented02::getStress (void)
{
...
double
ModIMKPeakOriented02::getTangent (void)
{
    return (Tangent);
}

double
ModIMKPeakOriented02::getInitialTangent (void)
{
    return (Ke);
}

double
ModIMKPeakOriented02::getDampTangent (void)
{
    double DTangent = ekP;
    return DTangent;
}
...
double
ModIMKPeakOriented02::getStrain (void)
{
    return dP;
}

double
ModIMKPeakOriented02::getStrainRate (void)
{
    return 0;
}

int
ModIMKPeakOriented02::commitState (void)
{
...
int
ModIMKPeakOriented02::revertToLastCommit (void)
{
    dP = Cstrain;
    fP = Cstress;
    Tangent = Ctangent;
...
int
ModIMKPeakOriented02::revertToStart (void)
{
...
void
ModIMKPeakOriented02::envelPosCap2 (double fy, double alphaPos,
                                    double alphaCap, double cpDsp, double &d,
                                    double &f, double &ek, double elstk,
                                    double fyieldPos, double Resfac,
...
void
ModIMKPeakOriented02::envelNegCap2 (double fy, double alphaNeg,
                                    double alphaCap, double cpDsp, double &d,
                                    double &f, double &ek, double elstk,
                                    double fyieldNeg, double Resfac,
                                    double fracDisp, int &flagStop)
{
...
int
ModIMKPeakOriented02::getResponse (int responseID,
