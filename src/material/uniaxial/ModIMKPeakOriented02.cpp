...
void *OPS_ModIMKPeakOriented02()
{
    if (numModIMKPeakOriented02Materials == 0) {
        ...
        opserr <<
            "Modified Ibarra-Medina-Krawinkler Model with Peak-Oriented02 Hysteretic Response\n";
    }
    ...
    if (OPS_GetIntInput(&numData, iData) != 0) {
        opserr <<
            "WARNING invalid uniaxialMaterial  ModIMKPeakOriented02 tag" <<
            endln;
        return 0;
    }
    ...
    if (numData != 23 && numData != 24 && numData != 25 && numData != 26) {
        opserr <<
            "Invalid Args want: uniaxialMaterial ModIMKPeakOriented02 tag? Ke?, alfaPos?, alfaNeg?, My_pos?, My_neg?";
        opserr <<
            "Ls?, Ld?, La?, Lk?, Cs?, Cd?, Ca?, Ck?, thetaPpos?, thetaPneg?, thetaPCpos?, thetaPCneg? ";
    ...
    if (numData == 23) {
        ...
        theMaterial = new ModIMKPeakOriented02(iData[0], dData[0], dData[1], dData[2], dData[3], dData[4], dData[5], dData[6], dData[7], dData[8], dData[9], dData[10], dData[11], dData[12], dData[13], dData[14], dData[15], dData[16], dData[17], dData[18], dData[19], dData[20], dData[21], dData[22]);    // Updated:Filipe Ribeiro and Andre Barbosa
        ...
        theMaterial = new ModIMKPeakOriented02(iData[0], dData[0], dData[1], dData[2], dData[3], dData[4], dData[5], dData[6], dData[7], dData[8], dData[9], dData[10], dData[11], dData[12], dData[13], dData[14], dData[15], dData[16], dData[17], dData[18], dData[19], dData[20], dData[21], dData[22], dData[23]); // Updated:Filipe Ribeiro and Andre Barbosa
        ...
        // Parsing was successful, allocate the material
        theMaterial = new ModIMKPeakOriented02(iData[0], dData[0], dData[1], dData[2], dData[3], dData[4], dData[5], dData[6], dData[7], dData[8], dData[9], dData[10], dData[11], dData[12], dData[13], dData[14], dData[15], dData[16], dData[17], dData[18], dData[19], dData[20], dData[21], dData[22], dData[23], dData[24]);      // Updated:Filipe Ribeiro and Andre Barbosa
        ...
        // Parsing was successful, allocate the material
        theMaterial = new ModIMKPeakOriented02(iData[0], dData[0], dData[1], dData[2], dData[3], dData[4], dData[5], dData[6], dData[7], dData[8], dData[9], dData[10], dData[11], dData[12], dData[13], dData[14], dData[15], dData[16], dData[17], dData[18], dData[19], dData[20], dData[21], dData[22], dData[23], dData[24], dData[25]);   // Updated:Filipe Ribeiro and Andre Barbosa
    ...
    if (theMaterial == 0) {
        opserr <<
            "WARNING could not create uniaxialMaterial of type ModIMKPeakOriented02 Material\n";
        return 0;
    }
...
ModIMKPeakOriented02::ModIMKPeakOriented02(int tag, double Ke0, double alfanPos, double alfanNeg, double my_pos, double my_neg, // Updated:Filipe Ribeiro and Andre Barbosa
                                           double ls, double ld, double la,
                                           double lk, double cs, double cd,
                                           double ca, double ck,
                                           double thetaPpos,
                                           double thetaPneg,
                                           double thetaPCpos,
                                           ...
                                           double resfacNeg,
                                           double fracDispPos,
                                           double fracDispNeg, double dPos,
                                           double
                                           dNeg):UniaxialMaterial(tag,
                                                                  MAT_TAG_ModIMKPeakOriented02),
Ke0(Ke0), AlfanPos(alfanPos), AlfanNeg(alfanNeg), My_pos(my_pos),
My_neg(my_neg), Ls(ls), Ld(ld), La(la), Lk(lk), Cs(cs), Cd(cd), Ca(ca),
Ck(ck), ThetaPpos(thetaPpos), ThetaPneg(thetaPneg), ThetaPCpos(thetaPCpos),
ThetaPCneg(thetaPCneg), ResfacPos(resfacPos), ResfacNeg(resfacNeg),
...
ModIMKPeakOriented02::ModIMKPeakOriented02(int tag, double Ke0, double alfanPos, double alfanNeg, double my_pos, double my_neg, // Updated:Filipe Ribeiro and Andre Barbosa
                                           double ls, double ld, double la, double lk, double cs, double cd, double ca, double ck, double thetaPpos, double thetaPneg, double thetaPCpos, double thetaPCneg, double resfacPos, double resfacNeg, double fracDispPos, double fracDispNeg, double dPos, double dNeg, double NFactor):UniaxialMaterial(tag, MAT_TAG_ModIMKPeakOriented02), Ke0(Ke0), AlfanPos(alfanPos), AlfanNeg(alfanNeg), My_pos(my_pos), My_neg(my_neg), Ls(ls), Ld(ld), La(la), Lk(lk), Cs(cs), Cd(cd), Ca(ca), Ck(ck), ThetaPpos(thetaPpos), ThetaPneg(thetaPneg), ThetaPCpos(thetaPCpos), ThetaPCneg(thetaPCneg), ResfacPos(resfacPos), ResfacNeg(resfacNeg), FracDispPos(fracDispPos), FracDispNeg(fracDispNeg), DPos(dPos), DNeg(dNeg), nFactor(NFactor)  // Updated:Filipe Ribeiro and Andre Barbosa
{
    // Initialize Variables by Calling revertToStart function
    this->revertToStart();
    C_Fp = 0.0;                 // Updated:Filipe Ribeiro and Andre Barbosa                                                                                                                 
...
ModIMKPeakOriented02::ModIMKPeakOriented02(int tag, double Ke0, double alfanPos, double alfanNeg, double my_pos, double my_neg, // Updated:Filipe Ribeiro and Andre Barbosa
                                           double ls, double ld, double la, double lk, double cs, double cd, double ca, double ck, double thetaPpos, double thetaPneg, double thetaPCpos, double thetaPCneg, double resfacPos, double resfacNeg, double fracDispPos, double fracDispNeg, double dPos, double dNeg, double CFp, double CFn):UniaxialMaterial(tag, MAT_TAG_ModIMKPeakOriented02), Ke0(Ke0), AlfanPos(alfanPos), AlfanNeg(alfanNeg), My_pos(my_pos), My_neg(my_neg), Ls(ls), Ld(ld), La(la), Lk(lk), Cs(cs), Cd(cd), Ca(ca), Ck(ck), ThetaPpos(thetaPpos), ThetaPneg(thetaPneg), ThetaPCpos(thetaPCpos), ThetaPCneg(thetaPCneg), ResfacPos(resfacPos), ResfacNeg(resfacNeg), FracDispPos(fracDispPos), FracDispNeg(fracDispNeg), DPos(dPos), DNeg(dNeg), C_Fp(CFp), C_Fn(CFn)      // Updated:Filipe Ribeiro and Andre Barbosa
{
    // Initialize Variables by Calling revertToStart function
    this->revertToStart();
    nFactor = 0.0;              // Updated:Filipe Ribeiro and Andre Barbosa
...
ModIMKPeakOriented02::ModIMKPeakOriented02(int tag, double Ke0, double alfanPos, double alfanNeg, double my_pos, double my_neg, // Updated:Filipe Ribeiro and Andre Barbosa
                                           double ls, double ld, double la, double lk, double cs, double cd, double ca, double ck, double thetaPpos, double thetaPneg, double thetaPCpos, double thetaPCneg, double resfacPos, double resfacNeg, double fracDispPos, double fracDispNeg, double dPos, double dNeg, double CFp, double CFn, double NFactor):UniaxialMaterial(tag, MAT_TAG_ModIMKPeakOriented02), Ke0(Ke0), AlfanPos(alfanPos), AlfanNeg(alfanNeg), My_pos(my_pos), My_neg(my_neg), Ls(ls), Ld(ld), La(la), Lk(lk), Cs(cs), Cd(cd), Ca(ca), Ck(ck), ThetaPpos(thetaPpos), ThetaPneg(thetaPneg), ThetaPCpos(thetaPCpos), ThetaPCneg(thetaPCneg), ResfacPos(resfacPos), ResfacNeg(resfacNeg), FracDispPos(fracDispPos), FracDispNeg(fracDispNeg), DPos(dPos), DNeg(dNeg), C_Fp(CFp), C_Fn(CFn), nFactor(NFactor)    // Updated:Filipe Ribeiro and Andre Barbosa
{
    // Initialize Variables by Calling revertToStart function
    this->revertToStart();
    Tangent = Ke;
...
ModIMKPeakOriented02::ModIMKPeakOriented02():UniaxialMaterial(0, MAT_TAG_ModIMKPeakOriented02), Ke0(0.0), AlfanPos(0.0),
AlfanNeg(0.0), My_pos(0.0), My_neg(0.0), Ls(0.0), Ld(0.0), La(0.0),
Lk(0.0),
    // Updated:Filipe Ribeiro and Andre Barbosa
    Cs(0.0), Cd(0.0), Ca(0.0), Ck(0.0), ThetaPpos(0.0), ThetaPneg(0.0), ThetaPCpos(0.0), ThetaPCneg(0.0), ResfacPos(0.0), ResfacNeg(0.0), FracDispPos(0.0), FracDispNeg(0.0), DPos(0.0), DNeg(0.0), C_Fp(0.0), C_Fn(0.0), nFactor(0.0)  // Updated:Filipe Ribeiro and Andre Barbosa
{
    // Initialize Variables by Calling revertToStart function
    this->revertToStart();
    Tangent = Ke;
 ...
 ModIMKPeakOriented02::setTrialStrain(double strain, double strainRate)
{
    ...
    if (kon == 0) {
        ...
        fCapRefPos =
            -capSlopePos * Ke * (ThetaPpos + My_pos / Ke) + fPeakPos;
        fCapRefNeg =
            -capSlopeNeg * Ke * (-ThetaPneg + My_neg / Ke) + fPeakNeg;
    ...
    if (flagStop == 0) {
        ...
        if (deltaD >= 0.0) {
            ...
            if (d >= dmax) {
                envelPosCap2(fyPos, AlfaPos, capSlopePos, cpPos, d, f,
                             ek, Ke, My_pos, ResfacPos, FracDispPos,
                             flagStop);
                dmax = d;
                fmax = f;
                dlstPos = dmax + 1.e-10;
                ...
                envelPosCap2(fyPos, AlfaPos, capSlopePos, cpPos, dmax,
                             fmax, ek, Ke, My_pos, ResfacPos,
                             FracDispPos, flagStop);
                ...
                if (d > 0.0) {
                    envelPosCap2(fyPos, AlfaPos, capSlopePos, cpPos,
                                 d, f, ek, Ke, My_pos, ResfacPos,
                                 FracDispPos, flagStop);
                } else {
                    envelNegCap2(fyNeg, AlfaNeg, capSlopeNeg, cpNeg,
                                 d, f, ek, Ke, My_neg, ResfacNeg,
                                 -FracDispNeg, flagStop);
                }
            ...
            //  Push envelope                                        
            if (d <= dmin) {
                envelNegCap2(fyNeg, AlfaNeg, capSlopeNeg, cpNeg, d, f,
                             ek, Ke, My_neg, ResfacNeg, -FracDispNeg,
                             flagStop);
                dmin = d;
                fmin = f;
                dlstNeg = dmin - 1.e-10;
                ...
                envelNegCap2(fyNeg, AlfaNeg, capSlopeNeg, cpNeg, dmin,
                             fmin, ek, Ke, My_neg, ResfacNeg,
                             -FracDispNeg, flagStop);
        ...
        if ((f * fP < 0.0)) {   // Updated: Filipe
            if (((fP > 0.0) && (dmax > (fyPos / Ke)))
                || ((fP < 0.0) && (dmin < (fyNeg / Ke)))) {
                flagdeg = 1;
                //interup = 1;
            }
        }
        ...
        if (flagdeg == 1) {     //this cycle was reformulated // Filipe Ribeiro and Andre Barbosa
            ...
            if (deltaD < 0.0) {
                ...
                AlfaNeg =
                    AlfaNeg * (1 + nFactor) / (1 + nFactor * AlfaNeg);
                ...
                if (Ke > Ke0) { //if nFactor>0
                    ...
                    envelNegCap2(fyNeg,
                                 ...
                                 capSlopeNeg * (1 + nFactor) / (1 +
                                                                ...
                                                                *
                                                                capSlopeNeg),
                                 cpNegOrig, dmin, fNegOrig, ek0, Ke0,
                                 My_neg, ResfacNeg, -FracDispNeg,
                                 flagStop);
                ...
                double dCap2Neg =
                    (fCapRefNeg + ekhardNeg * dyNeg -
                     fyNeg) / (ekhardNeg - capSlopeNeg * Ke);
                // cpNeg=min(dCap1Neg,dCap2Neg);
                //double fCapNeg = fCapRefNeg + capSlopeNeg*Ke*cpNeg;
                ...
                //1st - recover the strain hardening ratio of the member        
                AlfaPos =
                    AlfaPos * (1 + nFactor) / (1 + nFactor * AlfaPos);
                //2nd - apply the redution to the ratio of the member          
                ...
                if (Ke > Ke0) { //if nFactor>0
                    ...
                    envelPosCap2(fyPos,
                                 ...
                                 capSlopePos * (1 + nFactor) / (1 +
                                                                ...
                                                                *
                                                                capSlopePos),
                                 cpPosOrig, dmax, fPosOrig, ek0, Ke0,
                                 My_pos, ResfacPos, FracDispPos, flagStop);
                    //4th - recompute dmin
                ...
                double dCap2Pos =
                    (fCapRefPos + ekhardPos * dyPos -
                     fyPos) / (ekhardPos - capSlopePos * Ke);
...
UniaxialMaterial *ModIMKPeakOriented02::getCopy(void)
{
    ModIMKPeakOriented02 *theCopy =
        new ModIMKPeakOriented02(this->getTag(), Ke0, AlfanPos, AlfanNeg,
                                 My_pos, My_neg, Ls, Ld, La, Lk,
...
int ModIMKPeakOriented02::sendSelf(int cTag, Channel & theChannel)
{
    int res = 0;
    ...
    if (res < 0)
        opserr <<
            "ModIMKPeakOriented02::sendSelf() - failed to send data\n";

    return res;
}

int ModIMKPeakOriented02::recvSelf(int cTag, Channel & theChannel,
                                   FEM_ObjectBroker & theBroker)
{
    ...
    if (res < 0) {
        opserr <<
            "ModIMKPeakOriented02::recvSelf() - failed to receive data\n";
        this->setTag(0);
    } else {
...
void ModIMKPeakOriented02::Print(OPS_Stream & s, int flag)
{
...
void ModIMKPeakOriented02::envelPosCap2(double fy, double alphaPos,
                                        double alphaCap, double cpDsp,
                                        double &d, double &f, double &ek,
                                        double elstk, double fyieldPos,
                                        double Resfac, double fracDisp,
                                        int &flagStop)
{
...
void ModIMKPeakOriented02::envelNegCap2(double fy, double alphaNeg,
                                        double alphaCap, double cpDsp,
                                        double &d, double &f, double &ek,
                                        double elstk, double fyieldNeg,
                                        double Resfac, double fracDisp,
                                        int &flagStop)
{
...
Response *ModIMKPeakOriented02::setResponse(const char **argv, int argc,
                                            OPS_Stream & theOutputStream)
{
    //by default, See if the response is one of the defaults
    Response *theResponse =
        UniaxialMaterial::setResponse(argv, argc, theOutputStream);
...
int ModIMKPeakOriented02::getResponse(int responseID,
