...
{
    int
        argc = OPS_GetNumRemainingInputArgs () + 2;
...
int
Elastic2Material::setTrial (double strain, double &stress, double &tangent,
                            double strainRate)
{
    if (initialStrain == 99999.99)
        initialStrain = strain;
...
int
Elastic2Material::setParameter (const char **argv, int argc,
                                Parameter & param)
{
