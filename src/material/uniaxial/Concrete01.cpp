...
CminStrain (0.0), CendStrain (0.0), Cstrain (0.0),
Cstress (0.0)
{
    EnergyP = 0;                //SAJalali
...
int
Concrete01::setTrial (double strain, double &stress, double &tangent,
                      double strainRate)
{
    // Reset trial history variables to last committed state
    TminStrain = CminStrain;
...
int
Concrete01::sendSelf (int commitTag, Channel & theChannel)
{
    int res = 0;
...
int
Concrete01::recvSelf (int commitTag, Channel & theChannel,
...
int
Concrete01::commitSensitivity (double TstrainSensitivity, int gradIndex,
                               int numGrads)
{
