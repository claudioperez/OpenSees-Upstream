...
Concrete01::Concrete01
    (int tag, double FPC, double EPSC0, double FPCU,
     double EPSCU):UniaxialMaterial(tag, MAT_TAG_Concrete01), fpc(FPC),
epsc0(EPSC0), fpcu(FPCU), epscu(EPSCU), CminStrain(0.0), CendStrain(0.0),
...
int Concrete01::setTrial(double strain, double &stress, double &tangent,
                         double strainRate)
{
    // Reset trial history variables to last committed state
    TminStrain = CminStrain;
...
// AddingSensitivity:BEGIN ///////////////////////////////////
int Concrete01::setParameter(const char **argv, int argc,
                             Parameter & param)
{
...
int Concrete01::updateParameter(int parameterID, Information & info)
{
    switch (parameterID) {
    case 1:
...
int Concrete01::activateParameter(int passedParameterID)
{
...
double Concrete01::getStressSensitivity(int gradIndex, bool conditional)
{
...
int Concrete01::commitSensitivity(double TstrainSensitivity, int gradIndex,
                                  int numGrads)
{
...
int Concrete01::getVariable(const char *varName, Information & theInfo)
{
