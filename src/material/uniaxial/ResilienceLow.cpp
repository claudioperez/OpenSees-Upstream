...
ResilienceLow::ResilienceLow(int tag, double pPY, double pDPmax,
                             double pPmax, double pKe,
                             double pKd):UniaxialMaterial(tag,
                                                          MAT_TAG_ResilienceLow),
...
int ResilienceLow::commitState(void)
{
    Cstrain = strain;
    Cstress = stress;
    Ctangent = tangent;
...
int ResilienceLow::revertToLastCommit(void)
{
    return 0;
}

int ResilienceLow::revertToStart(void)
{
    return 0;
}
