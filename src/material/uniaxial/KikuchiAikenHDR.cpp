...
KikuchiAikenHDR::KikuchiAikenHDR(int tag, int tp, double ar, double hr,
                                 double cg, double ch, double cu,
                                 double rs,
                                 double rf):UniaxialMaterial(tag,
                                                             MAT_TAG_KikuchiAikenHDR),
Tp(tp), Ar(ar), Hr(hr), Cg(cg), Ch(ch), Cu(cu), Rs(rs), Rf(rf)
{
        ...
        if (trialDStrain * commitDStrainLastSign < 0) {
            ...
            if (trialIdxRev == 0) {     // unload
                ...
                b = (this->calcB) (fabs(commitStrain), a, c,
                                   (this->calcHeq) (fabs(commitStrain)) *
                                   Ch,
...
double KikuchiAikenHDR::getStress(void)
{
    return trialForce;
}

double KikuchiAikenHDR::getTangent(void)
{
    return trialStiff;
}

double KikuchiAikenHDR::getInitialTangent(void)
{
    return initialStiff;
}

double KikuchiAikenHDR::getStrain(void)
{
    return trialDeform;
}

int KikuchiAikenHDR::commitState(void)
{
...
int KikuchiAikenHDR::revertToLastCommit(void)
{
...
int KikuchiAikenHDR::revertToStart(void)
{
...
UniaxialMaterial *KikuchiAikenHDR::getCopy(void)
{
...
int KikuchiAikenHDR::sendSelf(int cTag, Channel & theChannel)
{
    return -1;
}

int KikuchiAikenHDR::recvSelf(int cTag, Channel & theChannel,
                              FEM_ObjectBroker & theBroker)
{
    return -1;
}

void KikuchiAikenHDR::Print(OPS_Stream & s, int flag)
{
...
double KikuchiAikenHDR::compQ1(double u, double n, double fm, double x)
{
...
double
 KikuchiAikenHDR::compQ1Derivertive(double u, double n, double geq,
                                    double x)
{
...
double
    KikuchiAikenHDR::compABisection(double heq, double u, double min,
                                    double max, double tol, double lim)
{
