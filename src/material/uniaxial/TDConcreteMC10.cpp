    ...
    if (numArgs == 17)
      {
          ...
          if (OPS_GetIntInput (&numData, &iData) != 0)
            {
                opserr <<
                    "WARNING: invalid uniaxialMaterial TDConcreteMC10 tag\n";
                return 0;
            }
          ...
          //ntosic
          theMaterial =
              new TDConcreteMC10 (iData, dData[0], dData[1], dData[2],
          ...
          if (theMaterial == 0)
            {
                opserr <<
                    "WARNING: could not create uniaxialMaterial of type TDConcreteMC10 \n";
                return 0;
            }
...
TDConcreteMC10::TDConcreteMC10 (int tag, double _fc, double _ft, double _Ec,
                                double _Ecm, double _beta, double _age,
                                double _epsba, double _epsbb, double _epsda,
                                double _epsdb, double _phiba, double _phibb,
                                double _phida, double _phidb, double _tcast,
                                double _cem):
...
{
    s << "TDConcreteMC10:(strain, stress, tangent) " << eps << " " << sig <<
        " " << e << endln;
}
