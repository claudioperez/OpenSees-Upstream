...
UniaxialMaterial *
TclModelBuilder_addPyTzQzMaterial (ClientData clientData, Tcl_Interp * interp,
                ...
                if (Tcl_GetDouble (interp, argv[7], &dashpot) != TCL_OK)
                  {
                      ...
                      opserr << "uniaxialMaterial PySimple1: " << tag <<
                          endln;
                      return 0;
                  }
            }
                ...
                if (Tcl_GetDouble (interp, argv[6], &suction) != TCL_OK)
                  {
                      ...
                      opserr << "uniaxialMaterial QzSimple1: " << tag <<
                          endln;
                      return 0;
                  }
                if (Tcl_GetDouble (interp, argv[7], &dashpot) != TCL_OK)
          ...
          if (argc > 6)
            {
                if (Tcl_GetDouble (interp, argv[6], &dashpot) != TCL_OK)
                  {
                      opserr << "WARNING invalid dashpot\n";
                      opserr << "uniaxialMaterial TzSimple1: " << tag <<
                          endln;
                      return 0;
                  }
            }
