...
//////////////////////////////////////////////////////////////////////////////////////////////////
    if ((strcmp(argv[1], "PySimple1") == 0) ||
        ...
        int
         tag, soilType;
        double
         pult, y50, drag, dashpot;

        if (Tcl_GetInt(interp, argv[2], &tag) != TCL_OK) {
            opserr << "WARNING invalid uniaxialMaterial PySimple1 tag" <<
                endln;
            return 0;
        }
        ...
        if (strcmp(argv[1], "PySimple1") == 0)
            theMaterial =
                new PySimple1(tag, MAT_TAG_PySimple1, soilType, pult, y50,
                              drag, dashpot);
        else
            theMaterial =
                new PySimple2(tag, MAT_TAG_PySimple1, soilType, pult, y50,
                              drag, dashpot);
...
//////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        int
         tag, soilType, solidElem1, solidElem2, seriesTag;
        double
         pult, y50, drag, dashpot, pRes;
        solidElem1 = 0;
        solidElem2 = 0;

        if (Tcl_GetInt(interp, argv[2], &tag) != TCL_OK) {
            opserr << "WARNING invalid uniaxialMaterial PyLiq1 tag" <<
                endln;
            return 0;
        }
        ...
        if (strcmp(argv[9], "-timeSeries") != 0) {
            ...
            // Parsing was successful, allocate the material
            theMaterial =
                new PyLiq1(tag, MAT_TAG_PyLiq1, soilType, pult, y50,
                           drag, dashpot, pRes, solidElem1, solidElem2,
                           theDomain);
        } else {
            ...
            theMaterial =
                new PyLiq1(tag, MAT_TAG_PyLiq1, soilType, pult, y50,
                           drag, dashpot, pRes, theDomain, theSeries);
        }
    }
...
//////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if (argc < 6) {
            ...
            printCommand(argc, argv);
            opserr <<
                "Want: uniaxialMaterial QzSimple1 tag? QzType? Qult? z50? suction? dashpot? "
                << endln;
            return 0;
        }
        ...
        int
         tag, QzType;
        double
         Qult, z50, suction, dashpot;

        if (Tcl_GetInt(interp, argv[2], &tag) != TCL_OK) {
            opserr << "WARNING invalid uniaxialMaterial QzSimple1 tag" <<
                endln;
            return 0;
        }
        ...
        if (strcmp(argv[1], "QzSimple1") == 0)
            theMaterial =
                new QzSimple1(tag, QzType, Qult, z50, suction, dashpot);
        else
            theMaterial =
                new QzSimple2(tag, QzType, Qult, z50, suction, dashpot);
    }
...
//////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        if (argc < 6) {
            ...
            printCommand(argc, argv);
            opserr <<
                "Want: uniaxialMaterial TzSimple1 tag? tzType? tult? z50? dashpot? "
                << endln;
            return 0;
        }
        ...
        if (Tcl_GetInt(interp, argv[2], &tag) != TCL_OK) {
            opserr << "WARNING invalid uniaxialMaterial TzSimple1 tag" <<
                endln;
            return 0;
        }
        ...
        if (strcmp(argv[1], "TzSimple1") == 0)
            theMaterial =
                new TzSimple1(tag, MAT_TAG_TzSimple1, tzType, tult, z50,
                              dashpot);
        else
            theMaterial =
                new TzSimple2(tag, MAT_TAG_TzSimple1, tzType, tult, z50,
                              dashpot);
    }
...
//////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        int
         tag, tzType, solidElem1, solidElem2, seriesTag;
        double
         tult, z50, dashpot;

        if (Tcl_GetInt(interp, argv[2], &tag) != TCL_OK) {
            opserr << "WARNING invalid uniaxialMaterial TzLiq1 tag" <<
                endln;
            return 0;
        }
        ...
        if (strcmp(argv[7], "-timeSeries") != 0) {
            ...
            // Parsing was successful, allocate the material
            theMaterial =
                new TzLiq1(tag, MAT_TAG_TzLiq1, tzType, tult, z50,
                           dashpot, solidElem1, solidElem2, theDomain);
        } else {
