...
void *OPS_TzLiq1()
{
    ...
    if (numdata < 7) {
        ...
        opserr <<
            "Want: uniaxialMaterial TzLiq1 tag? tzType? tult? z50? dashpot? solidElem1? solidElem2?\n";
        opserr <<
            "or: uniaxialMaterial TzLiq1 tag? tzType? tult? z50? dashpot? -timeSeries seriesTag?\n";
        return 0;
    }
    ...
    if (strcmp(arg, "-timeSeries") == 0) {
        ...
        theMat =
            new TzLiq1(idata[0], MAT_TAG_TzLiq1, idata[1], ddata[0],
                       ddata[1], ddata[2], theDomain, theSeries);
        ...
        theMat =
            new TzLiq1(idata[0], MAT_TAG_TzLiq1, idata[1], ddata[0],
                       ddata[1], ddata[2], eleTags[0], eleTags[1],
                       theDomain);
    }
...
TzLiq1::TzLiq1(int tag, int classtag, int tz_type, double t_ult,
               double z_50, double dash_pot, int solid_elem1,
               int solid_elem2, Domain * the_Domain):TzSimple1(tag,
                                                               classtag,
                                                               tz_type,
                                                               t_ult, z_50,
                                                               dash_pot),
...
TzLiq1::TzLiq1(int tag, int classtag, int tz_type, double t_ult,
               double z_50, double dash_pot, Domain * the_Domain,
               TimeSeries * the_Series):TzSimple1(tag, classtag, tz_type,
                                                  t_ult, z_50, dash_pot),
...
TzLiq1::TzLiq1():TzSimple1(), solidElem1(0), solidElem2(0), theDomain(0)
{
}
 ...
 TzLiq1::setTrialStrain(double newz, double zRate)
{
    ...
    if (lastLoadStage == 0 && loadStage == 1) {
        ...
        if (meanConsolStress == 0.0) {
            ...
            opserr << "TzLiq1: " << endln;
            if (TzConstructorType == 2)
                opserr << "Effective Stress file seriesTag: " <<
                    theSeries->getTag() << endln;
            else
...
/////////////////////////////////////////////////////////////////////
double TzLiq1::getInitialTangent(void)
{
    return this->initialTangent;
}

/////////////////////////////////////////////////////////////////////
double TzLiq1::getDampTangent(void)
{
    // Call the base class TzSimple1 to get basic t-z response,
...
/////////////////////////////////////////////////////////////////////
double TzLiq1::getStrainRate(void)
{
...
/////////////////////////////////////////////////////////////////////
int TzLiq1::revertToLastCommit(void)
{
...
/////////////////////////////////////////////////////////////////////
double TzLiq1::getEffectiveStress(TimeSeries * theSeries)
{
    return theSeries->getFactor(theDomain->getCurrentTime());
}

double TzLiq1::getEffectiveStress(void)
{
    ...
    if (theDomain != 0) {
        ...
        if (theElement1->getClassTag() != ELE_TAG_FourNodeQuad
            ...
            opserr << "Element: " << theElement1->getTag() <<
                " cannot be used to read effective stress for a TzLiq1 material."
                << endln;
            exit(-1);
        }
...
/////////////////////////////////////////////////////////////////////
int TzLiq1::updateParameter(int snum, Information & eleInformation)
{
    ...
    if (snum != 0 && snum != 1) {
        opserr <<
            "WARNING updateMaterialStage for TzLiq1 material must be 0 or 1";
        opserr << endln;
        exit(-1);
    }
    loadStage = snum;
...
/////////////////////////////////////////////////////////////////////
UniaxialMaterial *TzLiq1::getCopy(void)
{
...
/////////////////////////////////////////////////////////////////////
int TzLiq1::sendSelf(int cTag, Channel & theChannel)
{
...
/////////////////////////////////////////////////////////////////////
int TzLiq1::recvSelf(int cTag, Channel & theChannel,
...
/////////////////////////////////////////////////////////////////////
void TzLiq1::Print(OPS_Stream & s, int flag)
{
