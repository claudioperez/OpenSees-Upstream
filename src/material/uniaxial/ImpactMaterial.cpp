...
void *OPS_ImpactMaterial(void)
{
    ...
    theMaterial =
        new ImpactMaterial(iData[0], dData[0], dData[1], dData[2],
                           dData[3]);
...
ImpactMaterial::ImpactMaterial(int tag, double k1, double k2,
                               double delta_y,
                               double gap0):UniaxialMaterial(tag,
                                                             MAT_TAG_ImpactMaterial),
...
double ImpactMaterial::getStrain(void)
{
    return Tstrain;
}

double ImpactMaterial::getStress(void)
{
    return Tstress;
}

double ImpactMaterial::getTangent(void)
{
    return Ttangent;
}

double ImpactMaterial::getInitialTangent(void)
{
    return K1;
}

int ImpactMaterial::commitState(void)
{
    Cstress = Tstress;
    Cstrain = Tstrain;
    return 0;
...
int ImpactMaterial::revertToLastCommit(void)
{
    Tstrain = Cstrain;
    Tstress = Cstress;
    return 0;
...
int ImpactMaterial::revertToStart(void)
{
    Cstrain = 0.0;
    Cstress = 0.0;
    Tstrain = 0.0;
...
UniaxialMaterial *ImpactMaterial::getCopy(void)
{
...
int ImpactMaterial::sendSelf(int cTag, Channel & theChannel)
{
    int res = 0;
...
int ImpactMaterial::recvSelf(int cTag, Channel & theChannel,
...
void ImpactMaterial::Print(OPS_Stream & s, int flag)
{
