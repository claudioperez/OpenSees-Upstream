...
IMKBilin::IMKBilin (int tag, double p_Ke,
                    ...
                    double p_c_S, double p_c_C, double p_c_K, double p_D_pos,
                    double p_D_neg):
UniaxialMaterial (tag, 0),
Ke (p_Ke),
Theta_p_pos0 (p_Theta_p_pos0),
Theta_pc_pos0 (p_Theta_pc_pos0),
Theta_u_pos0 (p_Theta_u_pos0),
Mpe_pos0 (p_Mpe_pos0),
MmaxMpe_pos0 (p_MmaxMpe_pos0),
ResM_pos0 (p_ResM_pos0),
Theta_p_neg0 (p_Theta_p_neg0),
Theta_pc_neg0 (p_Theta_pc_neg0),
Theta_u_neg0 (p_Theta_u_neg0),
Mpe_neg0 (p_Mpe_neg0),
MmaxMpe_neg0 (p_MmaxMpe_neg0),
ResM_neg0 (p_ResM_neg0),
LAMBDA_S (p_LAMBDA_S),
LAMBDA_C (p_LAMBDA_C),
LAMBDA_K (p_LAMBDA_K),
c_S (p_c_S),
...
IMKBilin::setTrialStrain (double strain, double strainRate)
{
    ...
    double K_j;
    double Ki, slope_pi, slope_pci, Theta_yi, Theta_maxi, Mmaxi, MpeProjecti,
        MmaxProjecti, Theta_pci;
...
double
IMKBilin::getInitialTangent (void)
{
...
int
IMKBilin::revertToLastCommit (void)
{
...
IMKBilin::getCopy (void)
{
    IMKBilin *theCopy = new IMKBilin (this->getTag (), Ke,
                                      ...
                                      ResM_neg0,
                                      LAMBDA_S, LAMBDA_C, LAMBDA_K, c_S, c_C,
                                      c_K, D_pos, D_neg);
...
int
IMKBilin::sendSelf (int cTag, Channel & theChannel)
{
    int res = 0;
    cout << " sendSelf" << endln;
...
int
IMKBilin::recvSelf (int cTag, Channel & theChannel,
...
void
IMKBilin::Print (OPS_Stream & s, int flag)
{
