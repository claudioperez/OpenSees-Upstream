...
OOHystereticMaterial::negativeIncrement (double dStrain)
{
    ...
    double rotlim =
        (E <
         0) ? CrotMax - posEnvelope->getStress (CrotMax) / E : POS_INF_STRAIN;
...
{
    OOHystereticMaterial *theCopy = new OOHystereticMaterial (this->getTag (),
                                                              *posEnvelope,
                                                              *negEnvelope,
                                                              *posUnlRule,
                                                              *negUnlRule,
...
OOHystereticMaterial::getVariable (int varID, Information & info)
{
    switch (varID)
      ...
      case 4:
          info =
              posEnvelope->getEnergy (rot1p) +
              negEnvelope->getEnergy (-rot1n);
          return 0;
      default:
