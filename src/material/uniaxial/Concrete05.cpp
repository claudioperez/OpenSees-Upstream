...
Concrete05::Concrete05(int tag, double FPCC, double EPCC, double EC, double RC, double XCRN, double FT, double ET, double RT, double XCRP):UniaxialMaterial(tag, MAT_TAG_Concrete05), fpcc(FPCC), epcc(EPCC), Ec(EC), rc(RC), xcrn(XCRN), ft(FT), et(ET), rt(RT), xcrp(XCRP),   // input
...
Concrete05::Concrete05():UniaxialMaterial(0, MAT_TAG_Concrete05), fpcc(0.0), epcc(0.0), Ec(0.0),
rc(0.0), xcrn(0.0), ft(0.0), et(0.0), rt(0.0),
xcrp(0.0),
    // input
    Ceunn(0.0), Cfunn(0.0), Ceunp(0.0), Cfunp(0.0), Cer(0.0), Cfr(0.0), Cer0n(0.0), Cfr0n(0.0), Cer0p(0.0), Cfr0p(0.0), Ce0(0.0), Cea(0.0), Ceb(0.0), Ced(0.0), Cinc(0.0), Crule(0.0), Cstrain(0.0), Cstress(0.0), Ctangent(0.0)        // history and state variables
...
void Concrete05::fnewstnf(double funn, double delfn, double eunn,
                          double er0n, double espln)
{
    fnewstn = funn - delfn * ((eunn - er0n) / (eunn - espln));
}

void Concrete05::Enewstnf(double fnewstn, double fr0n, double eunn,
                          double er0n)
{
    Enewstn = (fnewstn - fr0n) / (eunn - er0n);
}

void Concrete05::esrestnf(double eunn, double delen, double er0n,
                          double espln)
{
...
void Concrete05::fnewstpf(double funp, double delfp, double eunp,
                          double er0p, double esplp, double e0)
{
    fnewstp = funp - delfp * ((eunp - er0p) / (eunp - esplp));
}

void Concrete05::Enewstpf(double fnewstp, double fr0p, double eunp,
                          double er0p)
{
    Enewstp = (fnewstp - fr0p) / (eunp - er0p);
}

void Concrete05::esrestpf(double eunp, double delep, double er0p,
                          double esplp)
{
    esrestp = eunp + delep * (eunp - er0p) / (eunp - esplp);
}

void Concrete05::freErestpf(double eunp, double funp, double er0p,
...
void Concrete05::e0eunpfunpf(double e0, double eunp, double funp,
...
void Concrete05::r9f(double espln, double Epln, double eunp, double fnewp,
                     double Enewp)
{
    esi = espln;
    fi = 0.0;
...
void Concrete05::r8f(double eunp, double fnewp, double Enewp, double esrep,
...
void Concrete05::r10f(double esplp, double Eplp, double eunn, double fnewn,
                      double Enewn)
{
    esi = esplp;
    fi = 0.0;
...
void Concrete05::r7f(double eunn, double fnewn, double Enewn, double esren,
...
void Concrete05::r12f(double er, double fr, double ea, double fca,
...
void Concrete05::r11f(double er, double fr, double eb, double fcb,
...
void Concrete05::r15f(double er, double fr, double ea, double fca,
                      double Eta, double A, double R)
{
    esi = er;
    fi = fr;
...
void Concrete05::r88f(double e, double e0, double er0p, double fr0p,
...
void Concrete05::r77f(double e, double e0, double er0n, double fr0n,
...
void Concrete05::ea1112f(double eb, double espln, double esplp,
                         double eunn, double eunp)
{
    Tea = espln + ((eunn - eb) / (eunn - esplp)) * (eunp - espln);
}

void Concrete05::eb1112f(double ea, double espln, double esplp,
                         double eunn, double eunp)
{
...
void Concrete05::RAf(double esi, double fi, double Ei, double esf,
                     double ff, double Ef)
{
...
void Concrete05::fcEturf(double es, double esi, double fi, double esf,
