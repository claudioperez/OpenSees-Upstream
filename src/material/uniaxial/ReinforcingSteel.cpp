...
OPS_ReinforcingSteel ()
{
    ...
    int
        buckModel = 0;
    double
    gabuckdata[4] = { 0.0, 1.0, 1.0, 0.5 };
    double
    dmbuckdata[2] = { 0.0, 1.0 };
    double
    fatiguedata[3] = { 0.0, -4.46, 0.0 };
    double
    mpdata[3] = { 1.0 / 3.0, 18.0, 4.0 };
    double
    isodata[2] = { 0.0, 0.01 };
...
ReinforcingSteel::Buckled_stress_Gomes (double ess, double fss)
{
    ...
    double t_s_out =
        fsup * fsu_fraction - (factor + fsu_fraction) * (fsup * fsu_fraction -
                                                         fss) / (1.0 +
                                                                 fsu_fraction);
    return t_s_out;
}
