...
OPS_ConcretewBeta (void)
{
    ...
    if (total < 12)
      {
          ...
          opserr <<
              "Want: uniaxialMaterial ConcretewBeta $tag $fpc $ec0 $fcint $ecint $fcres $ecres $ft $ftint $etint $ftres $etres <-lambda $lambda> <-alpha $alpha> <-beta $bint $ebint $bres $ebres> <-E $E> <-conf $fcc ecc>\n";
          return 0;
      }
          ...
          if (strcmp (optionFlag, "-beta") == 0)
            {
                ...
                if (OPS_GetDoubleInput (&numData, bData) != 0)
                  {
                      opserr <<
                          "WARNING invalid uniaxialMaterial ConcretewBeta argument of -beta for tag "
                          << tag << endln;
                      return 0;
                  }
                total -= 5;
          ...
          else if (strcmp (optionFlag, "-lambda") == 0)
            {
                ...
                if (OPS_GetDoubleInput (&numData, &lambda) != 0)
                  {
                      opserr <<
                          "WARNING invalid uniaxialMaterial ConcretewBeta argument of -lambda for tag "
                          << tag << endln;
                      return 0;
                  }
                total -= 2;
          ...
          else if (strcmp (optionFlag, "-alpha") == 0)
            {
                ...
                if (OPS_GetDoubleInput (&numData, &alpha) != 0)
                  {
                      opserr <<
                          "WARNING invalid uniaxialMaterial ConcretewBeta argument of -alpha for tag "
                          << tag << endln;
                      return 0;
                  }
                total -= 2;
          ...
          else if (strcmp (optionFlag, "-M") == 0)
            {
                ...
                if (OPS_GetDoubleInput (&numData, &M) != 0)
                  {
                      opserr <<
                          "WARNING invalid uniaxialMaterial ConcretewBeta argument of -M for tag "
                          << tag << endln;
                      return 0;
                  }
                total -= 2;
          ...
          else if (strcmp (optionFlag, "-E") == 0)
            {
                ...
                if (OPS_GetDoubleInput (&numData, &E0) != 0)
                  {
                      opserr <<
                          "WARNING invalid uniaxialMaterial ConcretewBeta argument of -E for tag "
                          << tag << endln;
                      return 0;
                  }
                total -= 2;
          ...
          else if (strcmp (optionFlag, "-conf") == 0)
            {
                ...
                if (OPS_GetDoubleInput (&numData, &fcc) != 0)
                  {
                      opserr <<
                          "WARNING invalid uniaxialMaterial ConcretewBeta argument 1 of -conf for tag "
                          << tag << endln;
                      return 0;
                  }
                if (OPS_GetDoubleInput (&numData, &ecc) != 0)
                  {
                      opserr <<
                          "WARNING invalid uniaxialMaterial ConcretewBeta argument 2 of -conf for tag "
                          << tag << endln;
                      return 0;
                  }
                total -= 3;
            ...
            {
                opserr <<
                    "WARNING invalid uniaxialMaterial ConcretewBeta flag " <<
                    tag << endln;
                return 0;
            }
      }
    ...
    UniaxialMaterial *theMaterial =
        new ConcretewBeta (tag, dData[0], dData[1], dData[2], dData[3],
                           dData[4], dData[5], dData[6], dData[7], dData[8],
                           dData[9], dData[10], lambda, alpha, bData[0],
...
ConcretewBeta::ConcretewBeta (int tag, double fpc1, double ec01,
                              double fcint1, double ecint1, double fcres1,
                              double ecres1, double fct1, double ftint1,
                              double etint1, double ftres1, double etres1,
                              double lambda1, double alpha1, double bint1,
                              double etbint1, double bres1, double etbres1,
                              double M1, double E01, double fcc1,
                              double ecc1):
...
ecc (ecc1)
{
    if (fpc > 0 || ec0 > 0 || fcint > 0 || ecint > 0 || fcres > 0
        || ecres > 0)
      {
          opserr << "WARNING uniaxialMaterial ConcretewBeta tag " << tag <<
              " has positive compression stress-strain values";
      }
    if (ecint < ecres)
      {
          opserr << "WARNING uniaxialMaterial ConcretewBeta tag " << tag <<
              " has ecint greater magnitude than ecres";
      }
    if (fct1 < 0 || ftint < 0 || etint < 0 || ftres < 0 || etres < 0)
      {
          opserr << "WARNING uniaxialMaterial ConcretewBeta tag " << tag <<
              " has negative tension stress-strain values";
      }
    if (lambda < 0 || lambda > 1)
      {
          opserr << "WARNING uniaxialMaterial ConcretewBeta tag " << tag <<
              " has invalid lambda value";
      }
    if (alpha < 0)
      {
          opserr << "WARNING uniaxialMaterial ConcretewBeta tag " << tag <<
              " has invalid alpha value";
      }
    if (bint < 0 || etbint < 0 || bres < 0 || etbres < 0)
      {
          opserr << "WARNING uniaxialMaterial ConcretewBeta tag " << tag <<
              " has negative beta values";
      }
    if (fcc == 0)
      {
          fcc = fpc;
      ...
      {
          opserr << "WARNING uniaxialMaterial ConcretewBeta tag " << tag <<
              " has fcc smaller than fpc: material will ignoring confinement";
          fcc = fpc;
          ecc = ec0;
      }
    else if (ecc > ec0)
      {
          opserr << "WARNING uniaxialMaterial ConcretewBeta tag " << tag <<
              " has ecc smaller than ec0: material will ignoring confinement";
          fcc = fpc;
          ecc = ec0;
      }
    if (M < 0)
    ...
    if (E0 == 0)
      ...
      {
          opserr << "WARNING uniaxialMaterial ConcretewBeta tag " << tag <<
              " too small E0 value - setting to (fpc/ec0)";
          E0 = (fpc / ec0);
      }
    else if (E0 > (2 * fpc / ec0))
      {
          opserr << "WARNING uniaxialMaterial ConcretewBeta tag " << tag <<
              " too large E0 value - setting to (2*fpc/ec0)";
          E0 = 2 * (fpc / ec0);
      }
...
ConcretewBeta::ConcretewBeta ():UniaxialMaterial (0, MAT_TAG_ConcretewBeta),
fpc (0), ec0 (0), E0 (0), fcint (0), ecint (0), fcres (0),
ecres (0), fct (0), ftint (0), etint (0), ftres (0), etres (0),
lambda (0), alpha (0), bint (0), etbint (0), bres (0), etbres (0), M (0)
{
...
int
ConcretewBeta::setTrialStrain (double strain, double strainRate)
{
...
int
ConcretewBeta::setTrialStrainwBeta (double newStrain, double et,
                                    double strainRate)
{
    //rever to last value.
...
double
ConcretewBeta::getStrain (void)
{
    return Tstrain;
}

double
ConcretewBeta::getStress (void)
{
    return Tstress;
}

double
ConcretewBeta::getTangent (void)
{
    return Ttangent;
}

double
ConcretewBeta::getBeta (void)
{
    return Tbeta;
}

double
ConcretewBeta::getInitialTangent (void)
{
    return E0;
}

int
ConcretewBeta::commitState (void)
{
...
int
ConcretewBeta::revertToLastCommit (void)
{
...
int
ConcretewBeta::revertToStart (void)
{
    CMaxStrainCompr = 0.0;
    CMaxStressCompr = 0.0;
...
UniaxialMaterial *
ConcretewBeta::getCopy (void)
{
    ConcretewBeta *theCopy =
        new ConcretewBeta (this->getTag (), this->fpc, this->ec0, this->fcint,
                           this->ecint,
                           this->fcres, this->ecres, this->fct, this->ftint,
                           this->etint, this->ftres, this->etres,
                           this->lambda,
                           this->alpha, this->bint, this->etbint, this->bres,
                           this->etbres, this->M, this->E0, this->fcc,
                           this->ecc);
...
int
ConcretewBeta::sendSelf (int commitTag, Channel & theChannel)
{
    int res = 0;
...
int
ConcretewBeta::recvSelf (int commitTag, Channel & theChannel,
...
void
ConcretewBeta::Print (OPS_Stream & s, int flag)
{
...
int
ConcretewBeta::setValues (double newStrain, double beta, double &newStress,
                          double &newStressPure, double &newTangent)
{
    if (E0 == 0)
      {
    ...
    if (de > 0)
      {
          ...
          if (newStrain > CMaxStrainTens)
                      ...
                      if (newStrain <= etint)
                        {
                            ...
                            newStressPure =
                                newTangent * (newStrain - etint) + ftint;
                            newStress = newStressPure;
                        }
                      else if (newStrain <= etres)
                        {
                            ...
                            newStressPure =
                                newTangent * (newStrain - etres) + ftres;
                            newStress = newStressPure;
                        }
                      else
                        {
                ...
                if (E1 > E0 || E1 < 0)
                  {
                      ...
                      newTangent =
                          (CMaxStressTens - Tstress) / (CMaxStrainTens -
                                                        Tstrain);
                      newStressPure = newTangent * de + Tstress;
                      newStress = newStressPure;
                  }
                else if (newStress > 0)
                  {
                      ...
                      newTangent =
                          (CMaxStressTens) / (CMaxStrainTens - zeroStrain);
          ...
          else
            {
                ...
                newTangent =
                    (CMaxStressTens - Tstress) / (CMaxStrainTens - Tstrain);
                ...
                if (newStrain >= eaftc && CMaxStrainTens > 0)
                  {
                      ...
                      newStressPure = newTangent * de + Tstress;
                      newTangent =
                          (beta * alphafct - Tstress) / (eaftc - Tstrain);
                ...
                else if (newStrain >= ec0)
                  {
                      ...
                      newStressPure =
                          E0 * newStrain + temp2 * (newStrain * newStrain);
                ...
                else if (newStrain >= ecint)
                  {
                      // linear softening
                      newStressPure =
                          ElinearsoftcP1 * (newStrain - ecint) + fcint;
                      newStress = beta * newStressPure;
                ...
                else if (newStrain >= ecres)
                  {
                      // linear softening
                      newStressPure =
                          ElinearsoftcP2 * (newStrain - ecres) + fcres;
                      newStress = beta * newStressPure;
                ...
                else
                  {
                      ...
                      //} else {
                      newTangent =
                          (newStress - Tstress) / (newStrain - Tstrain);
                      //}
                  }
            }
          ...
          else
            {
                ...
                if (Tstrain >= eaftc)
                      ...
                      if (beta * CMaxStressComprPure > CMaxStressCompr)
                        {
                            E2a =
                                (CMaxStressComprPure -
                                 Tstress) / (CMaxStrainCompr - Tstrain);
                            maxaim = beta * CMaxStressComprPure;
                            E2 = (maxaim - Tstress) / (CMaxStrainCompr -
                                                       Tstrain);
                        }
                      else
                        {
                            ...
                            E2 = (maxaim - Tstress) / (CMaxStrainCompr -
                                                       Tstrain);
                            E2a =
                                (maxaim / beta - Tstress) / (CMaxStrainCompr -
                                                             Tstrain);
                        }
                      ...
                      if (E1a > E2a && CMaxStrainCompr <= ec0)
                        {
                            newTangent =
                                (maxaim -
                                 (Tstress +
                                  unloadStress)) / (CMaxStrainCompr -
                                                    (Tstrain + unloadStrain));
                            newStressPure =
                                E2a * (newStrain - Tstrain) + Tstress;
                      ...
                      else
                        {
                            newTangent =
                                (beta * alphafct -
                                 (Tstress + unloadStress)) / (eaftc -
                                                              (Tstrain +
                                                               unloadStrain));
                            newStressPure =
                                E1a * (newStrain - Tstrain) + Tstress;
                ...
                else
                  {
                      ...
                      //} else {
                      E2 = (maxaim -
                            (Tstress + unloadStress)) / (CMaxStrainCompr -
                                                         (Tstrain +
                                                          unloadStrain));
                      E2a =
                          (maxaimA -
...
double
ConcretewBeta::computeBeta (double newStrain, double et)
{
    if (et <= 0.0)
      {
          return 1.0;
...
void
ConcretewBeta::updateStoredValues ()
{
    if (ec0 == 0)
      {
          et0 = 0;
                            ...
                            OPS_Stream & theOutput)
{
    ...
    // limit:  no more than 10000 random variables/sensitivity parameters
    else if (strstr (argv[0], "stressSensitivity") != 0)
      {
          ...
          theResponse =
              new MaterialResponse (this, gradient + 10000,
                                    this->getStress ());
      }
    // strain sensivitiy
    else if (strstr (argv[0], "strainSensitivity") != 0)
      {
          ...
          theResponse =
              new MaterialResponse (this, gradient + 20000,
                                    this->getStrain ());
      }
...
ConcretewBeta::getResponse (int responseID, Information & matInfo)
{
    ...
    if ((responseID > 10000) && (responseID < 20000))
      {
          matInfo.setDouble (this->
                             getStressSensitivity (responseID - 10000,
                                                   false));
          return 0;
      }
