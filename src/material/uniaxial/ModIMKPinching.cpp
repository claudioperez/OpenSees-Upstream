...
ModIMKPinching::ModIMKPinching (int tag, double ke0, double alfanPos, double alfanNeg, double my_pos, double my_neg,    // Updated: Filipe Ribeiro and Andre Barbosa
    ...
    :
UniaxialMaterial (tag, MAT_TAG_ModIMKPinching),
Ke0 (ke0),
AlfanPos (alfanPos),
AlfanNeg (alfanNeg),
My_pos (my_pos),
...
ModIMKPinching::ModIMKPinching (int tag, double ke0, double alfanPos, double alfanNeg, double my_pos, double my_neg,    // Updated: Filipe Ribeiro and Andre Barbosa
                                double fprPos, double fprNeg, double a_pinch,
                                double ls, double ld, double la, double lk,
                                double cs, double cd, double ca, double ck,
...
ModIMKPinching::ModIMKPinching ():UniaxialMaterial (0, MAT_TAG_ModIMKPinching), Ke0 (0.0), AlfanPos (0.0), AlfanNeg (0.0), My_pos (0.0), My_neg (0.0), FprPos (0.0), FprNeg (0.0), A_pinch (0.0),
                                                                                                                                                                // Updated: Filipe Ribeiro and Andre Barbosa
...
double
ModIMKPinching::getTangent (void)
{
    return (Tangent);
}

double
ModIMKPinching::getInitialTangent (void)
{
    return (Ke);
}

double
ModIMKPinching::getDampTangent (void)
{
    double DTangent = ekP;
    return DTangent;
}
...
double
ModIMKPinching::getStrain (void)
{
    return dP;
}

double
ModIMKPinching::getStrainRate (void)
{
    return 0;
}

int
ModIMKPinching::commitState (void)
{
...
int
ModIMKPinching::revertToLastCommit (void)
{
    dP = Cstrain;
    fP = Cstress;
    Tangent = Ctangent;
...
int
ModIMKPinching::revertToStart (void)
{
...
void
ModIMKPinching::envelPosCap2 (double fy, double alphaPos, double alphaCap,
...
void
ModIMKPinching::envelNegCap2 (double fy, double alphaNeg, double alphaCap,
                              double cpDsp, double &d, double &f, double &ek,
