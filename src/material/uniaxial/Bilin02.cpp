...
void *OPS_Bilin02(void)
{
    ...
    if (numData != 23 && numData != 24) {       // Updated: Filipe Ribeiro and Andre Barbosa
        opserr <<
            "Invalid Args want: uniaxialMaterial Bilin02 tag? Ke? AsPos? AsNeg? My_pos? My_neg? LamdaS? ";
        opserr <<
    ...
    if (numData == 23) {
        ...
        theMaterial = new Bilin02(iData[0], dData[0], dData[1], dData[2], dData[3], dData[4], dData[5], dData[6], dData[7], dData[8], dData[9], dData[10], dData[11], dData[12], dData[13], dData[14], dData[15], dData[16], dData[17], dData[18], dData[19], dData[20], dData[21], dData[22]); // Updated: Filipe Ribeiro and Andre Barbosa
        ...
        // Parsing was successful, allocate the material
        theMaterial = new Bilin02(iData[0], dData[0], dData[1], dData[2], dData[3], dData[4], dData[5], dData[6], dData[7], dData[8], dData[9], dData[10], dData[11], dData[12], dData[13], dData[14], dData[15], dData[16], dData[17], dData[18], dData[19], dData[20], dData[21], dData[22], dData[23]);      // Updated: Filipe Ribeiro and Andre Barbosa

    }

    if (theMaterial == 0) {
        opserr <<
            "WARNING could not create uniaxialMaterial of type Bilin02 Material\n";
        return 0;
    }
...
Bilin02::Bilin02(int tag, double p_Ke0, double p_AsPos, double p_AsNeg, double p_My_pos, double p_My_neg, double p_LamdaS, double p_LamdaD, double p_LamdaA, double p_LamdaK, double p_Cs, double p_Cd, double p_Ca, double p_Ck, double p_Thetap_pos, double p_Thetap_neg, double p_Thetapc_pos, double p_Thetapc_neg, double p_KPos, double p_KNeg, double p_Thetau_pos, double p_Thetau_neg, double p_PDPlus, double p_PDNeg, double p_nFactor):UniaxialMaterial(tag, MAT_TAG_Bilin02), Ke0(p_Ke0), AsPos(p_AsPos), AsNeg(p_AsNeg), My_pos(p_My_pos), My_neg(p_My_neg), LamdaS(p_LamdaS), LamdaK(p_LamdaK), LamdaA(p_LamdaA), LamdaD(p_LamdaD), Cs(p_Cs), Ck(p_Ck), Ca(p_Ca), Cd(p_Cd), Thetap_pos(p_Thetap_pos), Thetap_neg(p_Thetap_neg), Thetapc_pos(p_Thetapc_pos), Thetapc_neg(p_Thetapc_neg), KPos(p_KPos), KNeg(p_KNeg), Thetau_pos(p_Thetau_pos), Thetau_neg(p_Thetau_neg), PDPlus(p_PDPlus), PDNeg(p_PDNeg), nFactor(p_nFactor)     // Updated: Filipe Ribeiro and Andre Barbosa
{
...
Bilin02::Bilin02(int tag, double p_Ke0, double p_AsPos, double p_AsNeg, double p_My_pos, double p_My_neg, double p_LamdaS, double p_LamdaD, double p_LamdaA, double p_LamdaK, double p_Cs, double p_Cd, double p_Ca, double p_Ck, double p_Thetap_pos, double p_Thetap_neg, double p_Thetapc_pos, double p_Thetapc_neg, double p_KPos, double p_KNeg, double p_Thetau_pos, double p_Thetau_neg, double p_PDPlus, double p_PDNeg):UniaxialMaterial(tag, MAT_TAG_Bilin02), Ke0(p_Ke0), AsPos(p_AsPos), AsNeg(p_AsNeg), My_pos(p_My_pos), My_neg(p_My_neg), LamdaS(p_LamdaS), LamdaK(p_LamdaK), LamdaA(p_LamdaA), LamdaD(p_LamdaD), Cs(p_Cs), Ck(p_Ck), Ca(p_Ca), Cd(p_Cd), Thetap_pos(p_Thetap_pos), Thetap_neg(p_Thetap_neg), Thetapc_pos(p_Thetapc_pos), Thetapc_neg(p_Thetapc_neg), KPos(p_KPos), KNeg(p_KNeg), Thetau_pos(p_Thetau_pos), Thetau_neg(p_Thetau_neg), PDPlus(p_PDPlus), PDNeg(p_PDNeg)   // Updated: Filipe Ribeiro and Andre Barbosa
{
    //initialize variables
    this->revertToStart();
    //this->revertToLastCommit();
...
Bilin02::Bilin02():UniaxialMaterial(0, MAT_TAG_Bilin02), Ke0(0), AsPos(0), AsNeg(0),
My_pos(0), My_neg(0), LamdaS(0), LamdaD(0), LamdaA(0), LamdaK(0), Cs(0),
Cd(0), Ca(0), Ck(0), Thetap_pos(0), Thetap_neg(0), Thetapc_pos(0),
Thetapc_neg(0), KPos(0), KNeg(0), Thetau_pos(0), Thetau_neg(0), PDPlus(0),
PDNeg(0), nFactor(0)
    // Updated: Filipe Ribeiro and Andre Barbosa
{
    this->revertToStart();
...
int
 Bilin02::setTrialStrain(double strain, double strainRate)
{
    ...
    double deltaD, d, temp_1, temp, betas, betak, betad,
        ...
        f, xDevPos1, yDevPos1, xDevPos2, yDevPos2, xDevPos, yDevPos,
        xDevNeg1, yDevNeg1, xDevNeg2, yDevNeg2, xDevNeg, yDevNeg;
    ...
    if (d > 0.0) {
        ...
        interPoint(temp_1, temp, 0.0, fCapRefPos, capSlope * Ke, 0.0,
                   KPos * My_pos, 0.0);
        if (d < temp_1) {
            iNoFpos = 0;
            LP = 0;
        ...
        interPoint(temp_1, temp, 0.0, fCapRefNeg, capSlopeNeg * Ke, 0.0,
                   KNeg * My_neg, 0.0);
    ...
    if (kon == 0) {
        ...
        fPeakPos =
            My_pos + ekhardPos * ((Thetap_pos + My_pos / Ke) -
                                  My_pos / Ke);
        fPeakNeg =
            My_neg + ekhardNeg * ((-Thetap_neg + My_neg / Ke) -
                                  (My_neg / Ke));
        ...
        fCapRefPos =
            -capSlope * Ke * (Thetap_pos + My_pos / Ke) + fPeakPos;
        fCapRefNeg =
            -capSlopeNeg * Ke * (-Thetap_neg + My_neg / Ke) + fPeakNeg;
    ...
    if (deltaD >= 0.0) {
        if (iNoFpos == 1) {
            interPoint(dNewLoadPos, fNewLoadPos, dyNeg, fyNeg, ekhardNeg,
                       0.0, 0.0, 0.0);
        }
        ...
        if (kon == 2) {
            ...
            if ((LamdaK != 0.0) && (d < sp)
                && fabs(capSlope * (1 + nFactor)) >= 1.0e-3 && (fabs(capSlopeNeg * (1 + nFactor)) >= 1.0e-3)) { // Updated: Filipe Ribeiro and Andre Barbosa
            ...
            if ((dmin < (My_neg / Ke)) || (dmax > (My_pos / Ke))) {
                if ((dP < sp) || (((dP > sp) && (ekP == ekunload)))) {
                    ...
                    if ((fabs(dmax - (My_pos / Ke)) >= 1.0e-10)
                        && (fabs(sn - (My_pos / Ke)) <= 1.0e-10)) {
                        sn = (My_pos / Ke) - 1.0e-9;
                    }
                }
            }
        ...
        if ((iNoFneg == 1) && (iNoFpos == 1) && (d < Thetau_pos)) {
            f = KPos * My_pos;
            ek = 1.0e-7;
        } else if (((iNoFneg == 1) && (iNoFpos == 1) && (d >= Thetau_pos))
                   || flagControlResponse == 1) {       //fmk
            f = 1.0e-10;
            ek = 1.0e-7;
            flagstopdeg = 1;
            ...
            f = 0.0;
            envelPosCap2(fyPos, alphaPos, capSlope, cpPos, d, f, ek, Ke,
                         My_pos, KPos);
            dmax = d;
            fmax = f;
            ...
            if (LP == 0) {
                ...
                if (cpPos <= dyPos) {
                    ...
                    interPoint(xDevPos1, yDevPos1, sn, resSn,
                               ekhardPos, cpPos, fCapPos, capSlope * Ke);
                    //                             call interPoint(xDevPos2,yDevPos2,sn,resSn,ekunload,cpPos,fCapPos,capSlope*Ke)
                    interPoint(xDevPos2, yDevPos2, sn, resSn,
                               ekunload, cpPos, fCapPos, capSlope * Ke);
                ...
                if (d <= sn) {
                    ek = ekunload;
                    f = fP + ek * deltaD;
                } else if (((d > sn) && (sn == snEnv) && (d <= snHor))
                           || ((iNoFneg == 1) && (d > sn) && (d < snHor))) {
                    ek = Ke * alphaPos;
                    f2 = resSn + ek * (d - sn);
                    f1 = fP + ekunload * deltaD;
                    //f = min(f1,f2);
            ...
            if (d > 0.0) {
                ...
                f = 0.0;
                envelPosCap2(fyPos, alphaPos, capSlope, cpPos, d, f,
                             ek, Ke, My_pos, KPos);
            } else {

                f = 0.0;
                envelNegCap2(fyNeg, alphaNeg, capSlopeNeg, cpNeg, d, f,
                             ek, Ke, My_neg, KNeg);
            }
        }
        ...
        if (iNoFneg == 1) {
            interPoint(dNewLoadNeg, fNewLoadNeg, dyPos, fyPos, ekhardPos,
                       0.0, 0.0, 0.0);
        }
        ...
        if (kon == 1) {
            ...
            if ((LamdaK != 0.0) && (d > sn) && (flagstopdeg != 1)
                && (flagdeg != 1)) {
            ...
            if ((dmin < (My_neg / Ke)) || (dmax > (My_pos / Ke))) {
                if ((dP > sn) || (((dP < sn) && (ekP == ekunload)))) {
                    ...
                    spCalc();
                    if ((fabs(dmin - (My_neg / Ke)) >= 1.0e-10)
                        && (fabs(sp - (My_neg / Ke)) <= 1.0e-10)) {
                        sp = (My_neg / Ke) - 1.0e-9;
                    }
                }
            }
        ...
        if ((iNoFneg == 1) && (iNoFpos == 1) && (d > (-Thetau_neg))) {
            ...
            f = 0.0;
            envelNegCap2(fyNeg, alphaNeg, capSlopeNeg, cpNeg, d, f, ek,
                         Ke, My_neg, KNeg);
            dmin = d;
            fmin = f;
            ...
            if (LN == 0) {
                ...
                if (cpNeg >= dyNeg) {
                    ...
                    interPoint(xDevNeg1, yDevNeg1, sp, resSp,
                               Ke * alphaNeg, cpNeg, fCapNeg,
                               capSlopeNeg * Ke);
                    // call interPoint(xDevNeg2,yDevNeg2,sp,resSp,ekunload,cpNeg,fCapNeg,capSlope*Ke)
                    interPoint(xDevNeg2, yDevNeg2, sp, resSp,
                               ekunload, cpNeg, fCapNeg, capSlopeNeg * Ke);
                ...
                if (d >= sp) {
                    ek = ekunload;
                    f = fP + ek * deltaD;
                } else if (((d < sp) && (sp == spEnv) && (d > spHor))
                           || ((iNoFpos == 1) && (d < sp) && (d > spHor))) {
                    ek = Ke * alphaNeg;
                    f2 = resSp + ek * (d - sp);
                    f1 = fP + ekunload * deltaD;
                    //f = max(f1,f2);
    ...
    if ((flagstopdeg == 0) && (flagdeg == 1)) {
        ...
        if (deltaD < 0.0) {
            ...
            if (flagstopdeg == 0) {
                ...
                alphaNeg =
                    alphaNeg * (1 + nFactor) / (1 + nFactor * alphaNeg);
            ...
            envelNegCap2(fyNeg, alphaNeg, capSlopeNeg, cpNeg, dLimNeg,
                         fLimNeg, ek, Ke, My_neg, KNeg);
            spCalc();
            ...
            if (flagstopdeg == 0) {
                ...
                //1st - recover the strain hardening ratio of the member        
                alphaPos =
                    alphaPos * (1 + nFactor) / (1 + nFactor * alphaPos);
                //2nd - apply the redution to the ratio of the member          
            ...
            envelPosCap2(fyPos, alphaPos, capSlope, cpPos, dLimPos,
                         fLimPos, ek, Ke, My_pos, KPos);
    ...
    if ((interup == 1 && (ek == Ke * alphaPos)) || (ek == Ke * alphaNeg)
        || (ek == capSlope * Ke) || (ek == capSlopeNeg * Ke)) { //fmk
        interup = 0;
    }
...
double Bilin02::getStress(void)
{
    return (fP);
}

double Bilin02::getTangent(void)
{
    //opserr << "Bilin02::getTangent " << Tangent << endln;

    return (Tangent);
}

double Bilin02::getInitialTangent(void)
{
    return (Ke);
}
...
int Bilin02::revertToLastCommit(void)
{
...
int Bilin02::revertToStart(void)
{
...
UniaxialMaterial *Bilin02::getCopy(void)
{
    Bilin02 *theCopy =
        new Bilin02(this->getTag(), Ke0, AsPos, AsNeg, My_pos, My_neg,
                    LamdaS, LamdaD,
                    LamdaA, LamdaK, Cs, Cd, Ca, Ck, Thetap_pos, Thetap_neg,
                    Thetapc_pos, Thetapc_neg, KPos, KNeg,
    ...
    theCopy->prodBeta = prodBeta;

    return theCopy;
}

int Bilin02::sendSelf(int cTag, Channel & theChannel)
{
    int res = 0;
    ...
    if (res < 0)
        opserr << "Bilin02::sendSelf() - failed to send data\n";

    return res;
}

int Bilin02::recvSelf(int cTag, Channel & theChannel,
                      FEM_ObjectBroker & theBroker)
{
    ...
    if (res < 0) {
        opserr << "Bilin02::recvSelf() - failed to receive data\n";
        this->setTag(0);
    } else {
...
void Bilin02::Print(OPS_Stream & s, int flag)
{
...
//my functions
void Bilin02::interPoint(double &xInt, double &yInt, double x1, double y1,
                         double m1, double x2, double y2, double m2)
{
    xInt = (-m2 * x2 + y2 + m1 * x1 - y1) / (m1 - m2);
    yInt = m1 * xInt - m1 * x1 + y1;
}

void Bilin02::snCalc(void)
{
...
// c                              capStiff,fCapRefPos
    ...
    if (dyPos < cpPos) {
        ...
        interPoint(snHard, resSnHard, dyPos, fyPos, Ke * alphaPos, dP, fP,
                   ekunload);
    } else {

        interPoint(snHard, resSnHard, cpPos, fCapPos, Ke * alphaPos, dP,
                   fP, ekunload);
    }

    double snCap, resSnCap;
    interPoint(snCap, resSnCap, 0.0, fCapRefPos, capSlope * Ke, dP, fP,
               ekunload);
    ...
    if ((LP == 1) && (fLimPos == 0.0)) {
        ...
        interPoint(snLim, resSnLim, dLimPos, fLimPos, 0.0, dP, fP,
                   ekunload);
        if (snLim < sn) {
            sn = snLim;
            resSn = resSnLim;
        ...
        interPoint(snHor, resSnHor, dLimPos, fLimPos, 0.0, dyPos, fyPos,
                   Ke * alphaPos);
    }

    if (sn > dresid) {
//              call interPoint(snResid,resSnResid,dresid,Resid,ekresid,dP,fP,ekunload)
        interPoint(snResid, resSnResid, dresid, Resid, ekresid, dP, fP,
                   ekunload);
        sn = snResid;
        resSn = resSnResid;
    }
...
void Bilin02::envelPosCap2(double fy, double alphaPos, double alphaCap,
                           double cpDsp, double &d, double &f, double &ek,
                           double elstk, double fyieldPos, double Resfac)
{
...
//      call interPoint(d1,f1,E
    double d1, f1;
    interPoint(d1, f1, dyNeg, fyNeg, Ke * alphaNeg, 0.0, fCapRefPos,
               capSlope * Ke);

    double d2, f2;
    interPoint(d2, f2, dyNeg, fyNeg, Ke * alphaNeg, dresid, Resid,
               ekresid);
    //dBoundPos = max(d1,d2);
    if (d1 > d2) {
        dBoundPos = d1;
...
void Bilin02::envHitsZero(double &f)
{
    if (fP > 0) {
        if ((f * fP) < 0) {
            f = 0;
...
void Bilin02::envelNegCap2(double fy, double alphaNeg, double alphaCap,
                           double cpDsp, double &d, double &f, double &ek,
...
//              call interPoint(spLim,resSpLim,dLimNeg,fLimNeg,0.d0,dP,fP,ekunload)
        interPoint(spLim, resSpLim, dLimNeg, fLimNeg, 0.0, dP, fP,
                   ekunload);
        if (spLim > sp) {
            sp = spLim;
            resSp = resSpLim;
...
//              call interPoint(spHor,resSpHor,dLimNeg,fLimNeg,0.d0,dyNeg,fyNeg,Ke*alphaNeg)
        interPoint(spHor, resSpHor, dLimNeg, fLimNeg, 0.0, dyNeg, fyNeg,
                   Ke * alphaNeg);
    }

    if (sp < dresid) {
//              call interPoint(spResid,resSpResid,dresid,Resid,ekresid,dP,fP,ekunload)
        interPoint(spResid, resSpResid, dresid, Resid, ekresid, dP, fP,
                   ekunload);
        sp = spResid;
        resSp = resSpResid;
    }
...
double Bilin02::boundNeg(void)
{
    ...
    interPoint(d1, f1, dyPos, fyPos, Ke * alphaPos, 0.0, fCapRefNeg,
               capSlopeNeg * Ke);
    //%
    //      call interPoint(d2,f2,dyPos,fyPos,Ke*alphaPos,dresid,resid,ekresid)
    interPoint(d2, f2, dyPos, fyPos, Ke * alphaPos, dresid, Resid,
               ekresid);
    //dBoundNeg = min(d1,d2);
    if (d1 < d2) {
        dBoundNeg = d1;
