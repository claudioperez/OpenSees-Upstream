                                                                      ...
                                                                      0)
{
    ...
    if (ecaps < 0.0 || ecapk < 0.0 || ecapa < 0.0 || ecapd < 0.0)
        opserr <<
            "Error: CloughHenry::CloughHenry  : All gamma values must be >= 0\n"
            << "\a";

    if (cs < 0.0 || ck < 0.0 || ca < 0.0 || cd < 0.0)
        opserr <<
            "Error: CloughHenry::CloughHenry  : All 'c' values must be >= 0\n"
            << "\a";
    ...
    if (Resfac < 0.0 || Resfac > 1.0)
        opserr <<
            "Error: CloughHenry::CloughHenry  : Residual must be > 0 and <= 1\n"
            << "\a";

    if (alpha > 0.8 || alpha < -0.8)
        opserr <<
            "Error: CloughHenry::CloughHenry  : alpha must be < 0.8 and > -0.8\n"
            << "\a";

    if (alpha == capSlope)
        opserr <<
            "Error: CloughHenry::CloughHenry  : Error: alpha Hard. can not be equal to alphaCap\n"
            << "\a";
