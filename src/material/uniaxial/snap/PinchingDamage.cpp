...
int PinchingDamage::setTrialStrain(double d, double strainRate)
{
    ...
    double deltaD;
    double ekP, ekunload, ekexcurs, Enrgtot, Enrgc, sp, sn, dmax, dmin,
        fyPos, fyNeg, fP, dP;
...
void PinchingDamage::envelPosCap(double fy, double alphaPos,
...
void PinchingDamage::envelNegCap(double fy, double alphaNeg,
                                 double alphaCap, double cpDsp, double d,
                                 double *f, double *ek)
{
    double dy, Res, rcap, dres;
