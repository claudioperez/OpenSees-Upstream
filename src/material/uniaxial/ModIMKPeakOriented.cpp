...
OPS_ModIMKPeakOriented ()
{
    ...
    if (OPS_GetIntInput (&numData, iData) != 0)
      {
          opserr << "WARNING invalid uniaxialMaterial  ModIMKPeakOriented tag"
              << endln;
          return 0;
      }
...
UniaxialMaterial (tag, MAT_TAG_ModIMKPeakOriented),
Ke0 (Ke0),
AlfanPos (alfanPos),
AlfanNeg (alfanNeg),
My_pos (my_pos),
...
FracDispNeg (fracDispNeg),
DPos (dPos),
DNeg (dNeg)                     // Updated: Filipe Ribeiro and Andre Barbosa
{
    // Initialize Variables by Calling revertToStart function
    this->revertToStart ();
...
ModIMKPeakOriented::ModIMKPeakOriented ():UniaxialMaterial (0, MAT_TAG_ModIMKPeakOriented), Ke0 (0.0), AlfanPos (0.0), AlfanNeg (0.0), My_pos (0.0), My_neg (0.0), Ls (0.0), Ld (0.0), La (0.0), Lk (0.0),
                                                                                                                                                                        // Updated: Filipe Ribeiro and Andre Barbosa
...
void
ModIMKPeakOriented::envelPosCap2 (double fy, double alphaPos, double alphaCap,
...
void
ModIMKPeakOriented::envelNegCap2 (double fy, double alphaNeg, double alphaCap,
                                  double cpDsp, double &d, double &f,
