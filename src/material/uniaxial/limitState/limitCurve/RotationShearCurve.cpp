...
RotationShearCurve::RotationShearCurve (int crvTag, int eTag,
                                        int ni, int nj, int axis, double Vnom,
                                        double Vres, double Kd, double rLim,
                                        int dfTyp, double B, double D,
                                        double H, double Lgth, double S,
                                        double AreaS, double AreaCC,
                                        double Ldev, double DiaBar,
                                        double rhoTrans, double Fc, double Fy,
                                        double Fytrans, double Delta,
                                        Domain * theDom, Element * theEle,
                                        Node * theNdI, Node * theNdJ):
LimitCurve (crvTag, LIMCRV_TAG_RotShearCurve),
eleTag (eTag),
ndI (ni),
ndJ (nj),
rotAxis (axis),
...
int
RotationShearCurve::revertToStart (void)
{
    forceVec = 0;
    thetaMin = 0.0;
    P = 0.0;
