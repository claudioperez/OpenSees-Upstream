...
curveType (crvTyp),
curveTag (crvTag),
YpinchUnloadPN (YpinchUPN),
YpinchReloadPN (YpinchRPN),
XpinchReloadPN (XpinchRPN),
YpinchUnloadNP (YpinchUNP),
YpinchReloadNP (YpinchRNP),
XpinchReloadNP (XpinchRNP),
dmgStressLimE (dmgStrsLimE),
dmgDeflMax (dmgDispMax),
dmgElastic1 (dmgE1),
dmgElastic2 (dmgE2),
dmgElastic3 (dmgE3),
dmgElastic4 (dmgE4),
dmgElasticLim (dmgELim),
dmgUnload1 (dmgU1),
dmgUnload2 (dmgU2),
dmgUnload3 (dmgU3),
dmgUnload4 (dmgU4),
dmgUnloadLim (dmgULim),
dmgReload1 (dmgR1),
dmgReload2 (dmgR2),
dmgReload3 (dmgR3),
dmgReload4 (dmgR4),
dmgReloadLim (dmgRLim),
dmgReloadCyclic (dmgRCyc),
dmgStrength1 (dmgS1),
dmgStrength2 (dmgS2),
dmgStrength3 (dmgS3),
dmgStrength4 (dmgS4),
dmgStrengthLim (dmgSLim),
dmgStrengthCyclic (dmgSCyc),
eleTag (eTag),
b (B),
d (D),
h (H),
...
UniaxialMaterial *
PinchingLimitStateMaterial::getCopy (void)
{
    PinchingLimitStateMaterial *theCopy =
        new PinchingLimitStateMaterial (this->getTag (),
                                        ...
                                        dmgElastic1, dmgElastic2, dmgElastic3,
...
PinchingLimitStateMaterial::updateDamageE (void)
{
    ...
    double Delastic =
        dmgElastic1 * pow (DispRatio,
                           dmgElastic3) + dmgElastic2 * pow (EnergyRatio,
                                                             dmgElastic4);
...
PinchingLimitStateMaterial::updateDamageS (void)
{
    ...
    double Dstrength =
        dmgStrength1 * pow (DispRatio,
                            dmgStrength3) + dmgStrength2 * pow (EnergyRatio,
                                                                dmgStrength4);
...
PinchingLimitStateMaterial::updateDamageR (void)
{
    ...
    double EnergyRatio = Tenergy / InelastMonoEnergy;
    double Dreload =
        dmgReload1 * pow (DispRatio,
                          dmgReload3) + dmgReload2 * pow (EnergyRatio,
                                                          dmgReload4);
...
PinchingLimitStateMaterial::getStateFlag (void)
{
    if ((CstateFlag == 1 || CstateFlag == 2) && Tdu > 0.0
        ...
        return -7;
    else if (CstateFlag == -7 && Tdu < 0.0 && Tstrain > TpinchStrainUnloadNP
             && Tstrain <= TpinchStrainReloadNP)
        return -8;
...
PinchingLimitStateMaterial::defineTargetVars (void)
{
    ...
    double dmgSCyc =
        0.037133 + 0.251204 * (fy * As / (fc * Ag)) - 0.354989 * (Acc / Ag) +
        0.056569 * (a / d);
