...
void *OPS_DuctilityStrengthDegradation(void)
{
    ...
    if (theDegradation == 0) {
        opserr <<
            "WARNING could not create DuctilityStrengthDegradation\n";
        return 0;
    }
...
DuctilityStrengthDegradation::DuctilityStrengthDegradation
    (int tag, double a, double b):StrengthDegradation(tag,
                                                      DEG_TAG_STRENGTH_Ductility),
...
const char *DuctilityStrengthDegradation::getMeasure(void)
{
    if (!isNegative)
        return "negDuctility";
    else
...
int DuctilityStrengthDegradation::setTrialMeasure(double measure)
{
    Tductility = measure;
...
double DuctilityStrengthDegradation::getValue(void)
{
    if (Tductility < Cductility) {
        Tductility = Cductility;
        return 1.0;
...
void DuctilityStrengthDegradation::setNegative(bool flag)
{
    isNegative = flag;
}

int DuctilityStrengthDegradation::commitState(void)
{
...
int DuctilityStrengthDegradation::revertToLastCommit(void)
{
    Tductility = Cductility;
...
int DuctilityStrengthDegradation::revertToStart(void)
{
    Cductility = 0.0;
...
StrengthDegradation *DuctilityStrengthDegradation::getCopy(void)
{
...
int DuctilityStrengthDegradation::sendSelf(int commitTag,
                                           Channel & theChannel)
{
...
int DuctilityStrengthDegradation::recvSelf(int commitTag,
                                           Channel & theChannel,
...
void DuctilityStrengthDegradation::Print(OPS_Stream & s, int flag)
{
