...
MultiplierMaterial::MultiplierMaterial (int tag, UniaxialMaterial & material,
                                        double mult):
UniaxialMaterial (tag, MAT_TAG_Multiplier),
theMaterial (0),
multiplier (mult),
parameterID (0)
{
...
int
MultiplierMaterial::setTrialStrain (double strain, double temp,
                                    double strainRate)
{
...
int
MultiplierMaterial::setParameter (const char **argv, int argc,
                                  Parameter & param)
{
...
int
MultiplierMaterial::commitSensitivity (double strainGradient, int gradIndex,
                                       int numGrads)
{
