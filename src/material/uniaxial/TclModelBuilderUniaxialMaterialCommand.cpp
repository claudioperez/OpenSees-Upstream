...
extern UniaxialMaterial *Tcl_addWrapperUniaxialMaterial (matObj *,
                                                         ClientData
                                                         clientData,
                                                         Tcl_Interp * interp,
                                                         int argc,
...
int
TclCommand_KikuchiAikenHDR (ClientData clientData, Tcl_Interp * interp,
                            int argc, TCL_Char ** argv);

int
TclCommand_KikuchiAikenLRB (ClientData clientData, Tcl_Interp * interp,
                            int argc, TCL_Char ** argv);
...
UniaxialMaterial *TclModelBuilder_addFedeasMaterial (ClientData clientData,
                                                     Tcl_Interp * interp,
                                                     int argc,
                                                     TCL_Char ** argv);


UniaxialMaterial *TclModelBuilder_addDrainMaterial (ClientData clientData,
                                                    Tcl_Interp * interp,
                                                    int argc,
                                                    TCL_Char ** argv);


UniaxialMaterial *TclModelBuilder_addSnapMaterial (ClientData clientData,
                                                   Tcl_Interp * interp,
                                                   int argc,
                                                   TCL_Char ** argv);


UniaxialMaterial *TclModelBuilder_addPyTzQzMaterial (ClientData clientData,
                                                     Tcl_Interp * interp,
                                                     int argc,
                                                     TCL_Char ** argv,
                                                     Domain * theDomain);

UniaxialMaterial *TclModelBuilder_FRPCnfinedConcrete (ClientData clientData,
                                                      Tcl_Interp * interp,
                                                      int argc,
                                                      TCL_Char ** argv,
                                                      Domain * theDomain);
...
int
TclModelBuilderUniaxialMaterialCommand (ClientData clientData,
                                        ...
                                        TCL_Char ** argv, Domain * theDomain)
{
    ...
    if (argc < 3)
      {
          opserr <<
              "WARNING insufficient number of uniaxial material arguments\n";
          opserr <<
     ...
     */
    ...
    else if (strcmp (argv[1], "SteelMPF") == 0)
      {                         // K Kolozvari            
    ...
    else if (strcmp (argv[1], "ConcreteCM") == 0)
      {                         // K Kolozvari          
    ...
    else if (strcmp (argv[1], "BoucWen") == 0)
      {
          if (argc < 12)
            {
                ...
                printCommand (argc, argv);
                opserr <<
                    "Want: uniaxialMaterial BoucWen tag? alpha? ko? n? gamma?"
                    << endln << " beta? Ao? deltaA? deltaNu? deltaEta?" <<
                    endln;
                return TCL_ERROR;
            }
          ...
          if (Tcl_GetInt (interp, argv[2], &tag) != TCL_OK)
            {
                opserr << "WARNING invalid uniaxialMaterial BoucWen tag" <<
                    endln;
                return TCL_ERROR;
            }
                ...
                if (Tcl_GetDouble (interp, argv[12], &tolerance) != TCL_OK)
                  {
                      ...
                      opserr << "uniaxialMaterial BoucWen: " << tolerance <<
                          endln;
                      return TCL_ERROR;
                  }
            }
                ...
                if (Tcl_GetInt (interp, argv[13], &maxNumIter) != TCL_OK)
                  {
                      ...
                      opserr << "uniaxialMaterial BoucWen: " << maxNumIter <<
                          endln;
                      return TCL_ERROR;
                  }
            }
          ...
          if (argc < 9)
            {
                ...
                printCommand (argc, argv);
                opserr <<
                    "Want: uniaxialMaterial Steel03 tag? fy? E0? b? r? cR1 cR2?";
          ...
          if (argc > 9)
            {
                if (argc < 13)
                  {
                      opserr <<
                          "WARNING insufficient number of hardening parameters\n";
                      opserr << "uniaxialMaterial Steel03: " << tag << endln;
                      return TCL_ERROR;
                  }
                ...
                // Parsing was successful, allocate the material
                theMaterial =
                    new Steel03 (tag, fy, E, b, r, cR1, cR2, a1, a2, a3, a4);
            }
          else
              // Parsing was successful, allocate the material
          ...
          if (argc != 10 && argc != 9 && argc != 7)
            {
                ...
                printCommand (argc, argv);
                opserr <<
                    "Want: uniaxialMaterial Concrete04 tag? fpc? epsc0? epscu? Ec0? <ft? etu? <beta?> >"
                    << endln;
                return TCL_ERROR;
            }
    ...
    else if (strcmp (argv[1], "Concrete06") == 0)
      {
          if (argc < 12)
            {
                ...
                printCommand (argc, argv);
                opserr <<
                    "Want: uniaxialMaterial Concrete06 tag? fc? eo? r? k? alphaC? fcr? ecr? b? alphaT?"
                    << endln;
                return TCL_ERROR;
            }
          ...
          if (Tcl_GetInt (interp, argv[2], &tag) != TCL_OK)
            {
                opserr << "WARNING invalid uniaxialMaterial Concrete06 tag" <<
                    endln;
                return TCL_ERROR;
            }
          ...
          if (argc < 11)
            {
                ...
                printCommand (argc, argv);
                opserr <<
                    "Want: uniaxialMaterial Concrete07 tag? fpc? epsc0? Ec? fpt? epst0? xcrp? xcrn? r?\n";
                return TCL_ERROR;
            }
          ...
          if (argc < 4)
            {
                ...
                printCommand (argc, argv);
                opserr <<
                    "Want: uniaxialMaterial PathIndependent tag? matTag?" <<
                    endln;
                return TCL_ERROR;
            }
          ...
          if (material == 0)
            {
                ...
                opserr << "\nuniaxialMaterial PathIndependent: " << tag <<
                    endln;
                return TCL_ERROR;
            }
    ...
    else if (strcmp (argv[1], "Fatigue") == 0)
      {
          ...
          if (Tcl_GetInt (interp, argv[2], &tag) != TCL_OK)
            {
                opserr << "WARNING invalid uniaxialMaterial Fatigue tag" <<
                    endln;
                return TCL_ERROR;
            }
          ...
          for (int j = 4; j < argc; j++)
            {
                if (strcmp (argv[j], "-Dmax") == 0)
                  {
                      if ((j + 1 >= argc) ||
                          (Tcl_GetDouble (interp, argv[j + 1], &Dmax) !=
                           TCL_OK))
                        {
                  ...
                  {
                      if ((j + 1 >= argc) ||
                          (Tcl_GetDouble (interp, argv[j + 1], &E0) !=
                           TCL_OK))
                        {
                            opserr << "WARNING invalid -E0";
                            opserr << "uniaxialMaterial Fatigue: " << tag <<
                  ...
                  {
                      if ((j + 1 >= argc) ||
                          (Tcl_GetDouble (interp, argv[j + 1], &epsmin) !=
                           TCL_OK))
                        {
                  ...
                  {
                      if ((j + 1 >= argc) ||
                          (Tcl_GetDouble (interp, argv[j + 1], &epsmax) !=
                           TCL_OK))
                        {
    ...
    else if (strcmp (argv[1], "Pinching4") == 0)
      {
          if (argc != 42 && argc != 31)
            {
                ...
                printCommand (argc, argv);
                opserr <<
                    "Want: uniaxialMaterial Pinching4 tag? stress1p? strain1p? stress2p? strain2p? stress3p? strain3p? stress4p? strain4p? "
                    <<
          ...
          if (Tcl_GetInt (interp, argv[i++], &tag) != TCL_OK)
            {
                opserr << "WARNING invalid uniaxialMaterial Pinching4 tag" <<
                    endln;
                return TCL_ERROR;
            }
          ...
          if ((strcmp (argv[y], "cycle") == 0)
              || (strcmp (argv[y], "Cycle") == 0)
            ...
            {
                opserr <<
                    "WARNING invalid type of damage calculation specified\n";
                opserr << "Pinching4 material: " << tag << endln;
                return TCL_ERROR;
            }
    ...
    else if (strcmp (argv[1], "BarSlip") == 0)
      {
          if (argc != 17 && argc != 15)
            {
                ...
                printCommand (argc, argv);
                opserr <<
                    "Want: uniaxialMaterial BarSlip tag? fc? fy? Es? fu? Eh? db? ld? nb? width? depth? bsflag? type? <damage? unit?>"
                    << endln;
                return TCL_ERROR;
            }
          ...
          if (argc == 15)
            {
                theMaterial =
                    new BarSlipMaterial (tag, fc, fy, Es, fu, Eh, db, ld, nb,
                                         width, depth, bsf, typ);
            }
          ...
          if (argc != 42 && argc != 31)
            {
                ...
                printCommand (argc, argv);
                opserr <<
                    "Want: uniaxialMaterial ShearPanel tag? stress1p? strain1p? stress2p? strain2p? stress3p? strain3p? stress4p? strain4p? "
                    <<
                    "\n<stress1n? strain1n? stress2n? strain2n? stress3n? strain3n? stress4n? strain4n?> rDispP? rForceP? uForceP? "
                    <<
                    "\n<rDispN? rForceN? uForceN?> gammaK1? gammaK2? gammaK3? gammaK4? gammaKLimit? gammaD1? gammaD2? gammaD3? gammaD4? "
    ...
    else if (strcmp (argv[1], "Concrete01WithSITC") == 0)
      {
          if (argc < 7)
            {
                ...
                printCommand (argc, argv);
                opserr <<
                    "Want: uniaxialMaterial Concrete01 tag? fpc? epsc0? fpcu? epscu? <endStrainSITC?>"
                    << endln;
                return TCL_ERROR;
            }
          ...
          if (Tcl_GetInt (interp, argv[2], &tag) != TCL_OK)
            {
                opserr << "WARNING invalid uniaxialMaterial Concrete01 tag" <<
                    endln;
                return TCL_ERROR;
            }
          ...
          if (argc == 7)
              // Parsing was successful, allocate the material
              theMaterial =
                  new Concrete01WithSITC (tag, fpc, epsc0, fpcu, epscu);
          else
            {
     ...
     */
    ...
    else if (strcmp (argv[1], "ECC01") == 0)
      {
          if (argc < 16)
            {
                ...
                printCommand (argc, argv);
                opserr <<
                    "Want: uniaxialMaterial ECC01 TAG? SIGT0? EPST0? SIGT1? EPST1? EPST2? SIGC0? EPSC0? EPSC1? ";
                opserr << "ALPHAT1? ALPHAT2? ALPHAC? ALPHACU? BETAT? BETAC\n";
                return TCL_ERROR;
            }

          int tag;
          double SIGT0, EPST0, SIGT1, EPST1, EPST2, SIGC0, EPSC0, EPSC1,
              ALPHAT1, ALPHAT2, ALPHAC, ALPHACU, BETAT, BETAC;


          if (Tcl_GetInt (interp, argv[2], &tag) != TCL_OK)
            {
                opserr << "WARNING invalid uniaxialMaterial ECC01 tag" <<
                    endln;
                return TCL_ERROR;
            }
          ...
          theMaterial =
              new ECC01 (tag, SIGT0, EPST0, SIGT1, EPST1, EPST2, SIGC0, EPSC0,
                         EPSC1, ALPHAT1, ALPHAT2, ALPHAC, ALPHACU, BETAT,
                         BETAC);
      }
    ...
    else if (strcmp (argv[1], "SelfCentering") == 0)
      {
          if (argc < 7)
            {
                ...
                printCommand (argc, argv);
                opserr <<
                    "Want: uniaxialMaterial SelfCentering tag? k1? k2? ActF? beta? <SlipDef? BearDef? rBear?>"
                    << endln;
                return TCL_ERROR;
            }
          ...
          if (Tcl_GetInt (interp, argv[2], &tag) != TCL_OK)
            {
                opserr << "WARNING invalid uniaxialMaterial SelfCentering tag"
                    << endln;
                return TCL_ERROR;
            }
          ...
          if (argc == 8)
                ...
                if (Tcl_GetDouble (interp, argv[7], &SlipDef) != TCL_OK)
                  {
                      ...
                      opserr << "uniaxialMaterial SelfCentering: " << tag <<
                          endln;
                      return TCL_ERROR;
                  }
                // Parsing was successful, allocate the material
                theMaterial =
                    new SelfCenteringMaterial (tag, k1, k2, ActF, beta,
                                               SlipDef, 0, 0);
            }
          ...
          else
            {
                // Parsing was successful, allocate the material
                theMaterial =
                    new SelfCenteringMaterial (tag, k1, k2, ActF, beta, 0, 0,
                                               0);
            }
      }
    ...
    else if (strcmp (argv[1], "SteelMP") == 0)
      {
          ...
          theMaterial =
              new SteelMP (tag, fy, E, b, r, coeffR1, coeffR2, a1, a2);
      }
    ...
    else if (strcmp (argv[1], "SmoothPSConcrete") == 0)
      {
          ...
          if (Tcl_GetDouble (interp, argv[3], &fc) != TCL_OK)
            {
                opserr << "WARNING invalid fc\n";
                opserr << "uniaxiaMaterial SmoothPSConcrete: " << tag <<
                    endln;
                return TCL_ERROR;
            }
              ...
              if (Tcl_GetDouble (interp, argv[6], &eps0) != TCL_OK)
                {
                    ...
                    opserr << "uniaxialMaterial SmoothPSConcrete: " << tag <<
                        endln;
                    return TCL_ERROR;
                }
          ...
          // Parsing was successful, allocate the material
          theMaterial =
              new SmoothPSConcrete (tag, fc, fu, Ec, eps0, epsu, eta);
      }
    ...
    // ----- 1D J2 Plasticity ----
    else if (strcmp (argv[1], "UniaxialJ2Plasticity") == 0)
      {
          ...
          if (Tcl_GetDouble (interp, argv[3], &E) != TCL_OK)
            {
                opserr << "WARNING invalid E\n";
                opserr << "uniaxiaMaterial UniaxialJ2Plasticity: " << tag <<
                    endln;
                return TCL_ERROR;
            }
              ...
              if (Tcl_GetDouble (interp, argv[6], &Hiso) != TCL_OK)
                {
                    ...
                    opserr << "uniaxialMaterial UniaxialJ2Plasticity: " << tag
                        << endln;
                    return TCL_ERROR;
                }
    ...
    else if (strcmp (argv[1], "HystereticPoly") == 0)
    ...
    else
      {
          // Fedeas
          theMaterial =
              TclModelBuilder_addFedeasMaterial (clientData, interp, argc,
                                                 argv);

          // Drain
          if (theMaterial == 0)
              theMaterial =
                  TclModelBuilder_addDrainMaterial (clientData, interp, argc,
                                                    argv);

          // SNAP
          if (theMaterial == 0)
              theMaterial =
                  TclModelBuilder_addSnapMaterial (clientData, interp, argc,
                                                   argv);

          // Py, Tz, Qz models
          if (theMaterial == 0)
              theMaterial =
                  TclModelBuilder_addPyTzQzMaterial (clientData, interp, argc,
                                                     argv, theDomain);

          // LimitState
          if (theMaterial == 0)
              theMaterial =
                  Tcl_AddLimitStateMaterial (clientData, interp, argc, argv);
      }
          ...
          while (matCommands != NULL && found == false)
            {
                if (strcmp (argv[1], matCommands->funcName) == 0)
                  {
                      theMaterial =
                          (UniaxialMaterial *) (*(matCommands->funcPtr)) ();
                      found = true;;
                  }
                else
          ...
          if (matObject != 0)
            {
                ...
                theMaterial =
                    Tcl_addWrapperUniaxialMaterial (matObject, clientData,
                                                    interp, argc, argv);
    ...
    if (theMaterial == 0)
      {
          ...
          int res =
              getLibraryFunction (argv[1], tclFuncName, &libHandle,
                                  (void **) &funcPtr);
          ...
          if (res == 0)
            {
                ...
                UniaxialPackageCommand *theMatCommand =
                    new UniaxialPackageCommand;
    ...
    if (theMaterial == 0)
      {
          opserr << "WARNING could not create uniaxialMaterial " << argv[1] <<
              endln;
          return TCL_ERROR;
      }
          ...
          for (int i = 6; i <= (argc - 1); i++)
            {
                ...
                if (strcmp (argv[i], "-coGHU") == 0 && (i + 3) <= (argc - 1))
                  {             // <-coGHU cg? ch? cu?>

                      if (Tcl_GetDouble (interp, argv[i + 1], &cg) != TCL_OK
                          || cg < 0.0)
                        {
                      ...
                      if (Tcl_GetDouble (interp, argv[i + 2], &ch) != TCL_OK
                          || ch < 0.0)
                        {
                      ...
                      if (Tcl_GetDouble (interp, argv[i + 3], &cu) != TCL_OK
                          || cu < 0.0)
                        {
                  ...
                  {             // <-coMSS rs? rf?>
                      ...
                      if (Tcl_GetDouble (interp, argv[i + 1], &rs) != TCL_OK
                          || rs < 0.0)
                        {
                      ...
                      if (Tcl_GetDouble (interp, argv[i + 2], &rf) != TCL_OK
                          || rf < 0.0)
                        {
    ...
    if (!ifNoError)
      {
          ...
          //want:
          opserr <<
              "Want: uniaxialMaterial KikuchiAikenHDR matTag? tp? ar? hr? <-coGHU cg? ch? cu?> <-coMSS rs? rf?>"
              << endln;
          return TCL_ERROR;
      }
          ...
          for (int i = 11; i <= (argc - 1); i++)
            {
                ...
                if (strcmp (argv[i], "-T") == 0 && (i + 1) <= (argc - 1))
                  {             // <-T temp?>

                      if (Tcl_GetDouble (interp, argv[i + 1], &temp) !=
                          TCL_OK)
                        {
                            opserr << "WARNING KikuchiAikenLRB invalid temp"
                                << endln;
                            ifNoError = false;
                        }
                  ...
                  {             // <-coKQ rk? rq?>
                      ...
                      if (Tcl_GetDouble (interp, argv[i + 1], &rk) != TCL_OK
                          || rk < 0.0)
                        {
                            opserr << "WARNING KikuchiAikenLRB invalid rk" <<
                                endln;
                            ifNoError = false;
                        }

                      if (Tcl_GetDouble (interp, argv[i + 2], &rq) != TCL_OK
                          || rq < 0.0)
                        {
                            opserr << "WARNING KikuchiAikenLRB invalid rq" <<
                                endln;
                            ifNoError = false;
                        }
                  ...
                  {             // <-coMSS rs? rf?>
                      ...
                      if (Tcl_GetDouble (interp, argv[i + 1], &rs) != TCL_OK
                          || rs < 0.0)
                        {
                            opserr << "WARNING KikuchiAikenLRB invalid rs" <<
                                endln;
                            ifNoError = false;
                        }
                      ...
                      if (Tcl_GetDouble (interp, argv[i + 2], &rf) != TCL_OK
                          || rf < 0.0)
                        {
                            opserr << "WARNING KikuchiAikenLRB invalid rf" <<
                                endln;
                            ifNoError = false;
                        }
                  ...
                  {             // invalid option
                      opserr <<
                          "WAINING KikuchiAikenLRB invalid optional arguments"
                          << endln;
                      ifNoError = false;
                      break;
                  }
    ...
    if (!ifNoError)
      {
          ...
          //want:
          opserr <<
              "Want: uniaxialMaterial KikuchiAikenLRB matTag? type? ar? hr? gr? ap? tp? alph? beta? <-T temp? > <-coKQ rk? rq?> <-coMSS rs? rf?>"
              << endln;
//
          return TCL_ERROR;
      }
    ...
    // Parsing was successful, allocate the material
    theMaterial =
        new KikuchiAikenLRB (tag, type, ar, hr, gr, ap, tp, alph, beta, temp,
                             rk, rq, rs, rf);
    ...
    if (!ifNoError)
      {
          ...
          //want:
          opserr <<
              "WANT: AxialSp tag? sce? fty? fcy? <bte?> <bty?> <bcy?> <fcr?>"
              << endln;
                      ...
                      TCL_Char ** argv)
{
    ...
    if (!ifNoError)
      {
          ...
          //wand:
          opserr <<
              "WANT: AxialSpHD tag? sce? fty? fcy? <bte?> <bty?> <bth?> <bcy?> <fcr?> <ath?>"
              << endln;
    ...
    // Parsing was successful, allocate the material
    theMaterial =
        new AxialSpHD (tag, sce, fty, fcy, bte, bty, bth, bcy, fcr, ath);
