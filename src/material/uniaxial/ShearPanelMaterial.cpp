...
ShearPanelMaterial::ShearPanelMaterial (int tag,
                                        ...
                                        double gflim, double ge, double ystr):
...
ShearPanelMaterial::setTrialStrain (double strain, double CstrainRate)
{
    ...
    elasticStrainEnergy =
        (Tstrain >
         0.0) ? 0.5 * Tstress / kElasticPosDamgd * Tstress : 0.5 * Tstress /
        kElasticNegDamgd * Tstress;
...
double
ShearPanelMaterial::getStrain (void)
{
    return Tstrain;
}

double
ShearPanelMaterial::getStress (void)
{
    return Tstress;
}

double
ShearPanelMaterial::getTangent (void)
{
    return Ttangent;
}

double
ShearPanelMaterial::getInitialTangent (void)
{
    return envlpPosStress (0) / envlpPosStrain (0);
}

int
ShearPanelMaterial::commitState (void)
{
    Cstate = Tstate;
...
#ifdef _G3DEBUG
    (*fg) << tagMat << "  " << CgammaF << "  " << CgammaK << "  " << CgammaD
        << endln;
#endif
    return 0;
}
...
int
ShearPanelMaterial::revertToLastCommit (void)
{
...
int
ShearPanelMaterial::revertToStart (void)
{
    Cstate = 0;
    Cstrain = 0.0;
    Cstress = 0.0;
...
UniaxialMaterial *
ShearPanelMaterial::getCopy (void)
{
...
int
ShearPanelMaterial::sendSelf (int commitTag, Channel & theChannel)
{
    return -1;
}

int
ShearPanelMaterial::recvSelf (int commitTag, Channel & theChannel,
...
void
ShearPanelMaterial::Print (OPS_Stream & s, int flag)
{
...
void
ShearPanelMaterial::SetEnvelope (void)
{
    ...
    if (yldStress < envlpPosStress (2) && yldStress > envlpPosStress (1))
      {
          double slope =
              (envlpPosStress (2) -
               envlpPosStress (1)) / (envlpPosStrain (2) -
                                      envlpPosStrain (1));
          yldStrain =
             ...
             && yldStress >= envlpPosStress (2))
      {
          double slope =
              (envlpPosStress (3) -
               envlpPosStress (2)) / (envlpPosStrain (3) -
                                      envlpPosStrain (2));
          yldStrain =
...
void
ShearPanelMaterial::getstate (double u, double du)
{
    int cid = 0;
    int cis = 0;
    int newState = 0;
...
double
ShearPanelMaterial::posEnvlpStress (double u)
{
    double k = 0.0;
    int i = 0;
    double f = 0.0;
...
double
ShearPanelMaterial::posEnvlpTangent (double u)
{
    double k = 0.0;
    int i = 0;
    while (k == 0.0 && i <= 4)
...
double
ShearPanelMaterial::negEnvlpStress (double u)
{
    double k = 0.0;
    int i = 0;
    double f = 0.0;
...
double
ShearPanelMaterial::negEnvlpTangent (double u)
{
    double k = 0.0;
    int i = 0;
    while (k == 0.0 && i <= 4)
...
void
ShearPanelMaterial::getState3 (Vector & state3Strain, Vector & state3Stress,
                               double kunload)
{
...
void
ShearPanelMaterial::getState4 (Vector & state4Strain, Vector & state4Stress,
                               double kunload)
{
...
double
ShearPanelMaterial::Envlp3Tangent (Vector s3Strain, Vector s3Stress, double u)
{
    double k = 0.0;
    int i = 0;
    while ((k == 0.0 || i <= 2) && (i <= 2))
...
double
ShearPanelMaterial::Envlp4Tangent (Vector s4Strain, Vector s4Stress, double u)
{
    double k = 0.0;
    int i = 0;
    while ((k == 0.0 || i <= 2) && (i <= 2))
...
double
ShearPanelMaterial::Envlp3Stress (Vector s3Strain, Vector s3Stress, double u)
{
    double k = 0.0;
    int i = 0;
    double f = 0.0;
...
double
ShearPanelMaterial::Envlp4Stress (Vector s4Strain, Vector s4Stress, double u)
{
    double k = 0.0;
    int i = 0;
    double f = 0.0;
...
void
ShearPanelMaterial::updateDmg (double strain, double dstrain)
{
    double tes = 0.0;
    double umaxAbs =
        (TmaxStrainDmnd > -TminStrainDmnd) ? TmaxStrainDmnd : -TminStrainDmnd;
    double uultAbs =
        (envlpPosStrain (4) >
          ...
          if ((umaxAbs >= yldStrain) && (yldStrain != 0.0))
            {
                ...
                double b =
                    -gammaFLimit * yldStrain * uultAbs / (uultAbs -
                                                          yldStrain);
