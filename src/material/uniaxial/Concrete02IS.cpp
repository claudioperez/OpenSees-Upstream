...
void *OPS_Concrete02IS()
{
    ...
    if (OPS_GetIntInput(&numData, iData) != 0) {
        opserr << "WARNING invalid uniaxialMaterial Concrete02IS tag" <<
            endln;
        return 0;
    }
    ...
    if (numData != 8) {
        opserr << "Invalid #args, want: uniaxialMaterial Concrete02IS " <<
            iData[0] << "E0? fpc? epsc0? fpcu? epscu? rat? ft? Ets?\n";
        return 0;
    }
    ...
    if (theMaterial == 0) {
        opserr <<
            "WARNING could not create uniaxialMaterial of type Concrete02IS Material\n";
        return 0;
    }
...
Concrete02IS::Concrete02IS(int tag, double _E0, double _fc, double _epsc0,
                           double _fcu, double _epscu, double _rat,
                           double _ft, double _Ets):UniaxialMaterial(tag,
                                                                     MAT_TAG_Concrete02IS),
...
Concrete02IS::Concrete02IS(void):UniaxialMaterial(0, MAT_TAG_Concrete02IS)
{
...
UniaxialMaterial *Concrete02IS::getCopy(void)
{
    Concrete02IS *theCopy =
        new Concrete02IS(this->getTag(), E0, fc, epsc0, fcu, epscu, rat,
                         ft,
                         Ets);
...
double Concrete02IS::getInitialTangent(void)
{
    //return 2.0*fc/epsc0; // Marafi Change 2018/01/31
    return E0;
}

int Concrete02IS::setTrialStrain(double trialStrain, double strainRate)
{
...
double Concrete02IS::getStrain(void)
{
    return eps;
}

double Concrete02IS::getStress(void)
{
    return sig;
}

double Concrete02IS::getTangent(void)
{
    return e;
}

int Concrete02IS::commitState(void)
{
    ecminP = ecmin;
    deptP = dept;
...
int Concrete02IS::revertToLastCommit(void)
{
    ecmin = ecminP;;
    dept = deptP;
...
int Concrete02IS::revertToStart(void)
{
    ecminP = 0.0;
    deptP = 0.0;
...
int Concrete02IS::sendSelf(int commitTag, Channel & theChannel)
{
...
int Concrete02IS::recvSelf(int commitTag, Channel & theChannel,
...
void Concrete02IS::Print(OPS_Stream & s, int flag)
{
    if (flag == OPS_PRINT_PRINTMODEL_MATERIAL) {
        s << "Concrete02IS:(strain, stress, tangent) " << eps << " " << sig
            << " " << e << endln;
    }
...
void Concrete02IS::Tens_Envlp(double epsc, double &sigc, double &Ect)
{
/*-----------------------------------------------------------------------
...
void Concrete02IS::Compr_Envlp(double epsc, double &sigc, double &Ect)
{
/*-----------------------------------------------------------------------
...
int Concrete02IS::getVariable(const char *varName, Information & theInfo)
{
