...
void *OPS_AxialSp()
{
    ...
    return new AxialSp(tag, data[0], data[1], data[2], opt[0], opt[1],
                       opt[2], opt[3]);
}
#endif
...
AxialSp::AxialSp(int tag, double sce, double fty, double fcy,
                 double bte, double bty, double bcy,
                 double fcr):UniaxialMaterial(tag, MAT_TAG_AxialSp),
sce(sce), fty(fty), fcy(fcy), bte(bte), bty(bty), bcy(bcy), fcr(fcr)
{
...
AxialSp::AxialSp():UniaxialMaterial(0, MAT_TAG_AxialSp)
{
    trialDeformation = 0.0;
    trialForce = 0.0;
    trialStiffness = 0.0;
...
double AxialSp::getStress(void)
{
    return trialForce;
}

double AxialSp::getTangent(void)
{
    return trialStiffness;
}

double AxialSp::getInitialTangent(void)
{
    return sce;
}

double AxialSp::getStrain(void)
{
    return trialDeformation;
}

int AxialSp::commitState(void)
{
...
int AxialSp::revertToLastCommit(void)
{
...
int AxialSp::revertToStart(void)
{
    trialDeformation = 0.0;
    trialForce = 0.0;
    trialStiffness = sce;
...
UniaxialMaterial *AxialSp::getCopy(void)
{
...
int AxialSp::sendSelf(int cTag, Channel & theChannel)
{
    int res = 0;
...
int AxialSp::recvSelf(int cTag, Channel & theChannel,
...
void AxialSp::Print(OPS_Stream & s, int flag)
{
