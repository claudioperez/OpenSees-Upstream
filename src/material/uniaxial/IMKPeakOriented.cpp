...
OPS_IMKPeakOriented ()
{
    if (numIMKPeakOrientedMaterials == 0)
      {
          ...
          OPS_Error
              ("IMK Model with Peak-Oriented Response - Code by A. ELKADY & H. ELJISR (July 2020)\n",
               1);
      }
    ...
    if (OPS_GetIntInput (&numData, iData) != 0)
      {
          opserr << "WARNING invalid uniaxialMaterial IMKPeakOriented tag" <<
              endln;
          return 0;
      }
    ...
    if (theMaterial == 0)
      {
          opserr <<
              "WARNING could not create uniaxialMaterial of type IMKPeakOriented Material\n";
          return 0;
      }
...
IMKPeakOriented::IMKPeakOriented ():UniaxialMaterial (0, 0), Ke (0),
...
int
IMKPeakOriented::setTrialStrain (double strain, double strainRate)
{
          ...
          if (fi_1 + du * Kul_j_1 >= 0)
            {
                ...
                if ((ui >= 0) && (Upeak_pos_j_1 <= Uy_pos_j_1)
                         ...
                         && (ui <= Upeak_pos_j_1))
                  {
                      ...
                      // CASE 4: WHEN LOADING IN GENERAL TOWARDS THE TARGET PEAK
                         ...
                         && (((TargetPeak_Flag == 0) && (ui <= Upeak_pos_j_1))
                             || ((TargetPeak_Flag == 1)
                ...
                else if ((du >= 0) && (TargetPeak_Flag == 1)
                         && (ui >= ULastPeak_pos_j_1)
                         && (ui <= Upeak_pos_j_1))
                  {
                      Krel_j_1 =
                      ...
                      if (ui_1 <= ULastPeak_pos_j_1)
                        {
                            df = (FLastPeak_pos_j_1 - fi_1) + Krel_j_1 * (ui -
                                                                          ULastPeak_pos_j_1);
                        }
                      else
                        {
                ...
                if ((ui <= 0) && (Upeak_neg_j_1 >= Uy_neg_j_1)
                         ...
                         && (ui >= Upeak_neg_j_1))
                  {
                      ...
                      // CASE 4: WHEN LOADING IN GENERAL TOWARDS THE TARGET PEAK
                         ...
                         && (((TargetPeak_Flag == 0) && (ui >= Upeak_neg_j_1))
                             || ((TargetPeak_Flag == 1)
                         ...
                         && (ui >= Upeak_neg_j_1))
                  {
                      ...
                      if (ui_1 >= ULastPeak_neg_j_1)
                        {
                            df = (FLastPeak_neg_j_1 - fi_1) + Krel_j_1 * (ui -
                                                                          ULastPeak_neg_j_1);
                        }
                      else
                        {
...
double
IMKPeakOriented::getStress (void)
{
...
double
IMKPeakOriented::getTangent (void)
{
...
double
IMKPeakOriented::getInitialTangent (void)
{
...
double
IMKPeakOriented::getStrain (void)
{
...
int
IMKPeakOriented::commitState (void)
{
...
int
IMKPeakOriented::revertToLastCommit (void)
{
...
int
IMKPeakOriented::revertToStart (void)
{
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////\\
...
int
IMKPeakOriented::sendSelf (int cTag, Channel & theChannel)
{
    int res = 0;
    cout << " sendSelf" << endln;
...
int
IMKPeakOriented::recvSelf (int cTag, Channel & theChannel,
...
void
IMKPeakOriented::Print (OPS_Stream & s, int flag)
{
