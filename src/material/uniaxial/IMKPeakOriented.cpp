...
IMKPeakOriented::IMKPeakOriented(int tag, double p_Ke,
                                 ...
                                 double p_D_neg):UniaxialMaterial(tag, 0),
Ke(p_Ke),
Up_pos(p_Up_pos),
Upc_pos(p_Upc_pos),
Uu_pos(p_Uu_pos),
...
LAMBDA_K(p_LAMBDA_K),
c_S(p_c_S),
c_C(p_c_C), c_A(p_c_A), c_K(p_c_K), D_pos(p_D_pos), D_neg(p_D_neg)
{
    this->revertToStart();
}
...
UniaxialMaterial *IMKPeakOriented::getCopy(void)
{
...
int IMKPeakOriented::recvSelf(int cTag, Channel & theChannel,
