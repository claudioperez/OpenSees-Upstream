...
void *OPS_DamperMaterial(void)
{
    ...
    if (argc < 2) {
        opserr <<
            "Invalid #args,  want: uniaxialMaterial Damper $tag $tag1 $tag2 ... <-factors $fact1 $fact2 ...>"
            << endln;
        return 0;
    }
    ...
    if (theMaterial == 0) {
        opserr <<
            "WARNING could not create uniaxialMaterial of type Damper\n";
        return 0;
    }
...
DamperMaterial::DamperMaterial(int tag,
                               UniaxialMaterial *
                               theMaterialModel):UniaxialMaterial(tag,
                                                                  MAT_TAG_DamperMaterial),
...
DamperMaterial::DamperMaterial():UniaxialMaterial(0, MAT_TAG_DamperMaterial),
...
double DamperMaterial::getStrain(void)
{
    return trialStrain;
}

double DamperMaterial::getStrainRate(void)
{
    return trialStrainRate;
}

double DamperMaterial::getStress(void)
{
...
double DamperMaterial::getTangent(void)
{
    return 0;
}

double DamperMaterial::getInitialTangent(void)
{
    return 0;
}

double DamperMaterial::getDampTangent(void)
{
    return theMaterial->getTangent();
}

int DamperMaterial::commitState(void)
{
    return theMaterial->commitState();
}

int DamperMaterial::revertToLastCommit(void)
{
    return theMaterial->revertToLastCommit();
}


int DamperMaterial::revertToStart(void)
{
    trialStrain = 0.0;
    trialStrainRate = 0.0;
...
UniaxialMaterial *DamperMaterial::getCopy(void)
{
...
int DamperMaterial::sendSelf(int cTag, Channel & theChannel)
{
    int res = 0;
...
int DamperMaterial::recvSelf(int cTag, Channel & theChannel,
...
void DamperMaterial::Print(OPS_Stream & s, int flag)
{
