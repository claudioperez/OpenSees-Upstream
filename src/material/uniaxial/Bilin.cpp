...
// Updated: Filipe Ribeiro and Andre Barbosa 
Bilin::Bilin (int tag, double p_Ke0, double p_AsPos, double p_AsNeg,
              double p_My_pos, double p_My_neg, double p_LamdaS,
              double p_LamdaD, double p_LamdaA, double p_LamdaK, double p_Cs,
              double p_Cd, double p_Ca, double p_Ck, double p_Thetap_pos,
              double p_Thetap_neg, double p_Thetapc_pos, double p_Thetapc_neg,
              double p_KPos, double p_KNeg, double p_Thetau_pos,
              double p_Thetau_neg, double p_PDPlus, double p_PDNeg,
              double p_nFactor):
UniaxialMaterial (tag, MAT_TAG_Bilin),
Ke0 (p_Ke0),
AsPos (p_AsPos),
AsNeg (p_AsNeg),
My_pos (p_My_pos),
...
Bilin::Bilin ():UniaxialMaterial (0, MAT_TAG_Bilin), Ke0 (0), AsPos (0), AsNeg (0), My_pos (0), My_neg (0), LamdaS (0), LamdaD (0), LamdaA (0), LamdaK (0), Cs (0), Cd (0), Ca (0), Ck (0), Thetap_pos (0), Thetap_neg (0), Thetapc_pos (0), Thetapc_neg (0), KPos (0), KNeg (0), Thetau_pos (0), Thetau_neg (0), PDPlus (0), PDNeg (0), nFactor (0)
                                                                                                                                                                                                                                                                                                                                        // Updated: Filipe Ribeiro and Andre Barbosa
{
    this->revertToStart ();
}
...
{
    Bilin *theCopy =
        new Bilin (this->getTag (), Ke0, AsPos, AsNeg, My_pos, My_neg, LamdaS,
                   LamdaD,
...
int
Bilin::recvSelf (int cTag, Channel & theChannel, FEM_ObjectBroker & theBroker)
{
    int res = 0;
    static Vector data (166);   // Updated: Filipe Ribeiro and Andre Barbosa
...
//my functions
void
Bilin::interPoint (double &xInt, double &yInt, double x1, double y1,
...
void
Bilin::envelPosCap2 (double fy, double alphaPos, double alphaCap,
...
void
Bilin::envelNegCap2 (double fy, double alphaNeg, double alphaCap,
                     double cpDsp, double &d, double &f, double &ek,
