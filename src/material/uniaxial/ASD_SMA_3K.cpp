          ...
          if (Tstrain >= 0)
            {
                            ...
                            if (No_Y_Pos == 1)
                              {
                                  ...
                                  TupperStrainPos =
                                      (k1 * Tstrain - Tstress - k2 * ActDef +
                                       ActF) / (k1 - k2);
                                  TupperStressPos =
                                      k2 * TupperStrainPos - k2 * ActDef +
                                      ActF;
                              }
                            else
                              {
                                  Tstress =
                                      fmin (Cstress + diffStrain * k1,
                                            Tstrain * k1);
                                  Ttangent = k1;
                              }
                        }
                ...
                // Upper Activation 
                else if (Tstrain > CupperStrainPos)
                  {
                      ...
                      X = (-k3 * TupperStrainPos + TupperStressPos) / (k1 -
                                                                       k3);
            ...
            {                   // Tstrain < 0)
                            ...
                            if (No_Y_Neg == 1)
                              {
                                  ...
                                  TupperStrainNeg =
                                      (k1 * Tstrain - Tstress + k2 * ActDef -
                                       ActF) / (k1 - k2);
                                  TupperStressNeg =
                                      k2 * TupperStrainNeg + k2 * ActDef -
                                      ActF;
                              }
                            else
                              {
                                  Tstress =
                                      fmax (Cstress + diffStrain * k1,
                                            Tstrain * k1);
                                  Ttangent = k1;
                              }
                        }
                ...
                // Upper Activation
                else if (Tstrain < CupperStrainNeg)
                  {
                      ...
                      X = (-k3 * TupperStrainNeg + TupperStressNeg) / (k1 -
                                                                       k3);
