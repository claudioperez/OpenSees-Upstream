...
double
Steel4::isoHardening (double eps_pl_tot, double b_1, double b_2, double rho,
                      double R)
{
...
void
Steel4::calcBreakpoints (int loadDir, double eps_0BC, double sig_0BC,
                         double df_yC, double df_ykC, double eps_pl_tot,
                         double &eps_yC, double &sig_yC, double &eps_lC)
{
...
double
Steel4::calcStress (int loadDir, double eps_C, double eps_0C, double sig_0C,
                    double eps_0BC, double sig_0BC, bool saveProps,
    ...
    if (dir == 0 || dir == 3)
      {                         // = initial phase
          ...
          if (fabs (deltaEps) < 10.0 * DBL_EPSILON)
            ...
            {                   // = delta epsilon is large enough to make a decision on the load direction
                if (deltaEps < 0.0)
                  {             // negative direction -> compression
                      dir = 2;
                      eps_y = -eps_y0;
                      sig_y = -f_y;
                      eps_0B = 0;
