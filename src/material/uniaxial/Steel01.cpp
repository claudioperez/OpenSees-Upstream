...
fy (FY), E0 (E), b (B), a1 (A1), a2 (A2), a3 (A3),
a4 (A4)
{
...
int
Steel01::setTrial (double strain, double &stress, double &tangent,
                   double strainRate)
{
    // Reset history variables to last converged state
    TminStrain = CminStrain;
...
void
Steel01::determineTrialState (double dStrain)
{
...
int
Steel01::sendSelf (int commitTag, Channel & theChannel)
{
    int res = 0;
...
int
Steel01::recvSelf (int commitTag, Channel & theChannel,
...
int
Steel01::commitSensitivity (double TstrainSensitivity, int gradIndex,
                            int numGrads)
{
    if (SHVs == 0)
      {
