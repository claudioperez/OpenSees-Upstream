...
void *OPS_Steel01()
{
    ...
    if (numData != 3 && numData != 7) {
        opserr << "Invalid #args, want: uniaxialMaterial Steel01 " <<
    ...
    if (theMaterial == 0) {
        opserr <<
            "WARNING could not create uniaxialMaterial of type Steel01 Material\n";
        return 0;
    }
...
fy(0.0), E0(0.0), b(0.0), a1(0.0), a2(0.0), a3(0.0),
a4(0.0)
{
    Energy = 0;                 //by SAJalali
...
int
 Steel01::setTrialStrain(double strain, double strainRate)
{
...
int Steel01::setTrial(double strain, double &stress, double &tangent,
                      double strainRate)
{
    // Reset history variables to last converged state
    TminStrain = CminStrain;
...
// AddingSensitivity:BEGIN ///////////////////////////////////
int Steel01::setParameter(const char **argv, int argc, Parameter & param)
{
...
int Steel01::updateParameter(int parameterID, Information & info)
{
    switch (parameterID) {
    case -1:
        return -1;
...
int Steel01::activateParameter(int passedParameterID)
{
...
double Steel01::getStressSensitivity(int gradIndex, bool conditional)
{
...
double Steel01::getInitialTangentSensitivity(int gradIndex)
{
...
int Steel01::commitSensitivity(double TstrainSensitivity, int gradIndex,
                               int numGrads)
{
    if (SHVs == 0) {
