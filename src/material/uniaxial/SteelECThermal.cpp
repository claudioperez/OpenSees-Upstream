...
fyT (FY), E0T (E), a1 (A1), a2 (A2), a3 (A3),
a4 (A4)
{
...
int
SteelECThermal::setTrial (double strain, double &stress, double &tangent,
                          double strainRate)
{
    // Reset history variables to last converged state
    TminStrain = CminStrain;
...
void
SteelECThermal::determineTrialState (double dStrain)
{
...
void
SteelECThermal::detectLoadReversal (double dStrain)
{
...
double
SteelECThermal::getStrain ()
{
    return Tstrain;
}

double
SteelECThermal::getStress ()
{
    return Tstress;
}

double
SteelECThermal::getTangent ()
{
    return Ttangent;
}
...
double
SteelECThermal::getElongTangent (double TempT, double &ET, double &Elong,
                                 double TempTmax)
{
...
0.0 };
      ...
      {
          double FyRfEC22[12] =
              { 1.0, 1.0, 1.0, 0.94, 0.67, 0.40, 0.12, 0.11, 0.08, 0.05, 0.03,
0.0 };
          double FpRfEC22[12] =
...
0.02, 0.0 };
      ...
      {
          double FyRfEC23[12] =
              { 1.0, 1.0, 1.0, 0.90, 0.70, 0.47, 0.23, 0.11, 0.06, 0.04, 0.02,
0.0 };
          double FpRfEC23[12] =
...
int
SteelECThermal::revertToLastCommit ()
{
...
int
SteelECThermal::sendSelf (int commitTag, Channel & theChannel)
{
    int res = 0;
...
int
SteelECThermal::recvSelf (int commitTag, Channel & theChannel,
...
void
SteelECThermal::Print (OPS_Stream & s, int flag)
{
...
int
SteelECThermal::commitSensitivity (double TstrainSensitivity, int gradIndex,
                                   int numGrads)
{
    if (SHVs == 0)
      {
...
int
SteelECThermal::setTrialStrain (double strain, double strainRate)
{
    opserr <<
