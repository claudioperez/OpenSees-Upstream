                                                    ...
                                                    TCL_Char ** argv)
{
    ...
    if (strcmp(argv[1], "Hardening1") == 0
        ...
        if (argc < 7) {
            ...
            printCommand(argc, argv);
            opserr <<
                "Want: uniaxialMaterial Hardening01 tag? E? sigY? Hiso? Hkin?"
                << endln;
            return 0;
        }
        ...
        theMaterial =
            new FedeasHardeningMaterial(tag, E, sigY, Hiso, Hkin);
    }

    else if (strcmp(argv[1], "Bond1") == 0
             || strcmp(argv[1], "Bond01") == 0) {
        if (argc < 15) {
            opserr << "WARNING invalid number of arguments\n";
            printCommand(argc, argv);
            opserr <<
                "Want: uniaxialMaterial Bond01 tag? u1p? q1p? u2p? u3p? q3p? u1n? q1n? u2n? u3n? q3n? s0? bb?"
                << endln;
            return 0;
        }
        ...
        theMaterial =
            new FedeasBond1Material(tag, u1p, q1p, u2p, u3p, q3p, u1n, q1n,
                                    u2n, u3n, q3n, s0, bb);
    }

    else if (strcmp(argv[1], "Bond2") == 0
             || strcmp(argv[1], "Bond02") == 0) {
        if (argc < 17) {

            opserr << "WARNING invalid number of arguments\n";
            printCommand(argc, argv);
            opserr <<
                "Want: uniaxialMaterial Bond02 tag? u1p? q1p? u2p? u3p? q3p? u1n? q1n? u2n? u3n? q3n? s0? bb? alp? aln?"
                << endln;
            return 0;
        }
        ...
        theMaterial =
            new FedeasBond2Material(tag, u1p, q1p, u2p, u3p, q3p, u1n, q1n,
                                    u2n, u3n, q3n, s0, bb, alp, aln);
    }
        ...
        theMaterial =
            new FedeasConcr1Material(tag, fpc, epsc0, fpcu, epscu);
    }
        ...
        if (argc < 10) {
            ...
            printCommand(argc, argv);
            opserr <<
                "Want: uniaxialMaterial Concrete02 tag? fpc? epsc0? fpcu? epscu? rat? ft? Ets?"
                << endln;
            return 0;
        }
        ...
        theMaterial =
            new FedeasConcr2Material(tag, fpc, epsc0, fpcu, epscu, rat, ft,
                                     Ets);
    }
        ...
        if (argc < 13) {
            ...
            printCommand(argc, argv);
            opserr <<
                "Want: uniaxialMaterial Concrete03 tag? fpc? epsc0? fpcu? epscu? rat? ft? epst0? ft0? beta? epstu?"
                << endln;
            return 0;
        }
        ...
        theMaterial =
            new FedeasConcr3Material(tag, fpc, epsc0, fpcu, epscu, rat, ft,
        ...
        if (argc < 15) {
            ...
            printCommand(argc, argv);
            opserr <<
                "Want: uniaxialMaterial Hysteretic01 tag? s1p? e1p? s2p? e2p? s1n? e1n? s2n? e1n? px? py? d1? d2?"
                << endln;
            return 0;
        }
        ...
        theMaterial =
            new FedeasHyster1Material(tag, s1p, e1p, s2p, e2p, s1n, e1n,
                                      s2n, e2n, px, py, d1, d2);
    }
        ...
        if (argc < 19) {
            ...
            printCommand(argc, argv);
            opserr <<
                "Want: uniaxialMaterial Hysteretic02 tag? s1p? e1p? s2p? e2p? s3p? e3p? s1n? e1n? s2n? e1n? s3n? e3n? px? py? d1? d2?"
                << endln;
            return 0;
        }
        ...
        theMaterial =
            new FedeasHyster2Material(tag, s1p, e1p, s2p, e2p, s3p, e3p,
                                      s1n, e1n, s2n, e2n, s3n, e3n, px, py,
                                      d1, d2);
    }
        ...
        if (argc > 9) {
            ...
            theMaterial =
                new FedeasSteel1Material(tag, fy, E, b, a1, a2, a3, a4);
        } else
        ...
        if (argc < 6) {
            ...
            printCommand(argc, argv);
            opserr <<
                "Want: uniaxialMaterial Steel02 tag? fy? E? b? <R0? cR1? cR2? <a1? a2? a3? a4?>>"
                << endln;
            return 0;
        }
        ...
        if (argc > 8) {
            ...
            if (argc > 12) {
                ...
                theMaterial =
                    new FedeasSteel2Material(tag, fy, E, b, R0, cR1,
                                             cR2, a1, a2, a3, a4);
            } else
                theMaterial =
                    new FedeasSteel2Material(tag, fy, E, b, R0, cR1, cR2);
        } else
        ...
        if (argc < 11) {
            opserr << "WARNING invalid number of arguments\n";
            opserr <<
                "Want: uniaxialMaterial ConcretePlasticDamage tag? $Ec $Gf $Gc $ft $fcy $fc $ktcr $relax"
                << endln;
            return 0;
        }
        ...
        if (Tcl_GetDouble(interp, argv[3], &Ec) != TCL_OK) {
            opserr <<
                "WARNING uniaxialMaterial ConcretePlasticDamage tag? $Ec $Ft $Fc $ft_max $fcy $fc $ktcr $relax - invalid Ec\n";
            return 0;
        }
        if (Tcl_GetDouble(interp, argv[4], &Ft) != TCL_OK) {
            opserr <<
                "WARNING uniaxialMaterial ConcretePlasticDamage tag? $Ec $Ft $Fc $ft_max $fcy $fc $ktcr $relax - invalid Ft\n";
            return 0;
        }
        if (Tcl_GetDouble(interp, argv[5], &Fc) != TCL_OK) {
            opserr <<
                "WARNING uniaxialMaterial ConcretePlasticDamage tag? $Ec $Ft $Fc $ft_max $fcy $fc $ktcr $relax - invalid Fc\n";
            return 0;
        }
        if (Tcl_GetDouble(interp, argv[6], &ft_max) != TCL_OK) {
            opserr <<
                "WARNING uniaxialMaterial ConcretePlasticDamage tag? $Ec $Ft $Fc $ft_max $fcy $fc $ktcr $relax - invalid ft_max\n";
            return 0;
        }
        if (Tcl_GetDouble(interp, argv[7], &fcy) != TCL_OK) {
            opserr <<
                "WARNING uniaxialMaterial ConcretePlasticDamage tag? $Ec $Ft $Fc $ft_max $fcy $fc $ktcr $relax - invalid fcy\n";
            return 0;
        }
        ...
        if (Tcl_GetDouble(interp, argv[9], &ktcr) != TCL_OK) {
            opserr <<
                "WARNING uniaxialMaterial ConcretePlasticDamage tag? $Ec $Ft $Fc $ft_max $fcy $fc $ktcr $relax - invalid Ktcr\n";
            return 0;
        }
        if (Tcl_GetDouble(interp, argv[10], &relax) != TCL_OK) {
            opserr <<
                "WARNING uniaxialMaterial ConcretePlasticDamage tag? $Ec $Ft $Fc $ft_max $fcy $fc $ktcr $relax - invalid relax\n";
            return 0;
        }

        theMaterial =
            new PlasticDamageMaterial(tag, Ec, Ft, Fc, ft_max, fcy, fc,
                                      ktcr, relax);
