...
OPS_IMKPinching ()
{
    ...
    theMaterial = new IMKPinching (iData[0],
                                   ...
                                   dData[17], dData[18], dData[19], dData[20],
...
IMKPinching::IMKPinching (int tag, double p_Ke,
                          double p_Up_pos, double p_Upc_pos, double p_Uu_pos,
                          double p_Fy_pos, double p_FmaxFy_pos,
                          double p_ResF_pos, double p_Up_neg,
                          double p_Upc_neg, double p_Uu_neg, double p_Fy_neg,
                          double p_FmaxFy_neg, double p_ResF_neg,
                          double p_LAMBDA_S, double p_LAMBDA_C,
                          double p_LAMBDA_A, double p_LAMBDA_K, double p_c_S,
                          double p_c_C, double p_c_A, double p_c_K,
                          double p_D_pos, double p_D_neg, double p_kappaF,
                          double p_kappaD):
...
Uu_pos (p_Uu_pos),
Fy_pos (p_Fy_pos),
FmaxFy_pos (p_FmaxFy_pos),
ResF_pos (p_ResF_pos),
Up_neg (p_Up_neg),
Upc_neg (p_Upc_neg),
Uu_neg (p_Uu_neg),
Fy_neg (p_Fy_neg),
FmaxFy_neg (p_FmaxFy_neg),
ResF_neg (p_ResF_neg),
LAMBDA_S (p_LAMBDA_S),
LAMBDA_C (p_LAMBDA_C),
LAMBDA_A (p_LAMBDA_A),
          ...
          if ((fi_1 > 0) && (du <= 0) && (du * du_i_1 <= 0))
            {
                ...
                if ((K_check >= 1.05 * Kul_j_1)
                    || (K_check <= 0.95 * Kul_j_1))
                  {             // a tailored criteria to avoid registering last peak points during small unload/reload excursions on the unloading branch 
          ...
          if (Reversal_Flag == 1)
            {
                ...
                EiK =
                    Energy_Acc - Energy_Diss + 0.5 * (fi_1 / Kul_j_1) * fi_1;
                ...
                if ((ui >= 0) && (Upeak_pos_j_1 <= Uy_pos_j_1)
                      ...
                      if (TargetPeak_Flag == 1)
                        {
                            if ((FLastPeak_pos_j_1 <= Fbp) && (ui <= Ubp))
                              ...
                              {
                                  Krel_j_1 =
                                      (Fpeak_pos_j_1 - Fbp) / (Upeak_pos_j_1 -
                                                               Ubp);
                              }
                            else
                              {
                ...
                else if ((du >= 0) && (ui <= Upeak_pos_j_1))
                  {
                      if ((TargetPeak_Flag == 0) && (ui >= Ubp))
                        {
                            Krel_j_1 =
                                (Fpeak_pos_j_1 - fi_1) / (Upeak_pos_j_1 -
                                                          ui_1);
                        }
                        ...
                        {
                            Krel_j_1 =
                                (FLastPeak_pos_j_1) / (ULastPeak_pos_j_1 -
                                                       u0);
                        }
                      else if ((TargetPeak_Flag == 1)
                               && (ui >= ULastPeak_pos_j_1))
                ...
                if ((ui <= 0) && (Upeak_neg_j_1 >= Uy_neg_j_1)
                      ...
                      if (TargetPeak_Flag == 1)
                        {
                            if ((FLastPeak_neg_j_1 >= Fbp) && (ui <= Ubp))
                              ...
                              {
                                  Krel_j_1 =
                                      (Fpeak_neg_j_1 - Fbp) / (Upeak_neg_j_1 -
                                                               Ubp);
                              }
                            else
                              {
                ...
                else if ((du <= 0) && (ui >= Upeak_neg_j_1))
                  {
                      if ((TargetPeak_Flag == 0) && (ui <= Ubp))
                        {
                            Krel_j_1 =
                                (Fpeak_neg_j_1 - fi_1) / (Upeak_neg_j_1 -
                                                          ui_1);
                        }
                      else if ((TargetPeak_Flag == 0) && (ui >= Ubp))
                        {
                        ...
                        {
                            Krel_j_1 =
                                (FLastPeak_neg_j_1) / (ULastPeak_neg_j_1 -
                                                       u0);
                        }
                      else if ((TargetPeak_Flag == 1)
                               && (ui <= ULastPeak_neg_j_1))
...
double
IMKPinching::getInitialTangent (void)
{
...
int
IMKPinching::revertToLastCommit (void)
{
...
int
IMKPinching::revertToStart (void)
{
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////\\
...
IMKPinching::getCopy (void)
{
    IMKPinching *theCopy = new IMKPinching (this->getTag (), Ke,
                                            Uy_pos, Umax_pos, Uu_pos, Fy_pos,
                                            FmaxFy_pos, ResF_pos,
                                            Uy_neg, Umax_neg, Uu_neg, Fy_neg,
                                            FmaxFy_neg, ResF_neg,
...
int
IMKPinching::sendSelf (int cTag, Channel & theChannel)
{
    int res = 0;
    cout << " sendSelf" << endln;
...
int
IMKPinching::recvSelf (int cTag, Channel & theChannel,
...
void
IMKPinching::Print (OPS_Stream & s, int flag)
{
