...
Concrete04::Concrete04
    (int tag, double FPC, double EPSC0, double EPSCU, double EC0,
     double FCT, double ETU):UniaxialMaterial(tag, MAT_TAG_Concrete04),
fpc(FPC), epsc0(EPSC0), epscu(EPSCU), Ec0(EC0), fct(FCT), etu(ETU),
beta(0.1), CminStrain(0.0), CendStrain(0.0), CcompStrain(0.0),
CUtenStress(FCT), Cstrain(0.0), Cstress(0.0), CmaxStrain(0.0)
{
...
Concrete04::Concrete04
    (int tag, double FPC, double EPSC0, double EPSCU, double EC0,
     double FCT, double ETU, double BETA):UniaxialMaterial(tag,
                                                           MAT_TAG_Concrete04),
fpc(FPC), epsc0(EPSC0), epscu(EPSCU), Ec0(EC0), fct(FCT), etu(ETU),
beta(BETA), CminStrain(0.0), CendStrain(0.0), CcompStrain(0.0),
CUtenStress(FCT), Cstrain(0.0), Cstress(0.0), CmaxStrain(0.0)
{
    // Make all concrete parameters negative
    if (fpc > 0.0 || epsc0 > 0.0 || epscu > 0.0) {
...
Concrete04::Concrete04
    (int tag, double FPC, double EPSC0, double EPSCU,
     double EC0):UniaxialMaterial(tag, MAT_TAG_Concrete04), fpc(FPC),
epsc0(EPSC0), epscu(EPSCU), Ec0(EC0), fct(0.0), etu(0.0), beta(0.0),
...
int Concrete04::getMaterialType()
{
    return 0;
}
