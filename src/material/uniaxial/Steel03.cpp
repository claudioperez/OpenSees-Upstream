...
Steel03::Steel03
    (int tag, double FY, double E, double B, double R, double R1,
     double R2, double A1, double A2, double A3,
     double A4):UniaxialMaterial(tag, MAT_TAG_Steel03), fy(FY), E0(E),
b(B), r(R), cR1(R1), cR2(R2), a1(A1), a2(A2), a3(A3), a4(A4)
{
...
int Steel03::setTrial(double strain, double &stress, double &tangent,
                      double strainRate)
{
    // Reset history variables to last converged state
    TminStrain = CminStrain;
