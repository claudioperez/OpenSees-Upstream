...
Dodd_Restrepo::Dodd_Restrepo (int tag,
                              ...
                              double youngs,
                              double eSHI,
                              double fSHI, double omegaFac, double conv):
...
extern "C" int steel_ (double *Es, double *EpsLast, double *FpsLast,
                       ...
                       double *Epy, double *EpSH, double *Epsu, double *Fpsu,
                       double *Youngs, double *SHPower, double *Epr,
                       double *Fpr, double *Epa, double *Fpa, double *Epo,
                       double *EpoMax, double *EpsuSh, double *YoungsUn,
                       double *Power, int *BFlag, int *LMR, double *EprM,
                       double *FprM, double *EpaM, double *FpaM,
                       double *YpTanM, double *PowerM, double *Eps,
                       double *Fps, double *Fs, double *YpTan, double *YTan,
                       double *OmegFac);
...
int
Dodd_Restrepo::setTrial (double strain, double &stress, double &stiff,
                         double strainRate)
{
    if (fabs (strain - tStrain) > DBL_EPSILON)
      {
...
Dodd_Restrepo::Print (OPS_Stream & s, int flag)
{
    ...
    s << "tStrain: " << tStrain << "  tStress: " << tStress << " tTangent: "
        << tTangent << endln;
}
