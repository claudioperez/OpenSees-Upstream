...
void *OPS_ConstantStiffnessDegradation(void)
{
    ...
    if (theDegradation == 0) {
        opserr <<
            "WARNING could not create ConstantStiffnessDegradation\n";
        return 0;
    }
...
ConstantStiffnessDegradation::ConstantStiffnessDegradation(int tag,
                                                           double a,
                                                           double
                                                           b):StiffnessDegradation
    (tag, DEG_TAG_STIFF_Constant), alpha(a), beta(b)
{
    this->revertToStart();
...
const char *ConstantStiffnessDegradation::getMeasure(void)
{
    return "nothing";
}

int ConstantStiffnessDegradation::setTrialMeasure(double measure)
{
    return 0;
}

double ConstantStiffnessDegradation::getValue(void)
{
...
int ConstantStiffnessDegradation::commitState(void)
{
    Cfactor = Tfactor;
...
int ConstantStiffnessDegradation::revertToLastCommit(void)
{
    Tfactor = Cfactor;
...
int ConstantStiffnessDegradation::revertToStart(void)
{
    Cfactor = 1.0;
...
StiffnessDegradation *ConstantStiffnessDegradation::getCopy(void)
{
...
int ConstantStiffnessDegradation::sendSelf(int commitTag,
                                           Channel & theChannel)
{
...
int ConstantStiffnessDegradation::recvSelf(int commitTag,
                                           Channel & theChannel,
...
void ConstantStiffnessDegradation::Print(OPS_Stream & s, int flag)
{
