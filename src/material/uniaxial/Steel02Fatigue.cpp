...
Steel02Fatigue::getCopy (void)  // Add Fatigue... Need to add additional variables later
{
    Steel02Fatigue *theCopy =
        new Steel02Fatigue (this->getTag (), Fy, E0, b, R0, cR1, cR2, a1, a2,
                            a3, a4, Cd, Cf, Alpha, Beta, minStrain, maxStrain,
                            sigini);
    ...
    if (kon == 2 && deps > 0.0)
      {
          ...
          epss0 =
              (Fy * shft - Esh * epsy * shft - sigr + E0 * epsr) / (E0 - Esh);
    ...
    if (trialStrain >= maxStrain || trialStrain <= minStrain)
      {
          ...
          opserr << "FatigueMaterial: material tag " << this->
              getTag () << " failed from excessive strain\n";
                ...
                if (fabs (Fatigue_X) < 1e-10)
                ...
                else
                  {
                      Fatigue_DL =
                          ...
                          0.5 /
                          fabs (pow
                                ((Fatigue_X / Fatigue_E0), 1 / Fatigue_m));
                      // added 6/9/2006
                      //values for recorder
                ...
                if (fabs (Fatigue_Y) < 1e-10)
                ...
                else
                  {
                      Fatigue_DL =
                          ...
                          0.5 /
                          fabs (pow
                                ((Fatigue_Y / Fatigue_E0), 1 / Fatigue_m));
                      // added 6/9/2006
                      //values for recorder
