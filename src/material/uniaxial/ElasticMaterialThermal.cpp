...
OPS_ElasticMaterialThermal (void)
{
    ...
    theMaterial =
        new ElasticMaterialThermal (iData[0], dData1[0], dData1[1], dData2[0],
                                    dData2[1], softindex);
    if (theMaterial == 0)
      {
          opserr <<
...
parameterID (0)
{
    ...
    if (softIndex < 0 || softIndex > 2)
      {
          opserr << "ElasticMaterialThermal " << this->
              getTag () <<
...
int
ElasticMaterialThermal::setTrial (double strain, double &stress,
...
int
ElasticMaterialThermal::setParameter (const char **argv, int argc,
                                      Parameter & param)
{
