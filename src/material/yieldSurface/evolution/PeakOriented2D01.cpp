...
YS_Evolution *
PeakOriented2D01::getCopy (void)
{
    PeakOriented2D01 *theCopy =
        new PeakOriented2D01 (this->getTag (), minIsoFactor, *kpMatXPos,
                              *kpMatYPos);
    if (theCopy == 0)
      {
...
void
PeakOriented2D01::Print (OPS_Stream & s, int flag)
{
    s << "PeakOriented2D \n";
