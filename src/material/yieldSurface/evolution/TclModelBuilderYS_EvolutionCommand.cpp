...
int
addTclYS_Evolution (TclModelBuilder * theBuilder, YS_Evolution * theModel)
{
    if (theModel == 0)
        return TCL_ERROR;
                       ...
                       TclModelBuilder * theBuilder)
{
    ...
    if (Tcl_GetInt (interp, arg, &id) != TCL_OK)
      {
          opserr <<
              "WARNING: TclModelYS_EvolutionCommand - Invalid plastic material tag \n";
          return 0;
      }
    ...
    if (theMat == 0)
      {
          opserr <<
              "WARNING: TclModelYS_EvolutionCommand - no PlasticHardeningMaterial with id = "
              << id << " exists\n";
          return 0;
      }
    else
                       ...
                       TclModelBuilder * theBuilder)
{
    ...
    if (Tcl_GetInt (interp, arg, &id) != TCL_OK)
      {
          opserr <<
              "WARNING: TclModelYS_EvolutionCommand - Invalid YieldSurface_BC tag \n";
          return 0;
      }
    ...
    if (theYS == 0)
      {
          opserr <<
              "WARNING: TclModelYS_EvolutionCommand - no YieldSurface_BC with id = "
              << id << " exists\n";
          return 0;
      }
    else
...
int
TclPeakOriented2D01Command (ClientData clienData, Tcl_Interp * interp,
...
int
TclCombinedIsoKin2D01Command (ClientData clienData, Tcl_Interp * interp,
                              int argc, TCL_Char ** argv,
                              TclModelBuilder * theBuilder)
{
    YS_Evolution *theModel = 0;
    ...
    theModel = new CombinedIsoKin2D01 (tag, iso_ratio, kin_ratio,
                                       ...
                                       minIsoFactor, *kpx_pos, *kpx_neg,
                                       *kpy_pos, *kpy_neg, deform, dir);
                         ...
                         TCL_Char ** argv, TclModelBuilder * theBuilder)
{
    ...
    theModel = new Kinematic2D02 (tag, minIsoFactor, *ys,
                                  *theMatX, *theMatY, algo, resfact, appfact,
                                  dir);
...
int
TclPeakOriented2D02Command (ClientData clienData, Tcl_Interp * interp,
                            int argc, TCL_Char ** argv,
                            TclModelBuilder * theBuilder)
{
    YS_Evolution *theModel = 0;
    ...
    // Parsing was successful, allocate the material
    theModel =
        new PeakOriented2D02 (tag, minIsoFactor, *ys, *kinX, *kinY, *isoX,
                              *isoY, algo);
...
int
TclCombinedIsoKin2D02Command (ClientData clienData, Tcl_Interp * interp,
                              int argc, TCL_Char ** argv,
                              TclModelBuilder * theBuilder)
{
    YS_Evolution *theModel = 0;
    ...
    // Parsing was successful, allocate the material
    theModel =
        new CombinedIsoKin2D02 (tag, minIsoFactor, isoRatio, kinRatio, *ys,
                                *kinX, *kinY, *isoXPos, *isoXNeg, *isoYPos,
                                *isoYNeg, deform, algo, resfact, appfact,
                                dir);
...
int
TclModelBuilderYS_EvolutionModelCommand (ClientData clientData,
