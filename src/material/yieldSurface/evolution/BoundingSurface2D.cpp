...
BoundingSurface2D::BoundingSurface2D (int tag, int classTag,
                                      double min_iso_factor, double iso_ratio,
                                      double kin_ratio,
...
int
BoundingSurface2D::revertToLastCommit (void)
{
...
const Vector &
BoundingSurface2D::getEquiPlasticStiffness (void)
{
...
void
BoundingSurface2D::setTrialPlasticStrains (double ep, const Vector & f,
                                           const Vector & g)
{
...
double
BoundingSurface2D::getIsoPlasticStiffness (int dir)
{
    return 0;
}

double
BoundingSurface2D::getKinPlasticStiffness (int dir)
{
    return 0;
}
...
void
BoundingSurface2D::Print (OPS_Stream & s, int flag)
{
    s << "BoundingSurface2D \n";
