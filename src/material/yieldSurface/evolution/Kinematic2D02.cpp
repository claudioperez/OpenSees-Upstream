...
Kinematic2D02::Kinematic2D02 (int tag, double min_iso_factor,
                              ...
                              int algo, double resfact, double appfact,
                              double dir):
BkStressLimSurface2D (tag, KINEMATIC2D02_CLASSTAG, min_iso_factor, 0.0, 1.0,
                      lim_surface, kpx, kpy, nullMat, nullMat, nullMat,
                      nullMat, algo, resfact, appfact, dir)
{
...
*/
void
Kinematic2D02::Print (OPS_Stream & s, int flag)
{
    s << "Kinematic2D02 \n";
