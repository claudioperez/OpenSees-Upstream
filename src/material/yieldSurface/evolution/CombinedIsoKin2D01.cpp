...
CombinedIsoKin2D01::CombinedIsoKin2D01 (int tag,
                                        ...
                                        double shr_iso_ratio,
                                        double shr_kin_ratio,
...
PlasticHardening2D (tag, COMBINEDISOKIN2D01_CLASSTAG, min_iso_factor,
                    iso_ratio, kin_ratio, kpx_pos, kpx_neg, kpy_pos, kpy_neg,
                    dir)
{
...
YS_Evolution *
CombinedIsoKin2D01::getCopy (void)
{
    CombinedIsoKin2D01 *theCopy = new CombinedIsoKin2D01 (this->getTag (),
                                                          isotropicRatio,
                                                          kinematicRatio,
                                                          isotropicRatio_shrink,
                                                          kinematicRatio_shrink,
                                                          minIsoFactor,
                                                          *kpMatXPos,
                                                          *kpMatXNeg,
                                                          *kpMatYPos,
...
void
CombinedIsoKin2D01::Print (OPS_Stream & s, int flag)
{
