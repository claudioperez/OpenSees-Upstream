...
Vector
NullEvolution::vec_dim_1 (1);
Vector
NullEvolution::vec_dim_2 (2);
Vector
NullEvolution::vec_dim_3 (3);
...
/** No descriptions */
int
NullEvolution::evolveSurface (YieldSurface_BC * ys, double magPlasticDefo,
...
NullEvolution::getCopy ()
{
    ...
    if (dimension == 1)
        ...
        copy =
            new NullEvolution (getTag (), isotropicFactor (0),
                               isotropicFactor (1));
    else if (dimension == 3)
        copy =
            new NullEvolution (getTag (), isotropicFactor (0),
                               isotropicFactor (1), isotropicFactor (2));
    else
        copy = 0;
    return copy;
}
...
/** No descriptions */
const Vector &
NullEvolution::getEquiPlasticStiffness ()
{
    if (dimension == 1)
        return vec_dim_1;
    else if (dimension == 2)
        ...
        opserr <<
            "NullEvolution::getEquiPlasticStiffness() - error dimension\n";

    return vec_dim_3;
}

double
NullEvolution::getTrialPlasticStrains (int dof)
{
    return 0;
}

double
NullEvolution::getCommitPlasticStrains (int dof)
{
    return 0;
}
...
/** No descriptions */
int
NullEvolution::getResponse (int responseID, Information & info)
{
    return 0;
}
...
/** No descriptions */
Response *
NullEvolution::setResponse (char * *argv, int argc, Information & info)
{
    return 0;
}
...
/** No descriptions */
int
NullEvolution::commitState (int status)
{
    return 0;
}
...
/** No descriptions */
int
NullEvolution::revertToLastCommit ()
{
    return 0;
}
