...
CombinedIsoKin2D02::CombinedIsoKin2D02 (int tag, double min_iso_factor,
                                        ...
                                        bool isDeformable,
                                        int algo, double resfact,
                                        double appfact, double dir):
BkStressLimSurface2D (tag, -1, min_iso_factor, iso_ratio, kin_ratio,
                      lim_surface, kinX, kinY, isoXPos, isoXNeg, isoYPos,
                      isoYNeg, algo, resfact, appfact, dir)
{
...
CombinedIsoKin2D02::getCopy ()
{
    CombinedIsoKin2D02 *theCopy = new
        CombinedIsoKin2D02 (getTag (), minIsoFactor,
                            isotropicRatio_orig, kinematicRatio_orig,
                            *limSurface, *kinMatX, *kinMatY,
                            *isoMatXPos, *isoMatXNeg, *isoMatYPos,
                            *isoMatYNeg,
                            deformable, resAlgo, resFactor, appFactor,
                            direction_orig);
    return theCopy;
}
...
void
CombinedIsoKin2D02::Print (OPS_Stream & s, int flag)
{
