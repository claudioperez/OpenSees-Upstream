...
BkStressLimSurface2D (tag, -1, min_iso_factor, 0.5, 0.5,
                      lim_surface,
                      kinX, kinY, isoX, isoX, isoY, isoY, algo, 0.0, 0.0, 0.0)
{
...
YS_Evolution *
PeakOriented2D02::getCopy ()
{
    PeakOriented2D02 *theMat = new
        PeakOriented2D02 (getTag (), minIsoFactor, *limSurface, *kinMatX,
                          *kinMatY,
...
void
PeakOriented2D02::Print (OPS_Stream & s, int flag)
{
    s << "PeakOriented2D02 \n";
