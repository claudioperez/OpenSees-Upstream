...
NullEvolution
NullYS2D::evolModel (0, 1e+20, 1e+20);
...
void
NullYS2D::getGradient (double &gx, double &gy, double x, double y)
{
...
double
NullYS2D::getSurfaceDrift (double x, double y)
{
    return -1;
}

YieldSurface_BC *
NullYS2D::getCopy (void)
{
...
int
NullYS2D::displaySelf (Renderer & theViewer, int displayMode, float fact)
{
    return 0;
}

void
NullYS2D::Print (OPS_Stream & s, int flag)
{
