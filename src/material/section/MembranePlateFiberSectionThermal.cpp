...
MembranePlateFiberSectionThermal::MembranePlateFiberSectionThermal(int tag,
                                                                   ...
                                                                   NDMaterial
                                                                   &
                                                                   Afiber):SectionForceDeformation
    (tag, SEC_TAG_MembranePlateFiberSectionThermal), strainResultant(8)
{
    this->h = thickness;
...
//mass per unit area
double MembranePlateFiberSectionThermal::getRho()
{
...
getTemperatureStress(const Vector & dataMixed)
{
    ...
    sTData[1] =
        fabs(dataTempe[0] -
             dataTempe[16]) * 12e-6 * fabs(ThermalTangent[0]) * h * h /
        12 / 0.7;
    return *sT;
}
...
int MembranePlateFiberSectionThermal::sendSelf(int commitTag,
                                               Channel & theChannel)
{
    int res = 0;
...
int MembranePlateFiberSectionThermal::recvSelf(int commitTag,
                                               Channel & theChannel,
                                               FEM_ObjectBroker &
                                               theBroker)
{
...
Response *MembranePlateFiberSectionThermal::setResponse(const char **argv,
                                                        int argc,
                                                        OPS_Stream &
                                                        output)
{
...
int MembranePlateFiberSectionThermal::getResponse(int responseID,
                                                  Information & secInfo)
{
    switch (responseID) {
    case 1:
