...
OPS_ParallelSection ()
{
    ...
    int
        numMaterials = OPS_GetNumRemainingInputArgs ();
    ...
    SectionForceDeformation **
        theMats = new SectionForceDeformation *[numMaterials];
    ...
    for (int i = 0; i < numMaterials; i++)
      {
          ...
          SectionForceDeformation *
              theMat = OPS_getSectionForceDeformation (tagI);
...
int
ParallelSection::recvSelf (int cTag, Channel & theChannel,
...
Response *
ParallelSection::setResponse (const char **argv, int argc,
                              OPS_Stream & output)
{
