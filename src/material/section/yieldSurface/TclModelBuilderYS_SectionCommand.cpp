...
TclModelBuilderYS_SectionCommand (ClientData clienData, Tcl_Interp * interp,
                                  ...
                                  TclModelBuilder * theBuilder)
{
    ...
    if (strcmp (argv[1], "YS_Section2D01") == 0 ||
          ...
          if (argc < 7)
            {
                ...
                printCommand (argc, argv);
                opserr <<
                    "Want: section YS_Section2D01 tag? E? A? Iz? ysTag? <algo?>"
                    << endln;
                return 0;
            }
             ...
             strcmp (argv[1], "YS_Section2d02") == 0)
      {
          ...
          if (argc < 8)
            {
                ...
                printCommand (argc, argv);
                opserr <<
                    "Want: section YS_Section2D01 tag? E? A? Iz? maxPlastRot? ysTag? <algo?>"
                    << endln;
                return 0;
            }
          ...
          theModel =
              new YS_Section2D02 (tag, E, A, Iz, maxPlstkRot, ys, useKr);
      }
...
// Added by S.Gajan <sgajan@ucdavis.edu>
             ...
             (strcmp (argv[1], "SoilFootingSection2d") == 0))
      {
          ...
          if (argc < 10)
            {
                ...
                printCommand (argc, argv);
                opserr <<
                    "Want: section soilFootingSection2d tag? FS? Vult? L? Kv? dL?"
                    << endln;
                return 0;
            }
          ...
          theModel =
              new SoilFootingSection2d (tag, FS, Vult, L, Kv, Kh, Rv, deltaL);
      }
