...
ID
YieldSurfaceSection2d::code (2);
Vector
YieldSurfaceSection2d::dele (2);
Vector
YieldSurfaceSection2d::surfaceForce (2);
Matrix
YieldSurfaceSection2d::G (2, 1);
Matrix
YieldSurfaceSection2d::Ktp (2, 2);
...
eCommit (2), sCommit (2), ks (2, 2), use_Kr (use_kr),
split_step (false)
{
    code (0) = SECTION_RESPONSE_P;      // P is the first quantity
    code (1) = SECTION_RESPONSE_MZ;     // Mz is the second
