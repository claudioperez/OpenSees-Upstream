...
ID
FiberSectionWarping3d::code (6);

#ifdef OPS_API_COMMANDLINE
void *
OPS_FiberSectionWarping3d ()
{
...
Response *
FiberSectionWarping3d::setResponse (const char **argv, int argc,
                                    OPS_Stream & output)
{
...
int
FiberSectionWarping3d::setParameter (const char **argv, int argc,
                                     Parameter & param)
{
    if (argc < 3)
        return -1;
