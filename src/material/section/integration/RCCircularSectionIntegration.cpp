...
OPS_RCCircularSection ()
{
    ...
    RCCircularSectionIntegration rcsect (d, As, cover, ncore, ncover, nwedge,
                                         nsteel);
...
void
RCCircularSectionIntegration::getFiberLocations (int nFibers, double *yi,
                                                 double *zi)
{
...
void
RCCircularSectionIntegration::getLocationsDeriv (int nFibers, double *dyidh,
                                                 double *dzidh)
{
