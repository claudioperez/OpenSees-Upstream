...
void
TubeSectionIntegration::getFiberLocations (int nFibers, double *yi,
                                           double *zi)
{
...
int
TubeSectionIntegration::updateParameter (int parameterID, Information & info)
{
    switch (parameterID)
      {
      case 1:
...
void
TubeSectionIntegration::getLocationsDeriv (int nFibers, double *dyidh,
                                           double *dzidh)
{
