...
ID
FiberSectionGJThermal::code (4);
Vector
FiberSectionGJThermal::s (4);
Matrix
FiberSectionGJThermal::ks (4, 4);

// constructors:
FiberSectionGJThermal::FiberSectionGJThermal (int tag, int num,
                                              Fiber ** fibers, double gj):
...
Response *
FiberSectionGJThermal::setResponse (const char **argv, int argc,
                                    OPS_Stream & output)
{
...
int
FiberSectionGJThermal::setParameter (const char **argv, int argc,
                                     Parameter & param)
{
    if (argc < 3)
        return 0;
...
double
FiberSectionGJThermal::determineFiberTemperature (const Vector & DataMixed,
                                                  double fiberLocy,
                                                  double fiberLocz)
{
    double FiberTemperature = 0;
    if (DataMixed.Size () == 18)
      {
          ...
          if (fiberLocy <= dataTempe[1])
            {
                opserr << "FiberSectionGJThermal " << this->
                    getTag () << ":: fiber locy " << fiberLocy <<
