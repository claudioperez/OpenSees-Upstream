...
LayeredShellFiberSection::LayeredShellFiberSection(int tag,
    ...
    (tag, SEC_TAG_LayeredShellFiberSection), strainResultant(8)
{
...
//mass per unit area
double LayeredShellFiberSection::getRho()
{
...
Response *LayeredShellFiberSection::setResponse(const char **argv,
                                                int argc,
                                                OPS_Stream & output)
{
...
int LayeredShellFiberSection::getResponse(int responseID,
                                          Information & secInfo)
{
    switch (responseID) {
    case 1:
...
int LayeredShellFiberSection::setTrialSectionDeformation(const Vector &
...
int LayeredShellFiberSection::sendSelf(int commitTag, Channel & theChannel)
{
    int res = 0;
...
int LayeredShellFiberSection::recvSelf(int commitTag, Channel & theChannel,
