...
extern void *
OPS_ElasticSection (void);
extern void *
OPS_ElasticWarpingShearSection2d ();
extern void *
OPS_ElasticTubeSection3d (void);
extern void *
OPS_WFSection2d (void);
extern void *
OPS_RCCircularSection (void);
extern void *
OPS_RCSection2d (void);
extern void *
OPS_RCTBeamSection2d (void);
extern void *
OPS_RCTunnelSection (void);
extern void *
OPS_UniaxialSection (void);
extern void *
OPS_TubeSection (void);
extern void *
OPS_ParallelSection (void);
extern void *
OPS_Bidirectional (void);
extern void *
OPS_Elliptical2 (void);

int
TclCommand_addFiberSection (ClientData clientData, Tcl_Interp * interp,
...
TclCommand_addFiberSectionThermal (ClientData clientData, Tcl_Interp * interp,
                                   ...
                                   TclModelBuilder * theBuilder);
int
buildSectionThermal (Tcl_Interp * interp,
...
TclModelBuilderYS_SectionCommand (ClientData clientData, Tcl_Interp * interp,
                                  int argc, TCL_Char ** argv,
                                  TclModelBuilder * theTclBuilder);

int
TclModelBuilderSectionCommand (ClientData clientData, Tcl_Interp * interp,
                               ...
                               TclModelBuilder * theTclBuilder)
{
    ...
    if (argc < 3)
      {
          ...
          opserr << "Want: section type? tag? <specific material args>" <<
              endln;
          return TCL_ERROR;
      }
    ...
    if (strcmp (argv[1], "Elastic") == 0)
      ...
      {
          void *
              theMat = OPS_ElasticWarpingShearSection2d ();
          if (theMat != 0)
              theSection = (SectionForceDeformation *) theMat;
          else
              return TCL_ERROR;
    ...
    // Check argv[1] for section type
      ...
      {
          void *
              theMat = OPS_ElasticTubeSection3d ();
          if (theMat != 0)
              theSection = (SectionForceDeformation *) theMat;
          else
              return TCL_ERROR;
    ...
    else if (strcmp (argv[1], "Tube") == 0)
      {
          ...
          TubeSectionIntegration
          tubesect (D, t, nfw, nfr);

          int
              numFibers = tubesect.getNumFibers ();
          ...
          if (argc > 8)
            {
                ...
                NDMaterial *
                    theSteel = OPS_getNDMaterial (matTag);
                ...
                NDMaterial **
                    theMats = new NDMaterial *[numFibers];
                ...
                if (strcmp (argv[8], "-nd") == 0)
                    theSection =
                        new NDFiberSection3d (tag, numFibers, theMats,
                                              tubesect, shape);
                if (strcmp (argv[8], "-ndWarping") == 0)
                    theSection =
                        new NDFiberSectionWarping2d (tag, numFibers, theMats,
                                                     tubesect, shape);
            ...
            {
                UniaxialMaterial *
                    theSteel = OPS_getUniaxialMaterial (matTag);
                ...
                UniaxialMaterial **
                    theMats = new UniaxialMaterial *[numFibers];

                tubesect.arrangeFibers (theMats, theSteel);

                // Parsing was successful, allocate the section
                theSection =
                    new FiberSection2d (tag, numFibers, theMats, tubesect);
             ...
             || strcmp (argv[1], "Aggregator") == 0)
      {
          if (argc < 5)
            {
                opserr << "WARNING insufficient arguments\n";
                opserr <<
                    "Want: section Aggregator tag? uniTag1? code1? ... <-section secTag?>"
                    << endln;
                return TCL_ERROR;
            }
                ...
                if (strcmp (argv[ii], "-section") == 0 && ++ii < argc)
                  {
                      if (Tcl_GetInt (interp, argv[ii], &secTag) != TCL_OK)
                        {
                            opserr << "WARNING invalid Aggregator tag" <<
                                endln;
                            return TCL_ERROR;
                        }
          ...
          if (nArgs % 2 != 0)
            {
                opserr <<
                    "WARNING improper number of arguments for Aggregator" <<
                    endln;
                return TCL_ERROR;
            }
          ...
          if (theMats == 0)
            {
                opserr <<
                    "TclModelBuilderSection (Aggregator) -- unable to create uniaxial array"
                    << endln;
                return TCL_ERROR;
            }
          ...
          if (theSec)
              theSection =
                  new SectionAggregator (tag, *theSec, nMats, theMats, codes);
          else
    ...
    //--- Adding Thermo-mechanical Sections:[BEGIN]   by UoE OpenSees Group ---//  
        ...
        return TclCommand_addFiberSectionThermal (clientData, interp, argc,
                                                  argv, theTclBuilder);
    ...
    else if (strcmp (argv[1], "ElasticMembranePlateSection") == 0)
      {
          if (argc < 5)
            {
                opserr << "WARNING insufficient arguments\n";
                opserr <<
                    "Want: section ElasticMembranePlateSection tag? E? nu? h? <rho?> <Ep_mod?>"
                    << endln;
                return TCL_ERROR;
            }
          ...
          if (Tcl_GetInt (interp, argv[2], &tag) != TCL_OK)
            {
                opserr <<
                    "WARNING invalid section ElasticMembranePlateSection tag"
                    << endln;
                return TCL_ERROR;
            }
          ...
          if (Tcl_GetDouble (interp, argv[3], &E) != TCL_OK)
            {
                opserr << "WARNING invalid E" << endln;
                opserr << "ElasticMembranePlateSection section: " << tag <<
                    endln;
                return TCL_ERROR;
            }
    ...
    else if (strcmp (argv[1], "PlateFiber") == 0)
      {
          ...
          NDMaterial *
              theMaterial = OPS_getNDMaterial (matTag);
          if (theMaterial == 0)
            {
                opserr << "WARNING nD material does not exist\n";
    ...
    //start Yuli Huang & Xinzheng Lu LayeredShellFiberSection
    else if (strcmp (argv[1], "LayeredShell") == 0)
      {
          if (argc < 6)
            {
                ...
                opserr <<
                    "Want: section LayeredShell tag? nLayers? matTag1? h1? ... matTagn? hn? "
                    << endln;
                return TCL_ERROR;
            }
          ...
          for (int iLayer = 0; iLayer < nLayers; iLayer++)
            {
                if (Tcl_GetInt (interp, argv[4 + 2 * iLayer], &matTag) !=
                    TCL_OK)
                  {
                      opserr << "WARNING invalid matTag" << endln;
                      opserr << "LayeredShell section: " << tag << endln;
                ...
                if (Tcl_GetDouble (interp, argv[5 + 2 * iLayer], &h) !=
                    TCL_OK)
                  {
                      opserr << "WARNING invalid h" << endln;
                      opserr << "LayeredShell section: " << tag << endln;
          ...
          theSection =
              new LayeredShellFiberSection (tag, nLayers, thickness, theMats);
          if (thickness != 0)
              delete[]thickness;
          if (theMats != 0)
              delete[]theMats;
    ...
    //-----Thermo-mechanical shell sections added by L.Jiang [SIF] 
    else if (strcmp (argv[1], "PlateFiberThermal") == 0)
      {
          if (argc < 5)
            {
                opserr << "WARNING insufficient arguments\n";
                opserr << "Want: section PlateFiberThermal tag? matTag? h? "
                    << endln;
                return TCL_ERROR;
            }
          ...
          if (Tcl_GetInt (interp, argv[2], &tag) != TCL_OK)
            {
                opserr << "WARNING invalid section PlateFiberThermal tag" <<
                    endln;
                return TCL_ERROR;
            }
          ...
          theSection =
              new MembranePlateFiberSectionThermal (tag, h, *theMaterial);
      }
    ...
    // LayeredShellFiberSectionThermal based on the LayeredShellFiberSectionThermal by Yuli Huang & Xinzheng Lu
    else if (strcmp (argv[1], "LayeredShellThermal") == 0)
      {
          if (argc < 6)
            {
                opserr << "WARNING insufficient arguments" << endln;
                opserr <<
                    "Want: section LayeredShellThermal tag? nLayers? matTag1? h1? ... matTagn? hn? "
                    << endln;
                return TCL_ERROR;
            }
          ...
          if (Tcl_GetInt (interp, argv[2], &tag) != TCL_OK)
            {
                opserr << "WARNING invalid section LayeredShellThermal tag" <<
                    endln;
                return TCL_ERROR;
            }
          ...
          for (int iLayer = 0; iLayer < nLayers; iLayer++)
            {
                if (Tcl_GetInt (interp, argv[4 + 2 * iLayer], &matTag) !=
                  ...
                  {
                      opserr << "WARNING invalid matTag" << endln;
                      opserr << "LayeredShellThermal section: " << tag <<
                          endln;
                      return TCL_ERROR;
                  }
          ...
          theSection =
              new LayeredShellFiberSectionThermal (tag, nLayers, thickness,
                                                   theMats);
          if (thickness != 0)
              delete[]thickness;
          if (theMats != 0)
    ...
    //end L.Jiang [SIF] added based on LayeredShellFiberSectionThermal section created by Yuli Huang & Xinzheng Lu ----
    ...
    else if (strcmp (argv[1], "Iso2spring") == 0)
      {
          ...
          theSection =
              new Isolator2spring (tag, tol, k1, Fy, kb, kvo, hb, Pe, Po);
      }

    else
      {
          theSection =
              TclModelBuilderYS_SectionCommand (clientData, interp, argc,
                                                argv, theTclBuilder);
      }
    ...
    if (OPS_addSectionForceDeformation (theSection) != true)
      {
          ...
          delete
              theSection;       // invoke the material objects destructor, otherwise mem leak
          return TCL_ERROR;
      }
...
buildSectionInt (Tcl_Interp * interp, TclModelBuilder * theTclModelBuilder,
                 int secTag, UniaxialMaterial & theTorsion,
                 int NStrip1, double t1, int NStrip2, double t2, int NStrip3,
                 double t3);
                            ...
                            TclModelBuilder * theTclModelBuilder)
{
    ...
    int
        maxNumPatches = 30;
    int
        maxNumReinfLayers = 30;
    int
        NDM = theTclModelBuilder->getNDM ();
    ...
    int
        brace = 3;              // Start of recursive parse
          ...
          if (strcmp (argv[iarg], "-torsion") == 0 && iarg + 1 < argc)
            {
                int
                    torsionTag = 0;
                if (Tcl_GetInt (interp, argv[brace + 1], &torsionTag) !=
                    TCL_OK)
                  {
                               ...
                               TclModelBuilder * theTclModelBuilder)
{
    ...
    // build the fiber section (for analysis)
    if (buildSectionInt
        (interp, theTclModelBuilder, secTag, *torsion, NStrip1, t1, NStrip2,
         t2, NStrip3, t3) != TCL_OK)
      {
          opserr << "WARNING - error constructing the section\n";
          return TCL_ERROR;
      }
                     ...
                     TCL_Char ** argv, TclModelBuilder * theTclModelBuilder)
{
    ...
    if (currentSectionTag == 0)
      {
          opserr <<
              "WARNING subcommand 'patch' is only valid inside a 'section' command\n";
          return TCL_ERROR;
      }
    ...
    if (strcmp (argv[1], "quad") == 0 || strcmp (argv[1], "quadr") == 0)
      {
          ...
          if (Tcl_GetInt (interp, argv[argi++], &matTag) != TCL_OK)
            {
                opserr <<
                    "WARNING invalid matTag: patch quad matTag numSubdivIJ numSubdivJK yVertI zVertI yVertJ zVertJ yVertK zVertK yVertL zVertL\n";
                return TCL_ERROR;
            }
          //opserr << "\n\tmatTag: " << matTag;
          ...
          if (Tcl_GetInt (interp, argv[argi++], &numSubdivIJ) != TCL_OK)
            {
                opserr <<
                    "WARNING invalid numSubdivIJ: patch quad matTag numSubdivIJ numSubdivJK yVertI zVertI yVertJ zVertJ yVertK zVertK yVertL zVertL\n";
                return TCL_ERROR;
            }
          ...
          if (Tcl_GetInt (interp, argv[argi++], &numSubdivJK) != TCL_OK)
            {
                opserr <<
                    "WARNING invalid numSubdivJK: patch quad matTag numSubdivIJ numSubdivJK yVertI zVertI yVertJ zVertJ yVertK zVertK yVertL zVertL\n";
                return TCL_ERROR;
            }
          ...
          for (j = 0; j < 4; j++)
            {
                //opserr << "\n\tVertexCoord: " << j;
                if (Tcl_GetDouble (interp, argv[argi++], &vertexCoordY) !=
                    TCL_OK)
                  {
                      opserr <<
                          "WARNING invalid Coordinate y: ...yVertI zVertI yVertJ zVertJ yVertK zVertK yVertL zVertL\n";
                      return TCL_ERROR;
                  }
                //opserr << "\n\t\tvertexCoordY: " << vertexCoordY; 

                if (Tcl_GetDouble (interp, argv[argi++], &vertexCoordZ) !=
                    TCL_OK)
                  {
                      opserr <<
                          "WARNING invalid Coordinate z: ...yVertI zVertI yVertJ zVertJ yVertK zVertK yVertL zVertL\n";
                      return TCL_ERROR;
                  }
          ...
          SectionRepres *
              sectionRepres = theTclModelBuilder->getSectionRepres (secTag);
          if (sectionRepres == 0)
            {
          ...
          FiberSectionRepr *
              fiberSectionRepr = (FiberSectionRepr *) sectionRepres;
          ...
          int
              error = fiberSectionRepr->addPatch (*patch);
          delete
              patch;
    ...
    // check argv[1] for type of patch  and create the object
             ...
             strcmp (argv[1], "rectangular") == 0)
      {
          ...
          if (argc < 9)
            {
                opserr <<
                    "WARNING invalid number of parameters: patch quad matTag numSubdivIJ numSubdivJK yVertI zVertI yVertK zVertK\n";
                return TCL_ERROR;
            }
    ...
    else if (strcmp (argv[1], "circ") == 0)
      {
          ...
          if (argc < 11)
            {
                opserr <<
                    "WARNING invalid number of parameters: patch circ matTag numSubdivCirc numSubdivRad yCenter zCenter intRad extRad startAng endAng\n";
                return TCL_ERROR;
            }
          ...
          if (Tcl_GetInt (interp, argv[argi++], &matTag) != TCL_OK)
            {
                opserr <<
                    "WARNING invalid matTag: patch circ matTag numSubdivCirc numSubdivRad yCenter zCenter intRad extRad startAng endAng\n";
                return TCL_ERROR;
            }
          //opserr << "\n\tmatTag: " << matTag;
          ...
          if (Tcl_GetInt (interp, argv[argi++], &numSubdivCirc) != TCL_OK)
            {
                opserr <<
                    "WARNING invalid numSubdivCirc: patch circ matTag numSubdivCirc numSubdivRad yCenter zCenter intRad extRad startAng endAng\n";
                return TCL_ERROR;
            }
          ...
          if (Tcl_GetInt (interp, argv[argi++], &numSubdivRad) != TCL_OK)
            {
                opserr <<
                    "WARNING invalid numSubdivRad: patch circ matTag numSubdivCirc numSubdivRad yCenter zCenter intRad extRad startAng endAng\n";
                return TCL_ERROR;
            }
          ...
          if (Tcl_GetDouble (interp, argv[argi++], &yCenter) != TCL_OK)
            {
                opserr <<
                    "WARNING invalid yCenter: patch circ matTag numSubdivCirc numSubdivRad yCenter zCenter intRad extRad startAng endAng\n";
                return TCL_ERROR;
            }
          //opserr << "\n\tyCenter: " << yCenter;
          ...
          if (Tcl_GetDouble (interp, argv[argi++], &zCenter) != TCL_OK)
            {
                opserr <<
                    "WARNING invalid zCenter: patch circ matTag numSubdivCirc numSubdivRad yCenter zCenter intRad extRad startAng endAng\n";
                return TCL_ERROR;
            }
          //opserr << "\n\tzCenter: " << zCenter;
          ...
          if (Tcl_GetDouble (interp, argv[argi++], &intRad) != TCL_OK)
            {
                opserr <<
                    "WARNING invalid intRad: patch circ matTag numSubdivCirc numSubdivRad yCenter zCenter intRad extRad startAng endAng\n";
                return TCL_ERROR;
            }
          //opserr << "\n\tintRad: " << intRad;
          ...
          if (Tcl_GetDouble (interp, argv[argi++], &extRad) != TCL_OK)
            {
                opserr <<
                    "WARNING invalid extRad: patch circ matTag numSubdivCirc numSubdivRad yCenter zCenter intRad extRad startAng endAng\n";
                return TCL_ERROR;
            }
          //opserr << "\n\textRad: " << extRad;
          ...
          if (Tcl_GetDouble (interp, argv[argi++], &startAng) != TCL_OK)
            {
                opserr <<
                    "WARNING invalid startAng: patch circ matTag numSubdivCirc numSubdivRad yCenter zCenter intRad extRad startAng endAng\n";
                return TCL_ERROR;
            }
          //opserr << "\n\tstartAngle: " << startAng;
          ...
          if (Tcl_GetDouble (interp, argv[argi++], &endAng) != TCL_OK)
            {
                opserr <<
                    "WARNING invalid endAng: patch circ matTag numSubdivCirc numSubdivRad yCenter zCenter intRad extRad startAng endAng\n";
                return TCL_ERROR;
            }
          //opserr << "\n\tendAng: " << endAng;
          ...
          CircPatch *
              patch = new CircPatch (matTag, numSubdivCirc, numSubdivRad,
                     ...
                     TCL_Char ** argv, TclModelBuilder * theTclModelBuilder)
{
    ...
    if (currentSectionTag == 0)
      {
          opserr <<
              "WARNING subcommand 'fiber' is only valid inside a 'section' command\n";
          return TCL_ERROR;
      }
    ...
    FiberSectionRepr *
        fiberSectionRepr = (FiberSectionRepr *) sectionRepres;
    int
        numFibers = fiberSectionRepr->getNumFibers ();
    ...
    if (NDM == 2)
      {
          ...
          if (currentSectionIsND)
            {
                NDMaterial *
                    material = OPS_getNDMaterial (matTag);
                if (material == 0)
                  {
          ...
          else
            {
                ...
                if (material == 0)
                  {
                      opserr <<
                          "WARNING invalid UniaxialMaterial ID for patch\n";
                      return TCL_ERROR;
                  }
                theFiber =
                    new UniaxialFiber2d (numFibers, *material, area, yLoc);
            }
          ...
          if (currentSectionIsND)
            {
                ...
                theFiber =
                    new NDFiber3d (numFibers, *material, area, yLoc, zLoc);
            }
          else
            {
                UniaxialMaterial *
      ...
      {
          opserr <<
              "WARNING fiber command for FiberSection only for 2 or 3d \n";
          return TCL_ERROR;
      }

    // add patch to section representation
    int
        error = fiberSectionRepr->addFiber (*theFiber);
                      ...
                      TCL_Char ** argv, TclModelBuilder * theTclModelBuilder)
{
    ...
    if (currentSectionTag == 0)
      {
          opserr <<
              "WARNING subcommand 'Hfiber' is only valid inside a 'section' command\n";
          return TCL_ERROR;
      }
    ...
    if (argc < 5)
      {
          opserr <<
              "WARNING invalid num args: Hfiber yLoc zLoc area matTag\n";
          return TCL_ERROR;
      }
    ...
    FiberSectionRepr *
        fiberSectionHRepr = (FiberSectionRepr *) sectionHRepres;
    int
        numHFibers = fiberSectionHRepr->getNumHFibers ();
    ...
    double
        ...
        Harea;
    int
        HNDM = theTclModelBuilder->getNDM ();
    ...
    UniaxialMaterial *
        Hmaterial = OPS_getUniaxialMaterial (matHTag);
    ...
    if (HNDM == 2)
      {
          ...
          theHFiber =
              new UniaxialFiber2d (numHFibers, *Hmaterial, Harea, yHLoc);
          if (theHFiber == 0)
            {
    ...
    else if (HNDM == 3)
      {
          ...
          theHFiber =
              new UniaxialFiber3d (numHFibers, *Hmaterial, Harea,
                                   fiberHPosition);
          if (theHFiber == 0)
            {
                opserr << "WARNING unable to allocate Hfiber \n";
      ...
      {
          opserr <<
              "WARNING Hfiber command for FiberSection only fo 2 or 3d \n";
          return TCL_ERROR;
      }

    // add patch to section representation
    int
        error = fiberSectionHRepr->addHFiber (*theHFiber);
    ...
    if (strcmp (argv[1], "straight") == 0)
      {
          if (argc < 9)
            {
                opserr <<
                    "WARNING invalid number of parameters: layer straight matTag numReinfBars reinfBarArea yStartPt zStartPt yEndPt zEndPt\n";
                return TCL_ERROR;
            }
          ...
          if (Tcl_GetInt (interp, argv[argi++], &matTag) != TCL_OK)
            {
                opserr <<
                    "WARNING invalid matTag: layer straight matTag numReinfBars reinfBarArea  yStartPt zStartPt yEndPt zEndPt\n";
                return TCL_ERROR;
            }
          //opserr << "\n\tmatTag: " << matTag;
          ...
          if (Tcl_GetInt (interp, argv[argi++], &numReinfBars) != TCL_OK)
            {
                opserr <<
                    "WARNING invalid numReinfBars: layer straight matTag numReinfBars reinfBarArea  yStartPt zStartPt yEndPt zEndPt\n";
                return TCL_ERROR;
            }
          ...
          if (Tcl_GetDouble (interp, argv[argi++], &reinfBarArea) != TCL_OK)
            {
                opserr <<
                    "WARNING invalid reinfBarArea: layer straight matTag numReinfBars reinfBarArea  yStartPt zStartPt yEndPt zEndPt\n";
                return TCL_ERROR;
            }
          ...
          if (Tcl_GetDouble (interp, argv[argi++], &yStartPt) != TCL_OK)
            {
                opserr <<
                    "WARNING invalid yStartPt: layer straight matTag numReinfBars reinfBarArea  yStartPt zStartPt yEndPt zEndPt\n";
                return TCL_ERROR;
            }
          //opserr << "\n\tyStartPt: " << yStartPt;
          ...
          if (Tcl_GetDouble (interp, argv[argi++], &zStartPt) != TCL_OK)
            {
                opserr <<
                    "WARNING invalid zStartPt: layer straight matTag numReinfBars reinfBarArea  yStartPt zStartPt yEndPt zEndPt\n";
                return TCL_ERROR;
            }
          //opserr << "\n\tzStartPt: " << zStartPt;
          ...
          if (Tcl_GetDouble (interp, argv[argi++], &yEndPt) != TCL_OK)
            {
                opserr <<
                    "WARNING invalid yEndPt: layer straight matTag numReinfBars reinfBarArea  yStartPt zStartPt yEndPt zEndPt\n";
                return TCL_ERROR;
            }
          //opserr << "\n\tyEndPt: " << yEndPt;
          ...
          if (Tcl_GetDouble (interp, argv[argi++], &zEndPt) != TCL_OK)
            {
                opserr <<
                    "WARNING invalid zEndPt: layer straight matTag numReinfBars reinfBarArea  yStartPt zStartPt yEndPt zEndPt\n";
                return TCL_ERROR;
            }
          ...
          StraightReinfLayer *
              reinfLayer = new StraightReinfLayer (matTag,
          ...
          int
              error = fiberSectionRepr->addReinfLayer (*reinfLayer);
          delete
              reinfLayer;
    ...
    else if (strcmp (argv[1], "circ") == 0)
      {
          if (argc < 8)
            {
                opserr <<
                    "WARNING invalid number of parameters: layer circ matTag numReinfBars reinfBarArea yCenter zCenter arcRadius <startAng endAng>\n";
                return TCL_ERROR;
            }
          ...
          if (Tcl_GetInt (interp, argv[argi++], &matTag) != TCL_OK)
            {
                opserr <<
                    "WARNING invalid matTag: layer circ matTag numReinfBars reinfBarArea yCenter zCenter radius startAng endAng\n";
                return TCL_ERROR;
            }
          //opserr << "\n\tmatTag: " << matTag;
          ...
          if (Tcl_GetInt (interp, argv[argi++], &numReinfBars) != TCL_OK)
            {
                opserr <<
                    "WARNING invalid numReinfBars: layer circ matTag numReinfBars reinfBarArea yCenter zCenter radius startAng endAng\n";
                return TCL_ERROR;
            }
          //opserr << "\n\tnumReinfBars: " << numReinfBars;
          ...
          if (Tcl_GetDouble (interp, argv[argi++], &reinfBarArea) != TCL_OK)
            {
                opserr <<
                    "WARNING invalid reinfBarArea: layer circ matTag numReinfBars reinfBarArea yCenter zCenter radius startAng endAng\n";
                return TCL_ERROR;
            }
          //opserr << "\n\treinfBarArea: " << reinfBarArea;
          ...
          if (Tcl_GetDouble (interp, argv[argi++], &yCenter) != TCL_OK)
            {
                opserr <<
                    "WARNING invalid yCenter: layer circ matTag numReinfBars reinfBarArea yCenter zCenter radius startAng endAng\n";
                return TCL_ERROR;
            }
          //opserr << "\n\tyCenter: " << yCenter;
          ...
          if (Tcl_GetDouble (interp, argv[argi++], &zCenter) != TCL_OK)
            {
                opserr <<
                    "WARNING invalid zCenter: layer circ matTag numReinfBars reinfBarArea yCenter zCenter radius startAng endAng\n";
                return TCL_ERROR;
            }
          //opserr << "\n\tzCenter: " << zCenter;
          ...
          if (Tcl_GetDouble (interp, argv[argi++], &radius) != TCL_OK)
            {
                opserr <<
                    "WARNING invalid radius: layer circ matTag numReinfBars reinfBarArea yCenter zCenter radius startAng endAng\n";
                return TCL_ERROR;
            }
          //opserr << "\n\tradius: " << radius;
          ...
          if (argc > 9)
            {
                if (Tcl_GetDouble (interp, argv[argi++], &startAng) != TCL_OK)
                  {
                      opserr <<
                          "WARNING invalid startAng: layer circ matTag numReinfBars reinfBarArea yCenter zCenter radius startAng endAng\n";
                      return TCL_ERROR;
                  }
                //opserr << "\n\tstartAng: " << startAng;
                ...
                if (Tcl_GetDouble (interp, argv[argi++], &endAng) != TCL_OK)
                  {
                      opserr <<
                          "WARNING invalid endAng: layer circ matTag numReinfBars reinfBarArea yCenter zCenter radius startAng endAng\n";
                      return TCL_ERROR;
                  }
                //opserr << "\n\tendAng: " << endAng;
          ...
          if (anglesSpecified)
              // Construct arc
              reinfLayer =
                  new CircReinfLayer (matTag, numReinfBars, reinfBarArea,
    ...
    if (sectionRepres->getType () == SEC_TAG_FiberSection)
      {
          ...
          int
              numSectionRepresFibers = fiberSectionRepr->getNumFibers ();
          Fiber **
              sectionRepresFibers = fiberSectionRepr->getFibers ();
          ...
          ID
          fibersMaterial (numFibers - numSectionRepresFibers);
          Matrix
          fibersPosition (2, numFibers - numSectionRepresFibers);
          Vector
          fibersArea (numFibers - numSectionRepresFibers);
          ...
          if (NDM == 2)
                ...
                for (i = numSectionRepresFibers; i < numFibers; i++)
                  {
                      if (currentSectionIsND)
                        {
                            ndmaterial =
                                OPS_getNDMaterial (fibersMaterial (k));
                            if (ndmaterial == 0)
                              {
                                  opserr <<
                                      "WARNING invalid NDmaterial ID for patch\n";
                                  return TCL_ERROR;
                              }
                            fiber[i] =
                                new NDFiber2d (k, *ndmaterial, fibersArea (k),
                                               fibersPosition (0, k));
                        }
                      else
                        {
                            material =
                                OPS_getUniaxialMaterial (fibersMaterial (k));
                            if (material == 0)
                              {
                                  opserr <<
                                      "WARNING invalid UniaxialMaterial ID for patch\n";
                            ...
                            fiber[i] =
                                new UniaxialFiber2d (k, *material,
                                                     fibersArea (k),
                                                     fibersPosition (0, k));
                        }
                      if (fiber[i] == 0)
                ...
                if (currentSectionIsND)
                  {
                      if (currentSectionIsWarping)
                          section =
                              new NDFiberSectionWarping2d (secTag, numFibers,
                                                           fiber);
                      else
                          section =
                              new NDFiberSection2d (secTag, numFibers, fiber,
                                                    currentSectionComputeCentroid);
                  }
                else
                    section =
                        new FiberSection2d (secTag, numFibers, fiber,
                                            currentSectionComputeCentroid);
          ...
          else if (NDM == 3)
            {
                      ...
                      if (currentSectionIsND)
                        {
                            ...
                            fiber[i] =
                                new NDFiber3d (k, *ndmaterial, fibersArea (k),
                                               fiberPosition (0),
                                               fiberPosition (1));
                        }
                      else
                        {
                            ...
                            fiber[i] =
                                new UniaxialFiber3d (k, *material,
                                                     fibersArea (k),
                                                     fiberPosition);
                        }
                      if (fiber[k] == 0)
                ...
                if (currentSectionIsND)
                    section =
                        new NDFiberSection3d (secTag, numFibers, fiber,
                                              currentSectionComputeCentroid);
                else
                    section =
                        new FiberSection3d (secTag, numFibers, fiber,
                                            theTorsion,
                                            currentSectionComputeCentroid);
    ...
    if (sectionRepres->getType () == SEC_TAG_FiberSection)
      {
          ...
          int
              numSectionRepresHFibers = fiberSectionRepr->getNumHFibers ();
          Fiber **
              sectionRepresHFibers = fiberSectionRepr->getHFibers ();
          ...
          if (NDM == 2)
            {
                ...
                for (i = numSectionRepresFibers; i < numFibers; i++)
                  {
                      ...
                      fiber[i] =
                          new UniaxialFiber2d (k, *material, fibersArea (k),
                                               fibersPosition (0, k));
                      if (fiber[i] == 0)
                        {
                            opserr << "WARNING unable to allocate fiber \n";
                ...
                SectionForceDeformation *
                    section =
                    new FiberSection2dInt (secTag, numFibers, fiber,
                                           numHFibers, Hfiber, NStrip1, t1,
                                           NStrip2, t2, NStrip3, t3);
          ...
          else if (NDM == 3)
            {
                ...
                for (i = numSectionRepresFibers; i < numFibers; i++)
                  {
                      ...
                      fiber[i] =
                          new UniaxialFiber3d (k, *material, fibersArea (k),
                                               fiberPosition);
                      if (fibersArea (k) < 0)
                ...
                SectionForceDeformation *
                    section = 0;
                section =
                    new FiberSection3d (secTag, numFibers, fiber, theTorsion,
                                        currentSectionComputeCentroid);
                              ...
                              TclModelBuilder * theTclModelBuilder)
{
    ...
    if (NDM == 2)
      ...
      {
          UniaxialMaterial *
              theGJ = new ElasticMaterial (0, 1e10);
          section3d =
              new FiberSection3d (secTag, 0, 0, *theGJ,
                                  currentSectionComputeCentroid);
          section = section3d;
          delete
              theGJ;
    ...
    if (!theFile)
      {
          opserr << "section UCFiber - could not open file named " <<
              fileName;
          return TCL_ERROR;
      }
    else
      {
          ...
          while (theFile >> ycoord >> zcoord >> area >> prestrain >> garbage
                 >> matTag)
            {
                ...
                UniaxialMaterial *
                    theMaterial = OPS_getUniaxialMaterial (matTag);
                if (theMaterial == 0)
                  {
                      opserr <<
                          "section UCFiber - no material exists with tag << "
                          << matTag << endln;
                      return TCL_ERROR;
                  }
                ...
                if (NDM == 2)
                  {
                      theFiber =
                          new UniaxialFiber2d (fiberCount++, *theMaterial,
                                               area, zcoord);
                      if (theFiber != 0)
                        {
                ...
                else
                  {
                      ...
                      pos (1) = zcoord;
                      theFiber =
                          new UniaxialFiber3d (fiberCount++, *theMaterial,
                                               area, pos);
                      if (theFiber != 0)
                        {
                                   ...
                                   TclModelBuilder * theTclModelBuilder)
{
    ...
    // build the fiber section (for analysis)
    if (buildSectionThermal (interp, theTclModelBuilder, secTag, *torsion) !=
        TCL_OK)
      {
          opserr << "WARNING - error constructing the section\n";
          return TCL_ERROR;
          ...
          if (NDM == 2)
            {
                ...
                SectionForceDeformation *
                    section =
                    new FiberSection2dThermal (secTag, numFibers, fiber,
                                               currentSectionComputeCentroid);
          ...
          else if (NDM == 3)
            {
                ...
                SectionForceDeformation *
                    section = 0;
                section =
                    new FiberSection3dThermal (secTag, numFibers, fiber,
                                               currentSectionComputeCentroid);
