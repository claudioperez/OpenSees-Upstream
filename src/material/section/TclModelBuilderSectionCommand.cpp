...
int
TclCommand_addFiberSectionThermal(ClientData clientData,
                                  Tcl_Interp * interp, int argc,
                                  TCL_Char ** argv,
                                  TclModelBuilder * theBuilder);
int buildSectionThermal(Tcl_Interp * interp,
...
SectionForceDeformation *TclModelBuilderYS_SectionCommand(ClientData
                                                          clientData,
                                                          Tcl_Interp *
                                                          interp, int argc,
                                                          TCL_Char ** argv,
                              ...
                              TclModelBuilder * theTclBuilder)
{
    ...
    //--- Adding Thermo-mechanical Sections:[BEGIN]   by UoE OpenSees Group ---//  
        ...
        return TclCommand_addFiberIntSection(clientData, interp, argc,
                                             argv, theTclBuilder);
...
buildSectionInt(Tcl_Interp * interp, TclModelBuilder * theTclModelBuilder,
                int secTag, UniaxialMaterial & theTorsion,
                int NStrip1, double t1, int NStrip2, double t2,
                int NStrip3, double t3);
                           ...
                           TclModelBuilder * theTclModelBuilder)
{
    ...
    if (buildSection(interp, theTclModelBuilder, secTag, *torsion) !=
        TCL_OK) {
                              ...
                              TclModelBuilder * theTclModelBuilder)
{
    ...
    // build the fiber section (for analysis)
    if (buildSectionInt
        (interp, theTclModelBuilder, secTag, *torsion, NStrip1, t1,
                    ...
                    TCL_Char ** argv, TclModelBuilder * theTclModelBuilder)
{
    ...
    if (strcmp(argv[1], "quad") == 0 || strcmp(argv[1], "quadr") == 0) {
        int
         numSubdivIJ, numSubdivJK, matTag, secTag;
        double
    ...
    // check argv[1] for type of patch  and create the object
        ...
        int
         numSubdivRad, numSubdivCirc, matTag, secTag;
        double
         yCenter, zCenter;
        ...
        CircPatch *patch =
            new CircPatch(matTag, numSubdivCirc, numSubdivRad,
                    ...
                    TCL_Char ** argv, TclModelBuilder * theTclModelBuilder)
{
    ...
    if (argc < 5) {
        opserr <<
            "WARNING invalid num args: fiber yLoc zLoc area matTag\n";
        return TCL_ERROR;
    }
                     ...
                     TclModelBuilder * theTclModelBuilder)
{
    ...
    FiberSectionRepr *fiberSectionHRepr =
        (FiberSectionRepr *) sectionHRepres;
    int
                         ...
                         TclModelBuilder * theTclModelBuilder)
{
    ...
    if (strcmp(argv[1], "straight") == 0) {
        ...
        int
         secTag, matTag, numReinfBars;
        double
         reinfBarArea;
        double
         yStartPt, zStartPt, yEndPt, zEndPt;
    ...
    if (!theFile) {
        ...
        while (theFile >> ycoord >> zcoord >> area >> prestrain >> garbage
            ...
            UniaxialMaterial *theMaterial =
                OPS_getUniaxialMaterial(matTag);
            if (theMaterial == 0) {
                opserr <<
