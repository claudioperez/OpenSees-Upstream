...
Vector
GenericSection1d::s (1);
Matrix
GenericSection1d::ks (1, 1);
ID
GenericSection1d::c (1);

GenericSection1d::GenericSection1d (int tag, UniaxialMaterial & m, int type):
SectionForceDeformation (tag, SEC_TAG_Generic1d),
code (type)
{
    theModel = m.getCopy ();
...
int
GenericSection1d::setParameter (const char **argv, int argc,
                                Parameter & param)
{
