...
intRad (0.0), extRad (0.0), initAng (0.0),
finalAng (0.0)
{
...
void
CircPatch::setCenterPosition (const Vector & centerPosition)
{
    centerPosit = centerPosition;
}
...
const Vector &
CircPatch::getCenterPosition (void) const
{
    return centerPosit;
}

int
CircPatch::getNumCells (void) const
{
