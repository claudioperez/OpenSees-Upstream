...
QuadCell::QuadCell(void):vertCoord(4, 2), Centroid(2)
{

}


QuadCell::QuadCell(const Matrix & vertexCoords):vertCoord(vertexCoords),
Centroid(2)
{
...
const Vector & QuadCell::getCentroidPosition(void)
{
    int i, i1;
