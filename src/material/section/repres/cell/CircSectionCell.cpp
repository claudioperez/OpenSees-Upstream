...
CircSectionCell::CircSectionCell(double R1, double R2, double Alpha,
                                 double Theta, double offX,
                                 double offY):r1(R1), r2(R2), alpha(Alpha),
theta(Theta), A(0.0), Centroid(2), offsetX(offX), offsetY(offY)
{
...
double
 CircSectionCell::getArea(void) const
{
    return A;
}
...
const Vector & CircSectionCell::getCentroidPosition(void)
{
    return Centroid;
}
