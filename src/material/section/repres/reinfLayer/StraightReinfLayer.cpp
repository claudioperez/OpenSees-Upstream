...
void *OPS_StraightReinfLayer()
{
    ...
    return new StraightReinfLayer(idata[0], idata[1], data[0], pos1, pos2);
}
#endif


StraightReinfLayer::StraightReinfLayer(void):nReinfBars(0),
matID(0), barDiam(0.0), area(0.0), initPosit(2), finalPosit(2)
{
...
StraightReinfLayer::StraightReinfLayer(int materialID, int numReinfBars,
                                       ...
                                       const Vector &
                                       FinalPosition):nReinfBars
    (numReinfBars), matID(materialID), area(reinfBarArea), barDiam(0.0),
...
ReinfBar *StraightReinfLayer::getReinfBars(void) const
{
    double dy, dz;
    Vector barPosit(2);
    int i;
...
ReinfLayer *StraightReinfLayer::getCopy(void) const
{
