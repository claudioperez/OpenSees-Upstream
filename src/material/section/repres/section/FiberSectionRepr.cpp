...
int
FiberSectionRepr::setPatches (Patch ** patches)
{
...
void
FiberSectionRepr::setNumReinfLayers (int numReinfLayers)
{
    opserr <<
...
int
FiberSectionRepr::setReinfLayers (ReinfLayer ** reinfLayers)
{
...
int
FiberSectionRepr::addPatch (const Patch & aPatch)
{
    int error = 0;
...
int
FiberSectionRepr::addReinfLayer (const ReinfLayer & aReinfLayer)
{
    int error = 0;
    ...
    // out of room: make a new bigger array, copy old over, delete old array and then add new layer
    else
      {
          ...
          if (reinfLayers == 0)
            {
                opserr <<
                    "FiberSectionRepr::addReinLayer() - out of memory\n";
                return 1;
            }
...
int
FiberSectionRepr::getType (void) const
{
    return SEC_TAG_FiberSection;
}

int
FiberSectionRepr::getNumPatches (void) const
{
    return nPatches;
}

int
FiberSectionRepr::getNumReinfLayers (void) const
{
    return nReinfLayers;
}
...
void
FiberSectionRepr::Print (OPS_Stream & s, int flag)
{
//   int i;
