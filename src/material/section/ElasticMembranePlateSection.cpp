...
ElasticMembranePlateSection::ElasticMembranePlateSection(int tag,
                                                         ...
                                                         double r,
                                                         double
                                                         young_plate_mod):SectionForceDeformation
    (tag, SEC_TAG_ElasticMembranePlateSection), strain(8)
{
...
double ElasticMembranePlateSection::getRho()
{
    return rhoH;
}
...
//get the strain 
int ElasticMembranePlateSection::setTrialSectionDeformation(const Vector &
                                                            strain_from_element)
{
...
void ElasticMembranePlateSection::Print(OPS_Stream & s, int flag)
{
    if (flag == OPS_PRINT_PRINTMODEL_SECTION) {
        ...
        s << "  Young's Modulus for Membrane (in-plane) Action, Em = " <<
            Em << endln;
