...
bool
OPS_addSectionForceDeformation (SectionForceDeformation * newComponent)
{
    return theSectionForceDeformationObjects.addComponent (newComponent);
}

bool
OPS_removeSectionForceDeformation (int tag)
{
    TaggedObject *obj =
...
OPS_getSectionForceDeformation (int tag)
{
...
void
OPS_clearAllSectionForceDeformation (void)
{
    theSectionForceDeformationObjects.clearAll ();
}

void
OPS_printSectionForceDeformation (OPS_Stream & s, int flag)
{
...
int
SectionForceDeformation::getResponseSensitivity (int responseID,
                                                 int gradIndex,
                                                 Information & secInfo)
{
    Vector & theVec = *(secInfo.theVector);
...
const Vector &
SectionForceDeformation::getThermalElong (void)
{
    errRes.resize (this->getStressResultant ().Size ());
    return errRes;
}
