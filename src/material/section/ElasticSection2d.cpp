...
ElasticSection2d::ElasticSection2d(void):SectionForceDeformation(0,
                                                                 SEC_TAG_Elastic2d),
...
ElasticSection2d::ElasticSection2d
    (int tag, double E_in, double A_in,
     double I_in):SectionForceDeformation(tag, SEC_TAG_Elastic2d), E(E_in),
A(A_in), I(I_in), e(2)
{
    if (E <= 0.0) {
...
int ElasticSection2d::revertToLastCommit(void)
{
    return 0;
}

int ElasticSection2d::revertToStart(void)
{
    return 0;
}

int ElasticSection2d::setTrialSectionDeformation(const Vector & def)
{
    e = def;
...
const Vector & ElasticSection2d::getSectionDeformation(void)
{
    return e;
}

const Vector & ElasticSection2d::getStressResultant(void)
{
    s(0) = E * A * e(0);
    s(1) = E * I * e(1);
...
const Matrix & ElasticSection2d::getSectionTangent(void)
{
    ks(0, 0) = E * A;
    ks(1, 1) = E * I;
...
const Matrix & ElasticSection2d::getInitialTangent(void)
{
    ks(0, 0) = E * A;
    ks(1, 1) = E * I;
...
const Matrix & ElasticSection2d::getSectionFlexibility(void)
{
    ks(0, 0) = 1.0 / (E * A);
    ks(1, 1) = 1.0 / (E * I);
...
const Matrix & ElasticSection2d::getInitialFlexibility(void)
{
    ks(0, 0) = 1.0 / (E * A);
    ks(1, 1) = 1.0 / (E * I);
...
SectionForceDeformation *ElasticSection2d::getCopy(void)
{
...
const ID & ElasticSection2d::getType(void)
{
    return code;
}

int ElasticSection2d::getOrder(void) const
{
    return 2;
}

int ElasticSection2d::sendSelf(int commitTag, Channel & theChannel)
{
    int res = 0;
...
int ElasticSection2d::recvSelf(int commitTag, Channel & theChannel,
...
void ElasticSection2d::Print(OPS_Stream & s, int flag)
{
...
int ElasticSection2d::activateParameter(int paramID)
{
    parameterID = paramID;
