...
Matrix
UniaxialFiber2d::ks (2, 2);
Vector
UniaxialFiber2d::fs (2);
ID
UniaxialFiber2d::code (2);
...
int
UniaxialFiber2d::recvSelf (int commitTag, Channel & theChannel,
...
void
UniaxialFiber2d::Print (OPS_Stream & s, int flag)
{
