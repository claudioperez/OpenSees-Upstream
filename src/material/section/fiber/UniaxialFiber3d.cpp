...
Matrix
UniaxialFiber3d::ks (3, 3);
Vector
UniaxialFiber3d::fs (3);
ID
UniaxialFiber3d::code (3);
...
Matrix & UniaxialFiber3d::getFiberTangentStiffContr (void)
{
    // ks = (as^as) * area * Et;
    double
        value = theMaterial->getTangent () * area;
...
void
UniaxialFiber3d::Print (OPS_Stream & s, int flag)
{
