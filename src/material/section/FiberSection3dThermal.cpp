                ...
                s << -matData[3 * i] << " " << matData[3 * i +
                                                       1] << " " << matData[3
                                                                            *
                                                                            ...
                                                                            2]
                    << " ";
                s << theMaterials[i]->getStress () << " " << theMaterials[i]->
                    getStrain () << endln;
            }
      }
    else
...
Response *
FiberSection3dThermal::setResponse (const char **argv, int argc,
                                    OPS_Stream & output)
{
...
int
FiberSection3dThermal::setParameter (const char **argv, int argc,
                                     Parameter & param)
{
    if (argc < 3)
        return -1;
...
double
FiberSection3dThermal::determineFiberTemperature (const Vector & DataMixed,
                                                  double fiberLocy,
                                                  double fiberLocz)
{
