...
Vector
ElasticBDShearSection2d::s (3);
Matrix
ElasticBDShearSection2d::ks (3, 3);
ID
ElasticBDShearSection2d::code (3);
...
ElasticBDShearSection2d::ElasticBDShearSection2d
    (int tag, double E_in, double b_in, double d_in, double G_in,
     double alpha_in):
SectionForceDeformation (tag, SEC_TAG_ElasticBDShear2d), E (E_in), b (b_in),
d (d_in), G (G_in), alpha (alpha_in), e (3),
parameterID (0)
{
    if (E <= 0.0)
      {
