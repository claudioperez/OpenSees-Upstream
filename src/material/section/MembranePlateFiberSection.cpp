...
MembranePlateFiberSection::MembranePlateFiberSection(int tag,
    ...
    (tag, SEC_TAG_MembranePlateFiberSection), strainResultant(8)
{
    this->h = thickness;
...
//mass per unit area
double MembranePlateFiberSection::getRho()
{
...
int MembranePlateFiberSection::setTrialSectionDeformation(const Vector &
...
int MembranePlateFiberSection::recvSelf(int commitTag,
                                        Channel & theChannel,
...
Response *MembranePlateFiberSection::setResponse(const char **argv,
                                                 int argc,
                                                 OPS_Stream & output)
{
...
int MembranePlateFiberSection::getResponse(int responseID,
