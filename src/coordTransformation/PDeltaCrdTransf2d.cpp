...
// constructor:
PDeltaCrdTransf2d::PDeltaCrdTransf2d(int tag):CrdTransf(tag,
                                                        CRDTR_TAG_PDeltaCrdTransf2d),
nodeIPtr(0), nodeJPtr(0), nodeIOffset(0), nodeJOffset(0), cosTheta(0),
sinTheta(0), L(0), ul14(0), nodeIInitialDisp(0), nodeJInitialDisp(0),
...
initialDispChecked(false)
{
    ...
    if (&rigJntOffset1 == 0 || rigJntOffset1.Size() != 2) {
        opserr <<
            "PDeltaCrdTransf2d::PDeltaCrdTransf2d:  Invalid rigid joint offset vector for node I\n";
    ...
    if (&rigJntOffset2 == 0 || rigJntOffset2.Size() != 2) {
        opserr <<
            "PDeltaCrdTransf2d::PDeltaCrdTransf2d:  Invalid rigid joint offset vector for node J\n";
        opserr << "Size must be 2\n";
...
PDeltaCrdTransf2d::PDeltaCrdTransf2d():CrdTransf(0, CRDTR_TAG_PDeltaCrdTransf2d),
...
int PDeltaCrdTransf2d::revertToLastCommit(void)
{
    return 0;
}


int PDeltaCrdTransf2d::revertToStart(void)
{
    return 0;
}


int PDeltaCrdTransf2d::initialize(Node * nodeIPointer, Node * nodeJPointer)
{
    int error;
...
int PDeltaCrdTransf2d::update(void)
{
...
void PDeltaCrdTransf2d::compTransfMatrixLocalGlobal(Matrix & Tlg)
{
...
double PDeltaCrdTransf2d::getInitialLength(void)
{
    return L;
}


double PDeltaCrdTransf2d::getDeformedLength(void)
{
    return L;
}


const Vector & PDeltaCrdTransf2d::getBasicTrialDisp(void)
{
...
const Vector & PDeltaCrdTransf2d::getBasicIncrDisp(void)
{
    // determine global displacements
...
const Vector & PDeltaCrdTransf2d::getBasicIncrDeltaDisp(void)
{
    // determine global displacements
...
const Vector & PDeltaCrdTransf2d::getBasicTrialVel(void)
{
...
const Vector & PDeltaCrdTransf2d::getBasicTrialAccel(void)
{
...
const Vector &
    PDeltaCrdTransf2d::getGlobalResistingForce(const Vector & pb,
                                               const Vector & p0)
{
...
const Matrix &
    PDeltaCrdTransf2d::getGlobalStiffMatrix(const Matrix & kb,
                                            const Vector & pb)
{
...
CrdTransf *PDeltaCrdTransf2d::getCopy2d(void)
{
...
int PDeltaCrdTransf2d::sendSelf(int cTag, Channel & theChannel)
{
    int res = 0;
    ...
    if (res < 0) {
        opserr <<
            "PDeltaCrdTransf2d2d::sendSelf - failed to send Vector\n";
        return res;
    }
...
int PDeltaCrdTransf2d::recvSelf(int cTag, Channel & theChannel,
                                FEM_ObjectBroker & theBroker)
{
    ...
    if (res < 0) {
        opserr <<
            "PDeltaCrdTransf2d2d::recvSelf - failed to receive Vector\n";
...
const Vector &
    PDeltaCrdTransf2d::getPointGlobalDisplFromBasic(double xi,
                                                    const Vector & uxb)
{
    // determine global displacements
    const Vector & disp1 = nodeIPtr->getTrialDisp();
...
const Vector &
    PDeltaCrdTransf2d::getPointLocalDisplFromBasic(double xi,
                                                   const Vector & uxb)
{
    // determine global displacements
    const Vector & disp1 = nodeIPtr->getTrialDisp();
...
int PDeltaCrdTransf2d::getLocalAxes(Vector & xAxis, Vector & yAxis,
                                    Vector & zAxis)
{
    xAxis(0) = cosTheta;
    xAxis(1) = sinTheta;
