...
Matrix
PDeltaCrdTransf2d::Tlg (6, 6);
Matrix
PDeltaCrdTransf2d::kg (6, 6);
...
int
PDeltaCrdTransf2d::recvSelf (int cTag, Channel & theChannel,
...
int
PDeltaCrdTransf2d::getLocalAxes (Vector & xAxis, Vector & yAxis,
                                 Vector & zAxis)
{
    xAxis (0) = cosTheta;
    xAxis (1) = sinTheta;
