...
LinearCrdTransf3d::LinearCrdTransf3d(int tag,
                                     ...
                                     vecInLocXZPlane):CrdTransf(tag,
                                                                CRDTR_TAG_LinearCrdTransf3d),
nodeIPtr(0), nodeJPtr(0), nodeIOffset(0), nodeJOffset(0), L(0),
...
nodeIInitialDisp(0), nodeJInitialDisp(0), initialDispChecked(false)
{
    ...
    if (&rigJntOffset1 == 0 || rigJntOffset1.Size() != 3) {
        opserr <<
            "LinearCrdTransf3d::LinearCrdTransf3d:  Invalid rigid joint offset vector for node I\n";
    ...
    if (&rigJntOffset2 == 0 || rigJntOffset2.Size() != 3) {
        opserr <<
            "LinearCrdTransf3d::LinearCrdTransf3d:  Invalid rigid joint offset vector for node J\n";
        opserr << "Size must be 3\n";
...
int LinearCrdTransf3d::revertToLastCommit(void)
{
    return 0;
}


int LinearCrdTransf3d::revertToStart(void)
{
    return 0;
}
...
int LinearCrdTransf3d::update(void)
{
    return 0;
}
...
void LinearCrdTransf3d::compTransfMatrixLocalGlobal(Matrix & Tlg)
{
...
int LinearCrdTransf3d::getLocalAxes(Vector & XAxis, Vector & YAxis,
                                    Vector & ZAxis)
{
    // Compute y = v cross x
...
double LinearCrdTransf3d::getInitialLength(void)
{
    return L;
}


double LinearCrdTransf3d::getDeformedLength(void)
{
    return L;
}


const Vector & LinearCrdTransf3d::getBasicTrialDisp(void)
{
...
const Vector & LinearCrdTransf3d::getBasicIncrDisp(void)
{
    // determine global displacements
...
const Vector & LinearCrdTransf3d::getBasicIncrDeltaDisp(void)
{
    // determine global displacements
...
const Vector & LinearCrdTransf3d::getBasicTrialVel(void)
{
...
const Vector & LinearCrdTransf3d::getBasicTrialAccel(void)
{
...
const Vector &
    LinearCrdTransf3d::getGlobalResistingForce(const Vector & pb,
                                               const Vector & p0)
{
...
const Matrix &
    LinearCrdTransf3d::getGlobalStiffMatrix(const Matrix & KB,
                                            const Vector & pb)
{
...
CrdTransf *LinearCrdTransf3d::getCopy3d(void)
{
...
int LinearCrdTransf3d::sendSelf(int cTag, Channel & theChannel)
{
    int res = 0;
...
int LinearCrdTransf3d::recvSelf(int cTag, Channel & theChannel,
                                FEM_ObjectBroker & theBroker)
{
    ...
    if (res < 0) {
        opserr <<
            "LinearCrdTransf3d::recvSelf - failed to receive Vector\n";
...
const Vector &
    LinearCrdTransf3d::getPointGlobalDisplFromBasic(double xi,
                                                    const Vector & uxb)
{
    // determine global displacements
    const Vector & disp1 = nodeIPtr->getTrialDisp();
...
const Vector &
    LinearCrdTransf3d::getPointLocalDisplFromBasic(double xi,
                                                   const Vector & uxb)
{
    // determine global displacements
    const Vector & disp1 = nodeIPtr->getTrialDisp();
...
////////////////////////////////// sensitivity //////////////////////////////////
const Vector & LinearCrdTransf3d::getBasicDisplSensitivity(int gradNumber)
{
