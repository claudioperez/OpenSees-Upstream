...
CrdTransf *OPS_getCrdTransf(int tag)
{
    ...
    if (theResult == 0) {
        opserr <<
            "CrdTransf *getCrdTransf(int tag) - none found with tag: " <<
            tag << endln;
        return 0;
    }
...
// constructor:
CrdTransf::CrdTransf(int tag, int classTag):TaggedObject(tag),
...
const Vector & CrdTransf::getBasicDisplSensitivity(int gradNumber)
{
    opserr <<
        "WARNING CrdTransf::getBasicDisplSensitivity() - this method " <<
...
const Vector & CrdTransf::getBasicTrialDispShapeSensitivity(void)
{
    opserr <<
...
// --Quan
const Vector & CrdTransf::getBasicDisplSensitivity(int gradNumber, int)
{
    opserr <<
        "WARNING CrdTransf::getBasicDisplSensitivity() - this method " <<
        " should not be called." << endln;
