...
Matrix
LinearCrdTransf2d::Tlg (6, 6);
Matrix
LinearCrdTransf2d::kg (6, 6);
    ...
    if (nodeParameterID (0) != 0 || nodeParameterID (1) != 0)
      {
          ...
          pg (0) =
              dcosdh * pl[0] - dsindh * pl[1] - sinTheta * d1oLdh * (q1 + q2);
          pg (1) =
              dsindh * pl[0] + dcosdh * pl[1] + cosTheta * d1oLdh * (q1 + q2);

          pg (3) =
              dcosdh * pl[3] - dsindh * pl[4] + sinTheta * d1oLdh * (q1 + q2);
          pg (4) =
              dsindh * pl[3] + dcosdh * pl[4] - cosTheta * d1oLdh * (q1 + q2);
...
int
LinearCrdTransf2d::recvSelf (int cTag, Channel & theChannel,
