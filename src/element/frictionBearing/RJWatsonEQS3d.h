...
// Revision: A
//
// Description: This file contains the class definition for RJWatsonEQS3d.
...
// simulate the sliding shear behavior and six uniaxial material models
...
class RJWatsonEQS3d : public Element
{
public:
    // constructor
    ...
    const char *getClassType() const {return "RJWatsonEQS3d";};
...
private:
    ...
    UniaxialMaterial *theMaterials[6];  // array of uniaxial materials
