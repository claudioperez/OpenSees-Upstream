...
BandSPDLinSOE::BandSPDLinSOE (BandSPDLinSolver & the_Solver):LinearSOE (the_Solver, LinSOE_TAGS_BandSPDLinSOE),
size (0), half_band (0), A (0), B (0), X (0), vectX (0), vectB (0),
Asize (0), Bsize (0), factored (false)
{
...
BandSPDLinSOE::addColA (const Vector & colData, int col, double fact)
{
    ...
    if (col > size && col < 0)
      {
          opserr << "BandSPDLinSOE::addColA() - col " << col <<
...
int
BandSPDLinSOE::recvSelf (int tag, Channel & theChannel,
