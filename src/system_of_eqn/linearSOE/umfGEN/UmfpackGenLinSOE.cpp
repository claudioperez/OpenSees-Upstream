...
UmfpackGenLinSOE::UmfpackGenLinSOE (UmfpackGenLinSolver & the_Solver):LinearSOE (the_Solver, LinSOE_TAGS_UmfpackGenLinSOE), X (), B (), Ap (),
Ai (),
Ax ()
{
...
UmfpackGenLinSOE::UmfpackGenLinSOE ():LinearSOE (LinSOE_TAGS_UmfpackGenLinSOE), X (), B (), Ap (), Ai (),
Ax ()
{
}
