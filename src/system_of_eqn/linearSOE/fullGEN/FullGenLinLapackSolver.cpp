...
FullGenLinLapackSolver::FullGenLinLapackSolver ():FullGenLinSolver (SOLVER_TAGS_FullGenLinLapackSolver), iPiv (0),
sizeIpiv (0)
{
    ...
    if (info != 0)
      {
          if (info > 0)
            ...
            {
                opserr <<
                    "WARNING FullGenLinLapackSolver::solve() - OpenSees code error\n";
                return info;
            }
      }
...
int
FullGenLinLapackSolver::sendSelf (int commitTag, Channel & theChannel)
{
    // nothing to do
    return 0;
}
