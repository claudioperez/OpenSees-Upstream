...
PFEMUnifiedLinSOE::PFEMUnifiedLinSOE (PFEMUnifiedSolver & the_Solver):PFEMLinSOE (LinSOE_TAGS_PFEMUnifiedLinSOE),
M (0), G (0), Gt (0), Mp (0),
newDofID ()
{
...
PFEMUnifiedLinSOE::PFEMUnifiedLinSOE ():PFEMLinSOE (LinSOE_TAGS_PFEMUnifiedLinSOE),
M (0), G (0), Gt (0), Mp (0),
newDofID ()
{
