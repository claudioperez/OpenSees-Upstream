...
PFEMCompressibleLinSOE (PFEMCompressibleSolver & the_Solver, bool exp):
...
PFEMCompressibleLinSOE::PFEMCompressibleLinSOE ():PFEMLinSOE (LinSOE_TAGS_PFEMCompressibleLinSOE),
M (0), Gt (0), G (0), Mp (),
newDofID ()
{
