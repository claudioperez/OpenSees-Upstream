...
PFEMDiaLinSOE::PFEMDiaLinSOE (PFEMDiaSolver & the_Solver):PFEMLinSOE (LinSOE_TAGS_PFEMDiaLinSOE),
Gt (0), G (0), M (), Mp (),
newDofID ()
{
...
PFEMDiaLinSOE::PFEMDiaLinSOE ():PFEMLinSOE (LinSOE_TAGS_PFEMDiaLinSOE),
