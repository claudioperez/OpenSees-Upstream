    ...
    if (n > 0 && nnz > 0)
      {
          ...
          int status =
              umfpack_di_symbolic (n, n, Mp, Mi, Mx, &MSym, Control, Info);
    ...
    if (n > 0 && nnz > 0)
      {
          ...
          int status =
              umfpack_di_symbolic (n, n, Lp, Li, Lx, &LSym, Control, Info);
    ...
    if (LNum == 0 && Psize > 0)
      {
          ...
          double *Lx = L->x;
          int status =
              umfpack_di_numeric (Lp, Li, Lx, LSym, &LNum, Control, Info);
