    ...
    if (MSym == 0 && Msize > 0)
      {
          ...
          int status =
              umfpack_di_symbolic (Msize, Msize, Mp, Mi, Mx, &MSym, Control,
                                   Info);
    ...
    if (MNum == 0 && Msize > 0)
      {
          ...
          double *Mx = M->x;
          int status =
              umfpack_di_numeric (Mp, Mi, Mx, MSym, &MNum, Control, Info);
    ...
    if (Msize > 0)
      {
          ...
          if (status != UMFPACK_OK)
            {
                opserr << "WARNING: solving M returns " << status <<
                    " -- PFEMSolver_LumpM::solve\n";
                return -1;
            }
      }
    ...
    if (Psize > 0)
      {
          ...
          if (LSym == 0)
            {
                ...
                int status =
                    umfpack_di_symbolic (Psize, Psize, Sp, Si, Sx, &LSym,
                                         Control, Info);
                ...
                if (status != UMFPACK_OK)
                  {
                      ...
                      opserr << status << " -- PFEMSolver_LumpM::solve\n";
                      opserr << "UMFPACK_ERROR_n_nonpositive = " <<
                          UMFPACK_ERROR_n_nonpositive << "\n";
                      opserr << "UMFPACK_ERROR_invalid_matrix = " <<
                          UMFPACK_ERROR_invalid_matrix << "\n";
                      opserr << "UMFPACK_ERROR_out_of_memory = " <<
                          UMFPACK_ERROR_out_of_memory << "\n";
                      opserr << "UMFPACK_ERROR_argument_missing = " <<
                          UMFPACK_ERROR_argument_missing << "\n";
                      opserr << "UMFPACK_ERROR_internal_error = " <<
          ...
          if (LNum == 0)
            {
                int status =
                    umfpack_di_numeric (Sp, Si, Sx, LSym, &LNum, Control,
                                        Info);
          ...
          double *Ax = S->x;
          int status =
              umfpack_di_solve (UMFPACK_A, Ap, Ai, Ax, x_ptr, deltaP_ptr,
                                LNum, Control, Info);
          deltaP = x;
          ...
          if (status != UMFPACK_OK)
            {
                opserr << "WARNING: solving L returns " << status <<
                    " -- PFEMSolver_LumpM::solve\n";
                return -1;
            }
    ...
    if (Isize > 0 && Psize > 0)
      {
          ...
          double *Ax = M->x;
          int status =
              umfpack_di_solve (UMFPACK_A, Ap, Ai, Ax, x_ptr, deltaV_ptr,
                                MNum, Control, Info);
          deltaV = x;
