...
PFEMQuasiLinSOE::PFEMQuasiLinSOE (PFEMQuasiSolver & the_Solver):PFEMLinSOE (LinSOE_TAGS_PFEMQuasiLinSOE),
M (0), Mp (0), Gt (0),
newDofID ()
{
...
PFEMQuasiLinSOE::PFEMQuasiLinSOE ():PFEMLinSOE (LinSOE_TAGS_PFEMQuasiLinSOE),
