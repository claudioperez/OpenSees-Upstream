...
SparseGenColLinSOE::SparseGenColLinSOE (SparseGenColLinSolver & the_Solver):LinearSOE (the_Solver, LinSOE_TAGS_SparseGenColLinSOE),
...
SparseGenColLinSOE::SparseGenColLinSOE ():LinearSOE (LinSOE_TAGS_SparseGenColLinSOE),
size (0), nnz (0), A (0), B (0), X (0), rowA (0), colStartA (0),
vectX (0), vectB (0), Asize (0), Bsize (0), factored (false)
{
...
SparseGenColLinSOE::SparseGenColLinSOE (int N, int NNZ, int *ColStartA,
                                        int *RowA,
