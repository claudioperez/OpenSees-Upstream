...
ItpackLinSolver::ItpackLinSolver ():LinearSOESolver (SOLVER_TAGS_Itpack),
theSOE (0), IA (0), JA (0), n (0),
iwksp (0), wksp (0), nwksp (0), maxIter (0), method (0), omega (0.0)
{
...
extern "C" int _stdcall SSORCG (int *N, int *IA, int *JA, double *A,
                                double *RHS, double *U, int *IWKSP, int *NW,
                                double *WKSP, int *IPARM, double *RPARM,
                                int *IER);

extern "C" int _stdcall SSORSI (int *N, int *IA, int *JA, double *A,
                                double *RHS, double *U, int *IWKSP, int *NW,
                                double *WKSP, int *IPARM, double *RPARM,
                                int *IER);

extern "C" int _stdcall RSCG (int *N, int *IA, int *JA, double *A,
                              double *RHS, double *U, int *IWKSP, int *NW,
                              double *WKSP, int *IPARM, double *RPARM,
                              int *IER);

extern "C" int _stdcall RSSI (int *N, int *IA, int *JA, double *A,
                              double *RHS, double *U, int *IWKSP, int *NW,
                              double *WKSP, int *IPARM, double *RPARM,
                              int *IER);
...
ItpackLinSolver::solve (void)
{
    ...
    switch (method)
      ...
      default:
          opserr << method <<
              " -- unknown method type in ItpackLinSolver::solve()" << endln;
          break;
      }
    ...
    if (ier > 0)
      {
          opserr << "ItpackLinSolver::solve() -- returned ier = " << ier <<
              endln;
          return -ier;
      }
    else
